...
15. **Investigation Management**: Manage cases and investigations, trigger investigations, and fetch associated investigations
16. **UDM Search & Export**: Direct UDM querying, field value autocomplete, and CSV export
