...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def bit_sight_list_company_highlights(
      ...
      company_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the name of the company for which you want to return"
                  " highlights."
              ),
          ),
      ],
      ...
      max_highlights_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the number of  highlights you want to return. Default: 20."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "BitSight_List Company Highlights"
      ...
      try:
        ...
        print(
            f"Error executing action BitSight_List Company Highlights for BitSight: {e}"
        )
  ...
  @mcp.tool()
  async def bit_sight_get_company_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def bit_sight_list_company_vulnerabilities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      only_high_confidence: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If enabled, action will only return vulnerabilities with high"
                  " confidence."
              ),
          ),
      ],
      max_vulnerabilities_to_return: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify how many vulnerabilities you want to return. Default: 50."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "BitSight_List Company Vulnerabilities"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action BitSight_List Company Vulnerabilities for"
            f" BitSight: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
