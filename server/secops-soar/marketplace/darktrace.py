...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def darktrace_list_similar_devices(
      ...
      max_devices_to_return: Annotated[
          ...
          Field(
              default=None,
              description="Specify how many devices to return per entity. Default: 50.",
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "Darktrace_List Similar Devices"
      ...
      try:
        ...
        print(
            f"Error executing action Darktrace_List Similar Devices for Darktrace: {e}"
        )
  ...
  @mcp.tool()
  async def darktrace_update_model_breach_status(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      status: Annotated[
          List[Any],
          Field(..., description="Specify what status to set for the model breach."),
      ],
      model_breach_id: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify the id of the model breach, for which you want to update"
                  " status."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Darktrace_Update Model Breach Status"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Darktrace_Update Model Breach Status for"
            f" Darktrace: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def darktrace_execute_custom_search(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      query: Annotated[
          str, Field(..., description="Specify the query that needs to be executed.")
      ],
      time_frame: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  ' also need to provide "Start Time". If "Alert Time Till Now" is'
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Darktrace_Execute Custom Search"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action Darktrace_Execute Custom Search for Darktrace: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for Darktrace")
  ...
  @mcp.tool()
  async def darktrace_list_endpoint_events(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      event_type: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of event types that they want to"
                  " return. Possible values: connection, unusualconnection,"
      ...
      time_frame: Annotated[
          ...
          Field(
              ...,
              description=(
                  'Specify a time frame for the search. If "Custom" is selected, you'
      ...
      end_time: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  ' provided and "Custom" is selected for the "Time Frame" parameter'
                  " then this parameter will use current time."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Darktrace_List Endpoint Events"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action Darktrace_List Endpoint Events for Darktrace: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for Darktrace")
  ...
  @mcp.tool()
  async def darktrace_add_comment_to_model_breach(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      model_breach_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the ID of the model breach to which you want to add a"
                  " comment."
              ),
          ),
      ],
      comment: Annotated[
          str, Field(..., description="Specify the comment for the model breach.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Darktrace_Add Comment To Model Breach"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Darktrace_Add Comment To Model Breach for"
            f" Darktrace: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def darktrace_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      fetch_connection_data: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will return additional information about"
                  " connections related to the internal endpoints of Darktrace."
              ),
          ),
      ],
      max_hours_backwards: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify how many hours backwards, action needs to fetch connection"
                  " data. Default: 24."
              ),
          ),
      ],
      create_endpoint_insight: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " about the internal endpoints of Darktrace."
              ),
          ),
      ],
      target_entities: Annotated[
