...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def google_translate_list_languages(
      ...
      filter_key: Annotated[
          ...
          Field(
              default=None,
              description="Specify the key that needs to be used to filter languages.",
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "GoogleTranslate_List Languages"
      ...
      try:
        ...
        print(
            "Error executing action GoogleTranslate_List Languages for"
            f" GoogleTranslate: {e}"
        )
  ...
  @mcp.tool()
  async def google_translate_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def google_translate_translate_text(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      target_language: Annotated[
          str, Field(..., description="Specify the desired language.")
      ],
      text: Annotated[
          str, Field(..., description="Specify the text that needs to be translated.")
      ],
      source_language: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the source language of the text. If nothing is provided,"
                  " action will detect the language automatically."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "GoogleTranslate_Translate Text"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action GoogleTranslate_Translate Text for"
            f" GoogleTranslate: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
