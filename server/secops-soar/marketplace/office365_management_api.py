...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def office365_management_api_stop_subscription(
      ...
      stop_a_subscription_for: Annotated[
          List[Any],
          Field(
              ..., description="Specify for which content type to stop a subscription."
          ),
      ],
    ...
    try:
      instance_response = await bindings.http_client.get(
          Endpoints.LIST_INTEGRATION_INSTANCES.format(
              INTEGRATION_NAME="Office365ManagementAPI"
          )
      )
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "Office365ManagementAPI_Stop Subscription"
      ...
      try:
        ...
        print(
            "Error executing action Office365ManagementAPI_Stop Subscription for"
            f" Office365ManagementAPI: {e}"
        )
  ...
  @mcp.tool()
  async def office365_management_api_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Office365ManagementAPI_Ping for"
            f" Office365ManagementAPI: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def office365_management_api_start_subscription(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      start_a_subscription_for: Annotated[
          List[Any],
          Field(
              ..., description="Specify for which content type to start a subscription."
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Office365ManagementAPI_Start Subscription"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Office365ManagementAPI_Start Subscription for"
            f" Office365ManagementAPI: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
