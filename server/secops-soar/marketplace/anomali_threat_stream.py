...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def anomali_threat_stream_add_tags_to_entities(
      ...
      tags: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of tags that need to be added to"
    ...
    try:
      instance_response = await bindings.http_client.get(
          Endpoints.LIST_INTEGRATION_INSTANCES.format(
              INTEGRATION_NAME="AnomaliThreatStream"
          )
      )
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "AnomaliThreatStream_Add Tags To Entities"
      ...
      try:
        ...
        print(
            "Error executing action AnomaliThreatStream_Add Tags To Entities for"
            f" AnomaliThreatStream: {e}"
        )
  ...
  @mcp.tool()
  async def anomali_threat_stream_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AnomaliThreatStream_Ping for"
            f" AnomaliThreatStream: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def anomali_threat_stream_get_related_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      search_actors: Annotated[
          Optional[bool],
          Field(
              default=None, description="If enabled, action will search among actors."
          ),
      ],
      ...
      search_campaigns: Annotated[
          ...
          Field(
              default=None,
              description="If enabled, action will search among campaigns.",
          ),
      ],
      ...
      search_identities: Annotated[
          ...
          Field(
              default=None,
              description="If enabled, action will search among identities.",
          ),
      ],
      search_incidents: Annotated[
          ...
          Field(
              default=None,
              description="If enabled, action will search among incidents.",
          ),
      ],
      ...
      search_malware: Annotated[
          Optional[bool],
          Field(
              default=None, description="If enabled, action will search among malware."
          ),
      ],
      search_signatures: Annotated[
          ...
          Field(
              default=None,
              description="If enabled, action will search among signatures.",
          ),
      ],
      search_tools: Annotated[
          Optional[bool],
          Field(
              default=None, description="If enabled, action will search among tools."
          ),
      ],
      search_tt_ps: Annotated[
          Optional[bool],
          Field(default=None, description="If enabled, action will search among TTPs."),
      ],
      ...
      max_entities_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify how many entities to return per entity type. Default: 50."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AnomaliThreatStream_Get Related Entities"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AnomaliThreatStream_Get Related Entities for"
            f" AnomaliThreatStream: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def anomali_threat_stream_report_as_false_positive(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      comment: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify additional information related to your decision regarding"
                  " marking the entity as false positive."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AnomaliThreatStream_Report As False Positive"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AnomaliThreatStream_Report As False Positive for"
            f" AnomaliThreatStream: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def anomali_threat_stream_submit_observables(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AnomaliThreatStream_Submit Observables"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AnomaliThreatStream_Submit Observables for"
            f" AnomaliThreatStream: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def anomali_threat_stream_get_related_associations(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AnomaliThreatStream_Get Related Associations"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AnomaliThreatStream_Get Related Associations for"
            f" AnomaliThreatStream: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def anomali_threat_stream_remove_tags_from_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      tags: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of tags that need to be removed from"
                  " entities in Anomali ThreatStream."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AnomaliThreatStream_Remove Tags From Entities"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AnomaliThreatStream_Remove Tags From Entities for"
            f" AnomaliThreatStream: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def anomali_threat_stream_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AnomaliThreatStream_Enrich Entities"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AnomaliThreatStream_Enrich Entities for"
            f" AnomaliThreatStream: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
