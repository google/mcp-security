...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def threat_exchange_get_reputations(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "ThreatExchange_Get Reputations"
      ...
      try:
        ...
        print(
            "Error executing action ThreatExchange_Get Reputations for"
            f" ThreatExchange: {e}"
        )
  ...
  @mcp.tool()
  async def threat_exchange_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
