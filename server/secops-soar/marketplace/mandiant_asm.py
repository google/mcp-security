...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def mandiant_asm_search_issues(
      ...
      issue_i_ds: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of issue ids, for which you want to"
                  " return details."
              ),
          ),
      ],
      entity_i_ds: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of entity ids for which you want to"
                  " find related issues."
              ),
          ),
      ],
      entity_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of entity names for which you want to"
                  " find related issues."
              ),
          ),
      ],
      time_parameter: Annotated[
          Optional[List[Any]],
          Field(
              default=None,
              description="Specify what parameter should be used for filtering time.",
          ),
      ],
      time_frame: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a time frame for the issues. If \u201cCustom\u201d is"
      ...
      lowest_severity_to_return: Annotated[
          Optional[List[Any]],
          Field(
              default=None,
              description=(
                  "Specify the lowest severity that should be used to return the"
                  " issues. If \u201cSelect One\u201d is selected, this filter is not"
      ...
      status: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the status filter for the search. If \u201cSelect One\u201d"
                  " is selected, this filter is not applied during the search."
              ),
          ),
      ],
      tags: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of tag names, which should be used,"
                  " when searching for the issues."
              ),
          ),
      ],
      max_issues_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify how many issues to return. Default: 50. Maximum is 200."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def mandiant_asm_update_issue(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      issue_id: Annotated[
          str,
          Field(
              ..., description="Specify the ID of the issue that needs to be updated."
          ),
      ],
      status: Annotated[
          List[Any],
          Field(..., description="Specify what status to set for the issues."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def mandiant_asm_get_asm_entity_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MandiantASM_Get ASM Entity Details"
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MandiantASM_Get ASM Entity Details for"
            f" MandiantASM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def mandiant_asm_search_asm_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      critical_or_high_issue: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "Specify whether to include only entities with High or Critical"
                  " Issues."
              ),
          ),
      ],
      minimum_vulnerabilities_count: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify how many vulnerabilities should be related to the entity for"
                  " it to be returned."
              ),
          ),
      ],
      minimum_issues_count: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify how many issues should be related to the entity for it to be"
                  " returned."
              ),
          ),
      ],
      tags: Annotated[
          ...
          Field(
              ...
              description=(
                  "Specify a comma-separated list of tag names, which should be used,"
                  " when searching for the entities."
              ),
          ),
      ],
      max_entities_to_return: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify how many entities to return. Default: 50. Maximum is 200."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MandiantASM_Search ASM Entities"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MandiantASM_Search ASM Entities for"
            f" MandiantASM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
