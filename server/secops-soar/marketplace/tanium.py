...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def tanium_create_question(
      ...
      question_text: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the contents of Tanium question. Example: Get Operating"
                  " System from all machines"
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def tanium_quarantine_endpoint(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      package_names: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a JSON object containing all of the package names for"
                  " each OS."
              ),
          ),
      ],
      ...
      package_parameters: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify a JSON object containing all of the parameters for the"
                  " package being deployed. If nothing is provided, action will use the"
                  " following payload:"
                  ' [{"key":"$1","value":null},\n{"key":"$2","value":null},\n{"key":"$3","value":null},\n{"key":"$4","value":null},\n{"key":"$5","value":null},\n{"key":"$6","value":null},\n{"key":"$7","value":null},\n{"key":"$8","value":null},\n{"key":"$9","value":null}]'
              ),
          ),
  ...
  @mcp.tool()
  async def tanium_get_task_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      task_i_ds: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of task ids for which you want to"
                  " fetch details."
              ),
          ),
      ],
      wait_for_completion: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If enabled, action will wait for the task to have status"
  ...
  @mcp.tool()
  async def tanium_list_endpoint_events(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      max_events_to_return: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify how many events to return per entity. Default: 50. Maximum:"
                  " 500."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def tanium_get_question_results(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      question_id: Annotated[
          str, Field(..., description="Specify Tanium question id to get results for.")
      ],
      max_rows_to_return: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the max number of rows action should return for the"
                  " question."
              ),
          ),
      ],
      create_case_wall_table: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If enabled, action will create a case wall table as part of action"
                  " results."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def tanium_create_connection(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def tanium_list_connections(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def tanium_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      additional_fields: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify additional fields to fetch from Tanium for entity"
                  " enrichment. Parameter accepts multiple values as a comma separated"
                  " string."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def tanium_download_file(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      file_paths: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the absolute path of the files on the endpoint that needs to"
                  " be downloaded."
              ),
          ),
      ],
