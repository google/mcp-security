...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def azure_ad_identity_protection_update_user_state(
      ...
      state: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Specify the state for the users."),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "AzureADIdentityProtection_Update User State"
      ...
      try:
        ...
        print(
            "Error executing action AzureADIdentityProtection_Update User State for"
            f" AzureADIdentityProtection: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
          f"Warning: No active integration instance found for AzureADIdentityProtection"
      )
      return {"Status": "Failed", "Message": "No active instance found."}

  @mcp.tool()
  async def azure_ad_identity_protection_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureADIdentityProtection_Ping"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureADIdentityProtection_Ping for"
            f" AzureADIdentityProtection: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def azure_ad_identity_protection_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureADIdentityProtection_Enrich Entities"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureADIdentityProtection_Enrich Entities for"
            f" AzureADIdentityProtection: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
