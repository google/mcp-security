...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def endgame_collect_autoruns(
      ...
      max_items_to_return: Annotated[
          Optional[str],
          Field(default=None, description="Specify how many autoruns to return."),
      ],
      category_all: Annotated[
          Optional[bool],
          Field(
              default=None, description="If enabled, search for all autorun categories"
          ),
      ],
      category_network_provider: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "Network Provider" autorun category',
          ),
      ],
      category_office: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "Office" autorun category',
          ),
      ],
      category_driver: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "Driver" autorun category',
          ),
      ],
      category_app_init: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "App Init" autorun category',
          ),
      ],
      category_winlogon: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "Winlogon" autorun category',
          ),
      ],
      category_print_monitor: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "Print Monitor" autorun category',
          ),
      ],
      category_ease_of_access: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "Ease of Access" autorun category',
          ),
      ],
      category_wmi: Annotated[
          Optional[bool],
          Field(
              default=None, description='If enabled, search for "WMI" autorun category'
          ),
      ],
      category_lsa_provider: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "LSA Provider" autorun category',
          ),
      ],
      category_service: Annotated[
          ...
          Field(
              default=None,
              description='If enabled, search for "Service" autorun category',
          ),
      ],
      category_bits: Annotated[
          Optional[bool],
          Field(
              default=None, description='If enabled, search for "Bits" autorun category'
          ),
      ],
      category_known_dll: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "Known dll" autorun category',
          ),
      ],
      category_print_provider: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "Print Provider" autorun category',
          ),
      ],
      category_image_hijack: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "Image Hijack" autorun category',
          ),
      ],
      category_startup_folder: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "Startup Folder" autorun category',
          ),
      ],
      category_internet_explorer: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "Internet Explorer" autorun category',
          ),
      ],
      category_codec: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "Codec" autorun category',
          ),
      ],
      category_logon: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "Logon" autorun category',
          ),
      ],
      category_search_order_hijack: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  'If enabled, search for "Search Order Hijack" autorun category'
              ),
          ),
      ],
      category_winsock_provider: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "Winsock Provider" autorun category',
          ),
      ],
      category_boot_execute: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "Boot Execute" autorun category',
          ),
      ],
      category_phantom_dll: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "Phantom dll" autorun category',
          ),
      ],
      category_com_hijack: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "Com Hijack" autorun category',
          ),
      ],
      category_explorer: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "Explorer" autorun category',
          ),
      ],
      category_scheduled_task: Annotated[
          Optional[bool],
          Field(
              default=None,
              description='If enabled, search for "Scheduled Task" autorun category',
          ),
      ],
      include_all_metadata: Annotated[
          Optional[bool],
          Field(default=None, description="If enabled, provides all available data"),
      ],
      include_malware_classification_metadata: Annotated[
          Optional[bool],
          Field(
              default=None,
              description="If enabled, provides information about MalwareScore",
          ),
      ],
      include_authenticode_metadata: Annotated[
          Optional[bool],
          Field(default=None, description="If enabled, provides Signer Information"),
      ],
      include_md5_hash: Annotated[
          Optional[bool],
          Field(
              default=None, description="If enabled, provides MD5 hash in the response"
          ),
      ],
      include_sha_1_hash: Annotated[
          Optional[bool],
          Field(
              default=None,
              description="If enabled, provides SHA-1 hash in the response",
          ),
      ],
      include_sha_256_hash: Annotated[
          Optional[bool],
          Field(
              default=None,
              description="If enabled, provides SHA-256 hash in the response",
          ),
      ],
    ...
    if instances:
      ...
      if include_malware_classification_metadata is not None:
        script_params["Include Malware Classification Metadata"] = (
            include_malware_classification_metadata
        )
  ...
  @mcp.tool()
  async def endgame_isolate_host(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      create_insight: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If enabled, creates Insight after successful execution of this"
                  " action."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def endgame_hunt_user(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      endpoints_core_os: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Select an operating system (i.e., Windows, Linux, or Mac) to filter"
                  " the Endpoints list. Note: You can only create a single"
                  " investigation for endpoints that run on the same operating system."
              ),
          ),
      ],
      find_username: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "ADVANCED CONFIGURATION for this hunt. Enter username(s), separate"
  ...
  @mcp.tool()
  async def endgame_add_ip_subnet_to_host_isolation_config(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ip_subnet: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Enter the IPv4 Subnet that you want to add to Host Isolation Config."
              ),
          ),
      ],
      description: Annotated[
          Optional[str],
          Field(default=None, description="Enter the description to the IP Subnet."),
      ],
      create_insight: Annotated[
          Optional[bool],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Endgame_Add IP Subnet to Host Isolation Config"
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Endgame_Add IP Subnet to Host Isolation Config for"
            f" Endgame: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def endgame_get_investigation_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      investigation_id: Annotated[
          str, Field(..., description="Specify Endgame Investigation ID to search for.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Endgame_Get Investigation Details"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action Endgame_Get Investigation Details for Endgame: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for Endgame")
  ...
  @mcp.tool()
  async def endgame_remove_ip_subnet_from_host_isolation_config(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ip_subnet: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Enter the IPv4 Subnet that you want to remove from Host Isolation"
                  " Config."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Endgame_Remove IP Subnet from Host Isolation Config"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Endgame_Remove IP Subnet from Host Isolation"
            f" Config for Endgame: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for Endgame")
  ...
  @mcp.tool()
  async def endgame_system_survey(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      max_items_to_return: Annotated[
          Optional[str],
          Field(default=None, description="Specify how many items to return."),
      ],
      include_security_product_information_windows_only: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "Specify to get information about the security products installed on"
                  " the endpoint (Windows only)."
              ),
          ),
      ],
      include_patch_information_windows_only: Annotated[
          Optional[bool],
          Field(
              default=None,
              description="Specify to get information about patches (Windows only).",
          ),
      ],
      include_disk_information: Annotated[
          Optional[bool],
          Field(default=None, description="Specify to get information about Disks."),
      ],
      include_network_interface_information: Annotated[
          Optional[bool],
          Field(
              default=None,
              description="Specify to get information about network interfaces.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      if include_security_product_information_windows_only is not None:
        script_params["Include Security Product Information (Windows only)"] = (
            include_security_product_information_windows_only
        )
      if include_patch_information_windows_only is not None:
        script_params["Include Patch Information (Windows only)"] = (
            include_patch_information_windows_only
        )
      ...
      if include_network_interface_information is not None:
        script_params["Include Network Interface Information"] = (
            include_network_interface_information
        )
  ...
  @mcp.tool()
  async def endgame_hunt_process(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      md5_hashes: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "ADVANCED CONFIGURATION for this hunt. Enter MD5 Hashes, separated by"
                  " comma"
              ),
          ),
      ],
      sha1_hashes: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "ADVANCED CONFIGURATION for this hunt. Enter SHA1 Hashes, separated"
                  " by comma"
              ),
          ),
      ],
      sha256_hashes: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "ADVANCED CONFIGURATION for this hunt. Enter SHA256 Hashes, separated"
                  " by comma"
              ),
          ),
      ],
      process_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "ADVANCED CONFIGURATION for this hunt. Enter Process Name ex. iss.exe"
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  @mcp.tool()
  async def endgame_firewall_survey_windows_only(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Endgame_Firewall Survey (Windows only)"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Endgame_Firewall Survey (Windows only) for"
            f" Endgame: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def endgame_unisolate_host(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def endgame_list_investigations(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      os: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify for which OS you want to list investigations. Parameter can"
                  " take multiple values as a comma separated string."
              ),
          ),
      ],
      fetch_investigations_for_the_last_x_hours: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Return investigations created for the specified time frame in hours."
              ),
          ),
      ],
      max_investigation_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify how many investigation you want to query.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      if fetch_investigations_for_the_last_x_hours is not None:
        script_params["Fetch investigations for the last X hours"] = (
            fetch_investigations_for_the_last_x_hours
        )
  ...
  @mcp.tool()
  async def endgame_get_host_isolation_config(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Endgame_Get Host Isolation Config"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action Endgame_Get Host Isolation Config for Endgame: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for Endgame")
  ...
  @mcp.tool()
  async def endgame_get_endpoints(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def endgame_process_survey(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      detect_fileless_attacks_windows_only: Annotated[
          Optional[bool],
          Field(
              default=None,
      ...
      detect_malware_with_malware_score_windows_only: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "Specify to detect malware processes with MalwareScore. Windows Only."
              ),
          ),
      ],
      collect_process_threads: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
      ...
      return_only_suspicious_processes: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "Specify to return only suspicious processes from the endpoint. By"
                  " the Endgame definition: Suspicious processes are unbacked"
    ...
    if instances:
      ...
      if detect_fileless_attacks_windows_only is not None:
        script_params["Detect Fileless Attacks (Windows Only)"] = (
            detect_fileless_attacks_windows_only
        )
      if detect_malware_with_malware_score_windows_only is not None:
        script_params["Detect Malware With MalwareScore (Windows Only)"] = (
            detect_malware_with_malware_score_windows_only
        )
      ...
      if return_only_suspicious_processes is not None:
        script_params["Return Only Suspicious Processes"] = (
            return_only_suspicious_processes
        )
  ...
  @mcp.tool()
  async def endgame_drivers_survey_windows_only(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Endgame_Drivers Survey (Windows only)"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Endgame_Drivers Survey (Windows only) for"
            f" Endgame: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def endgame_kill_process(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      process_name: Annotated[str, Field(..., description="Enter the process name.")],
      pid: Annotated[
          Optional[str], Field(default=None, description="Enter ID of the process.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def endgame_user_sessions_survey(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def endgame_network_survey(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      include_route_entries_information: Annotated[
          Optional[bool],
          Field(
              default=None,
      ...
      include_net_bios_information: Annotated[
          Optional[bool],
          Field(default=None, description="Specify to get information about Net Bios."),
      ],
      include_dns_cache_information: Annotated[
          Optional[bool],
          Field(
              default=None,
      ...
      include_arp_table_information: Annotated[
          Optional[bool],
          Field(
              default=None,
    ...
    if instances:
      ...
      if include_route_entries_information is not None:
        script_params["Include Route Entries Information"] = (
            include_route_entries_information
        )
  ...
  async def endgame_hunt_ip(
      ...
      remote_ip_address: Annotated[
          Optional[str],
          Field(default=None, description="remote IP address - separated by comma"),
      ],
      local_ip_address: Annotated[
          Optional[str], Field(default=None, description="separated by comma")
      ],
      state: Annotated[
          Optional[str],
          Field(default=None, description="Enter state to return. Ex. ANY"),
      ],
      protocol: Annotated[
          Optional[str], Field(default=None, description="Ex. ANY, UDP, TCP")
      ],
      network_port: Annotated[Optional[str], Field(default=None, description="ul")],
      network_remote: Annotated[
          Optional[str], Field(default=None, description="Network Remote or Local")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def endgame_hunt_registry(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      hive: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "One of the following: HKEY_CLASSES_ROOT, HKEY_CURRENT_CONFIG,"
                  " HKEY_USERS, HKEY_LOCAL_MACHINE, ALL"
              ),
          ),
      ],
      keys: Annotated[
          Optional[str], Field(default=None, description="Registry Key or Value Name")
      ],
      min_size: Annotated[
          Optional[str], Field(default=None, description="Min byte size")
      ],
      max_size: Annotated[
          Optional[str], Field(default=None, description="Max byte size")
      ],
      endpoints_core_os: Annotated[
          Optional[str],
          Field(
  ...
  @mcp.tool()
  async def endgame_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  async def endgame_hunt_file(
      ...
      find_file: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Enter the filename(s) to search. TIP: Enter a regex to narrow search"
                  " results."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def endgame_download_file(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      full_file_path: Annotated[
          str, Field(..., description="Enter the path to the file")
      ],
      full_download_folder_path: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Enter the path to the folder, where you want to store this file."
              ),
          ),
      ],
      expected_sha_256_hash: Annotated[
          Optional[str],
          Field(default=None, description="Enter the expected SHA-256 hash"),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def endgame_delete_file(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      file_path: Annotated[str, Field(..., description="Enter the path to the file")],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
              default_factory=list,
  ...
  @mcp.tool()
  async def endgame_removable_media_survey_windows_only(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Endgame_Removable Media Survey (Windows only)"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Endgame_Removable Media Survey (Windows only) for"
            f" Endgame: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def endgame_software_survey_windows_only(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Endgame_Software Survey (Windows only)"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Endgame_Software Survey (Windows only) for"
            f" Endgame: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
