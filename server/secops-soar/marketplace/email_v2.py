...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def email_v2_send_thread_reply(
      ...
      folder_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of mailbox folders in which action"
                  " should search for email. Note: you can set mail-specific folders,"
                  ' for example, "[Gmail]/All Mail" to search in all of the folders of'
                  " Gmail mailbox. Additionally, folder name should match exactly the"
                  " IMAP folder. If folder contains spaces, folder must be wrapped in"
                  " double quotes."
              ),
          ),
      ],
      ...
      reply_all: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  ' the original email. Note: this parameter has priority over "Reply'
                  ' To" parameter.'
              ),
          ),
      ],
      reply_to: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  ' this reply. If nothing is provided and "Reply All" is disabled,'
                  ' action will only send a reply to the sender of the email. If "Reply'
                  ' All" is enabled, action will ignore this parameter.'
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def email_v2_wait_for_email_from_user(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      email_recipients: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " SendEmail.JSONResult.recipients field as a placeholder."
              ),
          ),
      ],
      wait_stage_timeout_minutes: Annotated[
          str,
          Field(
              ...,
              description=(
                  "How long in minutes to wait for the user\u2019s reply before marking"
                  " it timed out."
              ),
          ),
      ],
      ...
      fetch_response_attachments: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If selected, if recipient replies with attachment \u2013 fetch"
                  " recipient response and add it as attachment for the action result."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "EmailV2_Wait for Email from User"
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action EmailV2_Wait for Email from User for EmailV2: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for EmailV2")
  ...
  @mcp.tool()
  async def email_v2_forward_email(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      folder_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Mailbox folder to search email in. Parameter should also accept"
                  " comma separated list of folders. Note that you can set"
                  ' mail-specific folders, for example "[Gmail]/All Mail"  to search in'
                  " all of the folders of Gmail mailbox. Additionally, folder name"
                  " should match exactly the IMAP folder. If folder contains spaces,"
                  " folder must be wrapped in double quotes."
              ),
          ),
      ],
      message_id_of_email_to_forward: Annotated[
          str, Field(..., description="message_id value of the email to forward.")
      ],
      ...
      subject: Annotated[str, Field(..., description="The email subject part.")],
      cc: Annotated[
          Optional[str],
          Field(
              default=None,
      ...
      content: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "The email body part, if Email HTML Template is set, action should"
                  " support definition of body of the email with provided HTML"
                  " template."
              ),
          ),
      ],
      return_message_id_for_the_forwarded_email: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If selected, action returns the message id for the sent email in"
                  " JSON technical result."
              ),
          ),
      ],
    ...
    if instances:
      ...
      if return_message_id_for_the_forwarded_email is not None:
        script_params["Return message id for the forwarded email"] = (
            return_message_id_for_the_forwarded_email
        )
  ...
  @mcp.tool()
  async def email_v2_save_email_attachments_to_case(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "EmailV2_Save Email Attachments To Case"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action EmailV2_Save Email Attachments To Case for"
            f" EmailV2: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def email_v2_move_email_to_folder(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      destination_folder_name: Annotated[
          str, Field(..., description="Destination folder to move emails to")
      ],
  ...
  async def email_v2_send_email(
      ...
      return_message_id_for_the_sent_email: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If selected, action returns the message id for the sent email in"
                  " JSON technical result. This message id when can be used for the"
                  " 'Wait for Email from user' action to process user response"
              ),
          ),
      ],
      attachments_paths: Annotated[
    ...
    if instances:
      ...
      if return_message_id_for_the_sent_email is not None:
        script_params["Return message id for the sent email"] = (
            return_message_id_for_the_sent_email
        )
      if attachments_paths is not None:
        script_params["Attachments Paths"] = attachments_paths
  ...
  @mcp.tool()
  async def email_v2_download_email_attachments(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "EmailV2_DownloadEmailAttachments"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action EmailV2_DownloadEmailAttachments for EmailV2: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for EmailV2")
  ...
  @mcp.tool()
  async def email_v2_delete_email(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      message_i_ds: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " message id is provided, subject, sender, recipient and time filters"
                  " are ignored."
              ),
          ),
      ],
      ...
      days_back: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Filter condition, specify in what time frame in days should action"
                  " look for emails to delete. Note - Action works in days granularity"
                  " only. 0 means it will search for mails from today."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def email_v2_search_email(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      time_frame_minutes: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " search look for emails"
              ),
          ),
      ],
      max_emails_to_return: Annotated[
          str, Field(..., description="Return max X emails as an action result.")
      ],
      subject_filter: Annotated[
          Optional[str],
          Field(
