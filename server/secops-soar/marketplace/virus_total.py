...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def virus_total_scan_hash(
      ...
      threshold: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Mark entity as suspicious if number of negative engines is equal or"
                  " above the given threshold"
              ),
          ),
      ],
      rescan_after_days: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Action will fetch the latest result. If the result is older than"
                  " mentioned days it will automatically rescan the entity"
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def virus_total_upload_and_scan_files(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      threshold: Annotated[str, Field(..., description="Entity risk threshold.")],
      file_paths: Annotated[str, Field(..., description="Target file path.")],
      linux_server_address: Annotated[
          Optional[str],
          Field(default=None, description="Linux server address(e.g: x.x.x.x)."),
      ],
      linux_user: Annotated[Optional[str], Field(default=None, description="")],
      linux_password: Annotated[Optional[str], Field(default=None, description="")],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
              default_factory=list,
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "VirusTotal_Upload And Scan Files"
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action VirusTotal_Upload And Scan Files for"
            f" VirusTotal: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def virus_total_scan_url(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  async def virus_total_scan_ip(
      ...
      threshold: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the accepted threshold for the detected samples related to"
                  " the IP address. If the number of engines that marked related"
                  " samples as malicious is higher than the specified threshold, IP"
                  " address will be marked as suspicious."
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  @mcp.tool()
  async def virus_total_get_domain_report(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action VirusTotal_Get Domain Report for VirusTotal: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for VirusTotal")
