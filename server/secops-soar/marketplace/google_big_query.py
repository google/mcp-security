...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def google_big_query_run_custom_query(
      ...
      query: Annotated[
          str,
          Field(..., description="Specify the SQL query that needs to be executed."),
      ],
      max_results_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify how many results to return in the response.",
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "GoogleBigQuery_Run Custom Query"
      ...
      try:
        ...
        print(
            "Error executing action GoogleBigQuery_Run Custom Query for"
            f" GoogleBigQuery: {e}"
        )
  ...
  @mcp.tool()
  async def google_big_query_run_sql_query(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      dataset_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the name of the dataset, which will be used, when executing"
                  " queries."
              ),
          ),
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action GoogleBigQuery_Run SQL Query for"
            f" GoogleBigQuery: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def google_big_query_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
