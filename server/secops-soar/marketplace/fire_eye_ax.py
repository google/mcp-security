...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def fire_eye_ax_get_appliance_details(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "FireEyeAX_Get Appliance Details"
      ...
      try:
        ...
        print(
            f"Error executing action FireEyeAX_Get Appliance Details for FireEyeAX: {e}"
        )
  ...
  @mcp.tool()
  async def fire_eye_ax_submit_url(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      vm_profile: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify the virtual machine profile that should be used during"
                  ' analysis. Available VM profiles are available in the action "Get'
                  ' Appliance Details"'
              ),
          ),
      ],
      ...
      application_id: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the ID of the application that needs to be used during the"
                  " analysis of the file. By default, FireEye AX will select the needed"
                  " application automatically. In order to get a list of available"
                  ' applications on the profile, please execute action "Get Appliance'
                  ' Details"'
              ),
          ),
      ],
      priority: Annotated[
          ...
          Field(
              default=None,
              description=(
                  'Specify the priority for the submission. "Normal" puts submission at'
                  ' the bottom of the queue, while "Urgent" puts submission at the top'
                  " of the queue."
              ),
          ),
      ],
      force_rescan: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If enabled, action will force FireEye AX to rescan the submitted"
                  " file."
              ),
          ),
      ],
      analysis_type: Annotated[
          ...
          Field(
              default=None,
              description=(
                  'Specify the type of the analysis. If "Live" is selected, FireEye AX'
                  " will analyze suspected files live within the Malware Analysis"
                  ' Multi-Vector Virtual Execution (MVX) analysis engine. If "Sandbox"'
                  " is selected FireEye AX will analyze suspected files in a closed,"
  ...
  @mcp.tool()
  async def fire_eye_ax_submit_file(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      file_paths: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separate list of absolute file paths for submission."
              ),
          ),
      ],
      vm_profile: Annotated[
