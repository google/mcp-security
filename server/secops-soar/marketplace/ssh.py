...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def ssh_terminate_process(
      ...
      remote_server: Annotated[
          str, Field(..., description="Remote server address(e.g: x.x.x.x)")
      ],
      remote_username: Annotated[str, Field(..., description="")],
      remote_password: Annotated[str, Field(..., description="")],
      process: Annotated[str, Field(..., description="Process to terminate.")],
      remote_port: Annotated[Optional[str], Field(default=None, description="")],
  ...
  async def ssh_reboot_machine(
      ...
      remote_port: Annotated[
          Optional[str], Field(default=None, description="The default port will be 22.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  async def ssh_logoff_user(
      ...
      remote_username: Annotated[str, Field(..., description="")],
      remote_password: Annotated[str, Field(..., description="")],
      logoff_username: Annotated[
          str, Field(..., description="The username to log off.")
      ],
      remote_port: Annotated[
          Optional[str], Field(default=None, description="The default port will be 22.")
      ],
  ...
  async def ssh_execute_program(
      ...
      remote_username: Annotated[str, Field(..., description="")],
      remote_password: Annotated[str, Field(..., description="")],
      remote_program_path: Annotated[
          str, Field(..., description="The path to the program in the remote host.")
      ],
      remote_port: Annotated[Optional[str], Field(default=None, description="")],
      target_entities: Annotated[
          List[TargetEntity],
  ...
  @mcp.tool()
  async def ssh_list_iptables_rules(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      chain: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "The iptables chain that you wish to see (e.g: INPUT, OUTPUT, etc.)"
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  async def ssh_run_command(
      ...
      remote_password: Annotated[str, Field(..., description="")],
      command: Annotated[
          str, Field(..., description="Command content(e.g: ifconfig).")
      ],
      remote_port: Annotated[Optional[str], Field(default=None, description="")],
      target_entities: Annotated[
          List[TargetEntity],
  ...
  @mcp.tool()
  async def ssh_block_ip_address_in_iptables(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      remote_username: Annotated[str, Field(..., description="")],
      remote_password: Annotated[str, Field(..., description="")],
      block_ip_address: Annotated[
          str, Field(..., description="IP address to block(e.g: x.x.x.x).")
      ],
      remote_port: Annotated[Optional[str], Field(default=None, description="")],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "SSH_Block IP Address in iptables"
  ...
  @mcp.tool()
  async def ssh_shutdown_machine(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      wait_time: Annotated[
          str,
          Field(..., description="Time to wait before shutdown in minutes(e.g: now)."),
      ],
      remote_port: Annotated[
          Optional[str], Field(default=None, description="The default port will be 22.")
      ],
  ...
  @mcp.tool()
  async def ssh_delete_firewall_rule(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      remote_username: Annotated[str, Field(..., description="")],
      remote_password: Annotated[str, Field(..., description="")],
      i_ptables_rule: Annotated[
          str, Field(..., description="Rule value(e.g: INPUT -s 10.0.0.10 -j DROP)")
      ],
      remote_port: Annotated[Optional[str], Field(default=None, description="")],
      target_entities: Annotated[
          List[TargetEntity],
