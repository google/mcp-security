...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def microsoft365_defender_update_incident(
      ...
      status: Annotated[
          Optional[List[Any]],
          Field(
              default=None, description="Specify what status to set for the incident."
          ),
      ],
      classification: Annotated[
          ...
          Field(
              default=None,
              description="Specify what classification to set for the incident..",
          ),
      ],
      determination: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify what determination to set for the incident. Note:"
                  " determination can only be set, when classification is true"
                  " positive."
              ),
          ),
      ],
      assign_to: Annotated[
          Optional[str],
          Field(default=None, description="Specify to whom to assign this incident."),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "Microsoft365Defender_Update Incident"
      ...
      try:
        ...
        print(
            "Error executing action Microsoft365Defender_Update Incident for"
            f" Microsoft365Defender: {e}"
        )
  ...
  @mcp.tool()
  async def microsoft365_defender_execute_query(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      table_names: Annotated[
          str, Field(..., description="Specify what tables should be queried.")
      ],
      query: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the query that needs to be executed. Use this parameter to"
                  " provide |where clauses. Note: you don\u2019t need to provide time"
                  " filter, limiting and sorting."
              ),
          ),
      ],
      ...
      fields_to_return: Annotated[
          Optional[str],
          Field(default=None, description="Specify what fields to return."),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Microsoft365Defender_Execute Query"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Microsoft365Defender_Execute Query for"
            f" Microsoft365Defender: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft365_defender_add_comment_to_incident(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      comment: Annotated[
          ...
          Field(
              ...,
              description="Specify the comment that needs to be added to the incident.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Microsoft365Defender_Add Comment To Incident"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Microsoft365Defender_Add Comment To Incident for"
            f" Microsoft365Defender: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft365_defender_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Microsoft365Defender_Ping for"
            f" Microsoft365Defender: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft365_defender_execute_entity_query(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      stop_if_not_enough_entities: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " entity types are available for the specified \u201c.. Entity"
                  " Keys\u201d. Example: if \u201cIP Entity Key\u201d and \u201cFile"
                  " Hash Entity Key\u201d are specified, but in the scope there are no"
                  " file hashes then if this parameter is enabled, action will not"
                  " execute the query."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Microsoft365Defender_Execute Entity Query"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Microsoft365Defender_Execute Entity Query for"
            f" Microsoft365Defender: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft365_defender_execute_custom_query(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      query: Annotated[
          ...
          Field(
              ...
              description=(
                  "Specify the query that needs to be executed. Use this parameter to"
                  " provide |where clauses. Note: Note: you don't need to provide a"
                  ' limiting ("top" keyword).'
              ),
          ),
      ],
      max_results_to_return: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Microsoft365Defender_Execute Custom Query"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Microsoft365Defender_Execute Custom Query for"
            f" Microsoft365Defender: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
