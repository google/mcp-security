...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def microsoft_graph_mail_delegated_send_vote_email(
      ...
      send_from: Annotated[
          ...
          Field(
              ...,
              description=(
                  "An optional email address from which to send an email if permissions"
                  " allow it. By default, the email is sent from the default mailbox"
                  " that is specified in the integration configuration."
              ),
          ),
      ],
      ...
      email_html_template: Annotated[
          EmailContent,
          Field(
              ...,
              description=(
                  "The type of the HTML template to use. The default value is Email"
                  " HTML Template."
              ),
          ),
      ],
      structure_of_voting_options: Annotated[
          ...
          Field(
              ...,
              description=(
                  "The structure of the vote to send to recipients. The possible values"
                  " are Yes/No or Approve/Reject. The default value is Yes/No."
              ),
          ),
      ],
      attachment_location: Annotated[
          List[Any],
          Field(
              ...,
              description=(
                  "A location where the attachments are stored. By default, the action"
                  " attempts to upload attachments from the Cloud Storage bucket. The"
                  " possible values are GCP Bucket or Local File System. The default"
                  " value is GCP Bucket."
              ),
          ),
      ],
      ...
      attachments_paths: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "A comma-separated list of paths for file attachments stored on the"
                  " server, for example, /{FILE_DIRECTORY}/file.pdf,"
                  " /{FILE_DIRECTORY}/image.jpg."
              ),
          ),
      ],
      reply_to_recipients: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " Use the Reply-To header to redirect reply emails to the specific"
                  " email address instead of the sender address that is stated in the"
                  " From field."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "MicrosoftGraphMailDelegated_Send Vote Email"
      ...
      try:
        ...
        print(
            "Error executing action MicrosoftGraphMailDelegated_Send Vote Email for"
            f" MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
          f"Warning: No active integration instance found for"
          f" MicrosoftGraphMailDelegated"
      )
      return {"Status": "Failed", "Message": "No active instance found."}

  @mcp.tool()
  async def microsoft_graph_mail_delegated_mark_email_as_not_junk(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      search_in_mailbox: Annotated[
          str,
          Field(
              ...,
              description=(
                  "A mailbox to search for an email in. By default, the action attempts"
                  " to search for the email in the default mailbox that you specified"
                  " in the integration configuration. To execute a search in other"
                  " mailboxes, configure appropriate permissions for the action. This"
      ...
      folder_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "A mailbox folder in which to search for an email. To specify a"
                  " subfolder, use the \u201c/\u201d forward slash, such as"
                  " {Inbox/Subfolder}."
              ),
          ),
      ],
      mail_i_ds: Annotated[
          ...
          Field(
              ...,
              description=(
                  "A comma-separated string of the mail IDs or internetMessageId values"
                  " of the emails to mark as not junk."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphMailDelegated_Mark Email as Not Junk"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphMailDelegated_Mark Email as Not Junk"
            f" for MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
  ...
  @mcp.tool()
  async def microsoft_graph_mail_delegated_send_thread_reply(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      send_from: Annotated[
          ...
          Field(
              ...,
              description=(
                  "An optional email address from which to send emails if permissions"
                  " allow it. By default, the action sends emails from the default"
                  " mailbox that is specified in the integration configuration."
              ),
          ),
      ],
      mail_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "The email ID or the internetMessageId value of the email to"
                  " reply to."
              ),
          ),
      ],
      ...
      mail_content: Annotated[str, Field(..., description="The email body.")],
      attachment_location: Annotated[
          List[Any],
          Field(
              ...,
      ...
      reply_all: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " the original email. Not selected by default. This parameter has"
      ...
      reply_to: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "A comma-separated list of emails to reply to. If you don't set a"
                  " value and the Reply All checkbox is clear, the action only sends a"
                  " reply to the original email sender. If you select the Reply All"
                  " checkbox, the action ignores this parameter."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphMailDelegated_Send Thread Reply"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphMailDelegated_Send Thread Reply for"
            f" MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_graph_mail_delegated_wait_for_email_from_user(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      mail_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "The ID of the email. If you used the Send Mail action to send"
                  " emails, set the parameter value to the {SendEmail.JSONResult|id} or"
                  " {SendEmail.JSONResult|internetMessageId} placeholder."
              ),
          ),
      ],
      wait_for_all_recipients_to_reply: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " until reaching timeout or proceeding with the first reply."
              ),
          ),
      ],
      wait_stage_exclude_pattern: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "A regular expression to exclude specific replies from the wait"
                  " stage. This parameter works with the email body. For example, if"
                  " you configure the \u201cOut of Office.*\u201d regular expression,"
                  " the action doesn't consider automatic out-of-office messages as"
                  " recipient replies and waits for an actual user reply."
              ),
          ),
      ],
      folder_to_check_for_reply: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "A mailbox email folder to search for the user reply in. The search"
                  " is run in the mailbox which the email containing a question was"
                  " sent from. This parameter accepts a comma-separated list of folders"
                  " to check the user response in multiple folders. This parameter is"
                  " case-sensitive. The default value is Inbox."
              ),
          ),
      ],
      fetch_response_attachments: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " fetches the reply and adds it as an attachment to the action"
                  " result."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphMailDelegated_Wait For Email From User"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphMailDelegated_Wait For Email From"
            f" User for MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
  ...
  @mcp.tool()
  async def microsoft_graph_mail_delegated_forward_email(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      mail_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "The email ID or the internetMessageId value of the email to forward."
              ),
          ),
      ],
      subject: Annotated[str, Field(..., description="The email subject.")],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphMailDelegated_Forward Email"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphMailDelegated_Forward Email for"
            f" MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_graph_mail_delegated_generate_token(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      authorization_url: Annotated[
          ...
          Field(
              ...,
              description=(
                  "An authorization URL that you received in the Get Authorization"
                  " action. The URL is required to request a refresh token."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphMailDelegated_Generate Token"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphMailDelegated_Generate Token for"
            f" MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_graph_mail_delegated_move_email_to_folder(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      move_in_mailbox: Annotated[
          str,
          Field(
              ...,
              description=(
                  "The default mailbox to execute the move operation in. If permissions"
                  " allow it, the action can search in other mailboxes as well. This"
                  " parameter accepts multiple values as a comma-separated string."
              ),
          ),
      ],
      source_folder_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "A source folder from which to move the email. To specify a"
                  " subfolder, use the \u201c/\u201d forward slash, such as"
                  " {Inbox/Subfolder}."
              ),
          ),
      ...
      destination_folder_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "A destination folder to move the email to. Provide the parameter"
                  " value in the following format: {Inbox/folder_name/subfolder_name}."
      ...
      mail_i_ds: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " This parameter accepts a comma-separated list of email IDs to"
                  " search for. If you configure this parameter, the search ignores the"
                  " Subject Filter and Sender Filter parameters."
              ),
          ),
      ],
      ...
      time_frame_minutes: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "A filter condition that specifies the period in minutes to search"
                  " for emails."
              ),
          ),
      ],
      only_unread: Annotated[
          ...
          Field(
              default=None,
              description="If selected, the action searches only for unread emails.",
          ),
      ],
      how_many_mailboxes_to_process_in_a_single_batch: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "The number of mailboxes to process in a single batch (a single"
                  " connection to the Microsoft 365 server). The default value is 25."
              ),
          ),
      ],
      limit_the_amount_of_information_returned_in_the_json_result: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphMailDelegated_Move Email To Folder"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphMailDelegated_Move Email To Folder"
            f" for MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_graph_mail_delegated_wait_for_vote_email_results(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      vote_mail_sent_from: Annotated[
          str,
          Field(
              ...,
              description=(
                  "The mailbox from which an email is sent using the Send Vote Email"
                  " action. The default value is the mailbox that you specified in the"
                  " integration configuration. Optionally, you can set a different"
                  " value for this parameter if the vote mail is sent from a different"
                  " mailbox."
              ),
          ),
      ],
      mail_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "The ID of the email. If the email is sent using the Send Vote Email"
                  " action, set the parameter value to the SendVoteEmail.JSONResult|id"
                  " or SendEmail.JSONResult|internetMessageId placeholder. To return"
                  " email IDs, you can use the Search Emails action."
              ),
          ),
      ],
      wait_for_all_recipients_to_reply: Annotated[
          ...
          Field(
              ...
              description=(
                  "If selected, the action waits for responses from all recipients"
                  " until reaching timeout or proceeding with the first reply. Selected"
                  " by default."
              ),
          ),
      ],
      ...
      folder_to_check_for_reply: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "A mailbox email folder to search for the user reply. The action"
                  " searches in the mailbox from which you sent the email with a"
                  " question. This parameter accepts a comma-separated list of folders"
                  " to check the user response in multiple folders. To specify a"
                  " subfolder, use the \u201c/\u201d forward slash, such as"
                  " {Inbox/Subfolder}. This parameter is case-sensitive. The default"
                  " value is Inbox."
              ),
          ),
      ],
      folder_to_check_for_sent_mail: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "A mailbox folder to search for the sent mail. The action searches in"
                  " the mailbox from which you sent the email with a question. This"
                  " parameter accepts a comma-separated list of folders to check the"
                  " user response in multiple folders. To specify a subfolder, use the"
                  " \u201c/\u201d forward slash, such as {Inbox/Subfolder}. This"
                  " parameter is case-sensitive. The default value is Sent Items."
              ),
          ),
      ],
      fetch_response_attachments: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphMailDelegated_Wait For Vote Email Results"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphMailDelegated_Wait For Vote Email"
            f" Results for MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
  ...
  @mcp.tool()
  async def microsoft_graph_mail_delegated_send_email_html(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphMailDelegated_Send Email HTML"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphMailDelegated_Send Email HTML for"
            f" MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_graph_mail_delegated_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphMailDelegated_Ping"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphMailDelegated_Ping for"
            f" MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_graph_mail_delegated_search_emails(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      search_in_mailbox: Annotated[
          ...
          Field(
              ...,
              description=(
                  "The default mailbox to execute the search operation in. If"
                  " permissions allow it, the action can search in other mailboxes."
                  " This parameter accepts multiple values as a comma-separated string."
                  " For complex searches against a significant number of mailboxes, use"
                  " the Exchange Extension Pack integration."
              ),
          ),
      ],
      folder_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "A mailbox folder to execute the search in. To specify a subfolder,"
                  " use the \u201c/\u201d forward slash, such as {Inbox/Subfolder}."
              ),
          ),
      ],
      subject_filter: Annotated[
      ...
      max_emails_to_return: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "The number of emails for the action to return. If you don't set a"
                  " value, the action uses the API default value. The default value"
                  " is 10."
              ),
          ),
      ],
      ...
      select_all_fields_for_return: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If selected, the action returns all available fields for the"
                  " obtained email."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphMailDelegated_Search Emails"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphMailDelegated_Search Emails for"
            f" MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_graph_mail_delegated_save_email_to_the_case(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      search_in_mailbox: Annotated[
          ...
          Field(
              ...,
              description=(
                  "The default mailbox in which to execute the search operation. If"
                  " permissions allow it, the action can search in other mailboxes."
              ),
          ),
      ],
      mail_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "The email ID or the internetMessageId value to search for. This"
                  " parameter accepts a comma-separated list of email IDs to search"
                  " for. If you used the Send Mail action to send emails, set the"
                  " parameter value to the {SendEmail.JSONResult|id} or"
                  " {SendEmail.JSONResult|internetMessageId}  placeholder."
              ),
          ),
      ],
      ...
      attachment_to_save: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If you select the Save Only Email Attachments parameter, the action"
                  " only saves attachments specified by this parameter. This parameter"
                  " accepts multiple values as a comma-separated string."
              ),
          ),
      ],
      base64_encode: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If selected, the action encodes the email file into the base64"
                  " format."
              ),
          ),
      ],
      save_email_to_the_case_wall: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If selected, the action saves the specified email to the action Case"
                  " Wall in Google Secops."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphMailDelegated_Save Email to the Case"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphMailDelegated_Save Email to the Case"
            f" for MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_graph_mail_delegated_send_email(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      send_from: Annotated[
          ...
          Field(
              ...
              description=(
                  "An optional email address from which to send emails if permissions"
                  " allow it. By default, the action sends emails from the default"
                  " mailbox specified in the integration configuration."
              ),
          ),
      ],
      subject: Annotated[str, Field(..., description="The email subject.")],
      ...
      mail_content_type: Annotated[
          Optional[List[Any]],
          Field(
              default=None,
              description="The type of the email content. The default value is Text.",
          ),
      ],
      reply_to_recipients: Annotated[
          Optional[str],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphMailDelegated_Send Email"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphMailDelegated_Send Email for"
            f" MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_graph_mail_delegated_get_mailbox_account_out_of_facility_settings(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          actionProvider="Scripts",  # Assuming constant based on example
          actionName=(
              "MicrosoftGraphMailDelegated_Get Mailbox Account Out Of Facility Settings"
          ),
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (  # Assuming same as actionName
                  "MicrosoftGraphMailDelegated_Get Mailbox Account Out Of Facility"
                  " Settings"
              ),
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphMailDelegated_Get Mailbox Account"
            f" Out Of Facility Settings for MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
  ...
  @mcp.tool()
  async def microsoft_graph_mail_delegated_download_attachments_from_email(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      download_destination: Annotated[
          List[Any],
          Field(
              ...,
              description=(
                  "A location to save the downloaded attachments. By default, the"
                  " action attempts to save the attachment to the Cloud Storage bucket."
                  " Saving an attachment to the local file system is a fallback option."
                  " The possible values are GCP Bucket and Local File System. The"
                  " default value is GCP Bucket."
              ),
          ),
      ],
      download_path: Annotated[
          ...
          Field(
              ...,
              description=(
                  "A path to download attachments to. When saving attachments to the"
                  " Cloud Storage bucket or a local file system, the action expects you"
                  " to specify the download path in the Unix-like format, such"
                  ' as"/tmp/test"'
              ),
          ),
      ],
      ...
      mail_i_ds: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "A filter condition to search for emails with specific email IDs or"
                  " internetMessageId values. This parameter accepts a comma-separated"
                  " list of email IDs to search for. If this parameter is provided, the"
                  " search ignores the Subject Filter and Sender Filter parameters."
              ),
          ),
      ],
      subject_filter: Annotated[
      ...
      download_attachments_to_unique_path: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If selected, the action downloads attachments to the unique path"
                  " provided in the Download Path parameter to avoid overwriting any"
                  " previously downloaded attachments."
              ),
          ),
      ],
      how_many_mailboxes_to_process_in_a_single_batch: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (  # Assuming same as actionName
                  "MicrosoftGraphMailDelegated_Download Attachments from Email"
              ),
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphMailDelegated_Download Attachments"
            f" from Email for MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
  ...
  @mcp.tool()
  async def microsoft_graph_mail_delegated_delete_email(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      delete_in_mailbox: Annotated[
          str,
          Field(
              ...,
              description=(
                  "The default mailbox to execute the delete operation in. If"
                  " permissions allow it, the action executes search in other"
                  " mailboxes. This parameter accepts multiple values as a"
      ...
      mail_i_ds: Annotated[
          ...
          Field(
              ...
              description=(
                  "A filter condition to search for emails with specific email IDs."
                  " This parameter accepts a comma-separated list of email IDs to"
                  " search for. If this parameter is provided, the search ignores the"
                  " Subject Filter and Sender Filter parameters."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphMailDelegated_Delete Email"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphMailDelegated_Delete Email for"
            f" MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_graph_mail_delegated_mark_email_as_junk(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphMailDelegated_Mark Email as Junk"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphMailDelegated_Mark Email as Junk for"
            f" MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_graph_mail_delegated_extract_data_from_attached_eml(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      mail_i_ds: Annotated[
          ...
          Field(
              ...
              description=(
                  "A filter condition to search for emails with specific email IDs or"
                  " internetMessageId values. This parameter accepts a comma-separated"
                  " list of email IDs to search for."
              ),
          ),
      ],
      folder_name: Annotated[
      ...
      regex_map_json: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "A JSON definition that contains regular expressions to apply to the"
                  " attached email file and generate additional key values in the"
                  " action JSON result. The example of this parameter value is as"
                  " follows: {ips:"
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (  # Assuming same as actionName
                  "MicrosoftGraphMailDelegated_Extract Data from Attached EML"
              ),
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphMailDelegated_Extract Data from"
            f" Attached EML for MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
  ...
  @mcp.tool()
  async def microsoft_graph_mail_delegated_get_authorization(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphMailDelegated_Get Authorization"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphMailDelegated_Get Authorization for"
            f" MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_graph_mail_delegated_run_microsoft_search_query(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      entity_types_to_search: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "A comma-separated list of expected resource types for the search"
                  " response. The possible values are as follows: event, message,"
                  " driveItem, externalItem, site, list, listItem, drive, chatMessage,"
                  " person, acronym, bookmark."
              ),
          ),
      ],
      fields_to_return: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "The fields to return in the search response. If you don\u2019t"
                  " configure this parameter, the action returns all available fields."
              ),
          ),
      ],
      search_query: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "The query to run the search. For more information about the search"
                  " query examples, see Use the Microsoft Search API to search Outlook"
                  " messages(https://learn.microsoft.com/en-us/graph/search-concept-messages)."
              ),
          ),
      ],
      max_rows_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "The maximum number of rows for the action to return. If you"
                  " don\u2019t configure this parameter, the action uses the default"
      ...
      advanced_query: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "The full search payload to use instead of constructing the search"
                  " query with other action parameters. Format the search payload as a"
                  " JSON string. If you configure this parameter, the action ignores"
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphMailDelegated_Run Microsoft Search Query"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphMailDelegated_Run Microsoft Search"
            f" Query for MicrosoftGraphMailDelegated: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
