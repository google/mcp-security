...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def palo_alto_ngfw_edit_blocked_applications(
      ...
      device_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "The device name in which the group is located. The default device"
                  " name of NGFW is localhost.localdomain. In case configured"
                  " differently, please refer to"
                  " https://<NGFWIP>/php/rest/browse.php/config::devices for the list"
                  " of all the device names and select the relevant device."
              ),
          ),
      ],
      vsys_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "The vsys in which the group is located. The default vsys name of"
                  " NGFW is vsys1. In case configured differently, please refer to"
                  " https://<NGFW"
                  " IP>/php/rest/browse.php/config::devices::entry[@name='<DEVICE"
                  " NAME>']::vsys for the list of all the vsys names of the device and"
                  " select the relevant vsys."
              ),
          ),
      ],
      policy_name: Annotated[str, Field(..., description="Policy name value.")],
      applications_to_block: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "List of applications to block, comma separated, e.g:"
                  " apple-siri,app2."
              ),
          ),
      ],
      applications_to_un_block: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "List of applications to unblock, comma separated, e.g:"
                  " apple-siri,app2."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "PaloAltoNGFW_Edit Blocked Applications"
      ...
      try:
        ...
        print(
            "Error executing action PaloAltoNGFW_Edit Blocked Applications for"
            f" PaloAltoNGFW: {e}"
        )
  ...
  @mcp.tool()
  async def palo_alto_ngfw_block_ips_in_policy(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      policy_name: Annotated[str, Field(..., description="Policy name value.")],
      target: Annotated[
          str, Field(..., description="Has to be source or destination.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "PaloAltoNGFW_Block ips in policy"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action PaloAltoNGFW_Block ips in policy for"
            f" PaloAltoNGFW: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def palo_alto_ngfw_add_ips_to_group(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      address_group_name: Annotated[str, Field(..., description="Group name value.")],
      device_name: Annotated[
          Optional[str],
          Field(
              default=None,
      ...
      use_shared_objects: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will use shared objects instead of vsys. Note:"
                  " action will not create a shared address group, if it doesn't exist."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action PaloAltoNGFW_Add Ips to group for"
            f" PaloAltoNGFW: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def palo_alto_ngfw_commit_changes(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      only_my_changes: Annotated[
          bool, Field(..., description="Commit only the configured use changes.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action PaloAltoNGFW_Commit Changes for PaloAltoNGFW: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for PaloAltoNGFW")
  ...
  @mcp.tool()
  async def palo_alto_ngfw_unblock_urls(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      url_category_name: Annotated[str, Field(..., description="")],
      device_name: Annotated[
          Optional[str],
          Field(
              default=None,
  ...
  @mcp.tool()
  async def palo_alto_ngfw_block_urls(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      url_category_name: Annotated[str, Field(..., description="Policy name value.")],
      device_name: Annotated[
          Optional[str],
          Field(
              default=None,
  ...
  @mcp.tool()
  async def palo_alto_ngfw_remove_ips_from_group(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      address_group_name: Annotated[
          str, Field(..., description="The name of the required address group.")
      ],
      device_name: Annotated[
          Optional[str],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "PaloAltoNGFW_Remove Ips from group"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action PaloAltoNGFW_Remove Ips from group for"
            f" PaloAltoNGFW: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def palo_alto_ngfw_unblock_ips_in_policy(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "PaloAltoNGFW_Unblock ips in policy"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action PaloAltoNGFW_Unblock ips in policy for"
            f" PaloAltoNGFW: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def palo_alto_ngfw_get_blocked_applications(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "PaloAltoNGFW_Get Blocked Applications"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action PaloAltoNGFW_Get Blocked Applications for"
            f" PaloAltoNGFW: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
