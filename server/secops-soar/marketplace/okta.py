...
def register_tools(mcp: FastMCP):
  ...
  async def okta_list_providers(
      ...
      query: Annotated[
          Optional[str],
          Field(default=None, description="Search the name property for a match"),
      ],
      type: Annotated[Optional[str], Field(default=None, description="Filter by type")],
      limit: Annotated[
          Optional[str],
          Field(default=None, description="Max amount of results to return"),
      ],
  ...
  @mcp.tool()
  async def okta_assign_role(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      role_types: Annotated[
          str, Field(..., description="The type of role to assign to the users")
      ],
      user_i_ds: Annotated[
          Optional[str], Field(default=None, description="Ids of users in Okta")
      ],
      also_run_on_scope: Annotated[
          Optional[bool],
          Field(
              default=None,
  ...
  @mcp.tool()
  async def okta_unassign_role(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      role_i_ds_or_names: Annotated[
          str, Field(..., description="Ids or names of roles in Okta")
      ],
      user_i_ds: Annotated[
          Optional[str], Field(default=None, description="Ids of users in Okta")
      ],
      is_id: Annotated[
          Optional[bool],
          Field(default=None, description="Whether the values are ids or names"),
      ],
      also_run_on_scope: Annotated[
          Optional[bool],
          Field(
  ...
  @mcp.tool()
  async def okta_disable_user(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      user_i_ds_or_logins: Annotated[
          Optional[str], Field(default=None, description="Ids of users in Okta")
      ],
      is_deactivate: Annotated[
          Optional[bool],
          Field(
              default=None, description="Whether to dactivate or only suspend the user"
          ),
      ],
      send_email_if_deactivate: Annotated[
          Optional[bool],
          Field(
              default=None,
  ...
  @mcp.tool()
  async def okta_get_user(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      user_ids_or_logins: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Ids or logins (email or short email name) of a user in Okta, e.g."
                  " test@gmail.com or simply 'test'"
              ),
          ),
      ],
      also_run_on_scope: Annotated[
  ...
  @mcp.tool()
  async def okta_list_user_groups(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      user_i_ds_or_logins: Annotated[
          Optional[str],
          Field(default=None, description="Ids or logins of users in Okta"),
      ],
      also_run_on_scope: Annotated[
          Optional[bool],
          Field(
  ...
  @mcp.tool()
  async def okta_get_group(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      group_ids_or_names: Annotated[
          str, Field(..., description="Ids or names of groups in Okta")
      ],
      is_id: Annotated[
          Optional[bool],
          Field(default=None, description="Whether the value is an id or a name"),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def okta_add_group(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      group_name: Annotated[
          str, Field(..., description="The name of the group in Okta")
      ],
      group_description: Annotated[
          Optional[str],
          Field(default=None, description="The description for the group"),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  async def okta_reset_password(
      ...
      send_email: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Whether to send an email for the password reset or return the token"
                  " for every user"
              ),
          ),
      ],
  ...
  async def okta_enable_user(
      ...
      is_activate: Annotated[
          Optional[bool],
          Field(
              default=None, description="Whether to activate the user or just unsuspend"
          ),
      ],
      send_email_if_activate: Annotated[
          Optional[bool],
          Field(
              default=None,
  ...
  async def okta_set_password(
      ...
      add_10_random_chars: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "Whether to add extra characters to every user password or not"
              ),
          ),
      ],
      also_run_on_scope: Annotated[
  ...
  async def okta_list_users(
      ...
      query: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Search for a match in the firstname, lastname or in the email"
              ),
          ),
      ],
      filter: Annotated[
          Optional[str],
          Field(
              default=None, description="Custom search query for a subset of properties"
          ),
      ],
      search: Annotated[
          Optional[str],
          Field(default=None, description="Custom search query for most properties"),
      ],
      limit: Annotated[
          Optional[str],
          Field(default=None, description="Max amount of results to return"),
