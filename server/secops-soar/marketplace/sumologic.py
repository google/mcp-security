...
def register_tools(mcp: FastMCP):
  ...
  async def sumologic_search(
      ...
      query: Annotated[
          str, Field(..., description="Sumologic query to run. e.g: _collector=*")
      ],
      delete_search_job: Annotated[
          Optional[bool],
          Field(
              default=None,
      ...
      since: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Start date of the search, ISO-8601 or unixtime (milliseconds). e.g."
                  " 1970-01-01T00:00:00. Default: Last 30 days."
              ),
          ),
      ],
      to: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "End date of the search, ISO-8601 or unixtime (milliseconds). e.g."
                  " 1970-01-01T00:00:00. Default: now (current utc unixtime)."
              ),
          ),
      ],
      limit: Annotated[
