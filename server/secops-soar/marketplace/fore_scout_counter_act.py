...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def fore_scout_counter_act_ping(
    ...
    if instances:
      ...
      try:
        ...
        print(
            "Error executing action ForeScoutCounterACT_Ping for"
            f" ForeScoutCounterACT: {e}"
        )
  ...
  @mcp.tool()
  async def fore_scout_counter_act_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      create_insight: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If enabled, action will create insights containing enrichment"
                  " information."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "ForeScoutCounterACT_Enrich Entities"
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ForeScoutCounterACT_Enrich Entities for"
            f" ForeScoutCounterACT: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
