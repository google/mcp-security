...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def screenshot_machine_take_url_screenshot(
      ...
      image_format: Annotated[
          Optional[str],
          Field(default=None, description="Format of the image, e.g: jpg"),
      ],
      delay: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Using delay parameter, you can manage how long capturing engine"
                  " should wait before the screenshot is created. This parameter must"
                  " be an integer. Default value is 2000."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "ScreenshotMachine_Take URL Screenshot"
      ...
      try:
        ...
        print(
            "Error executing action ScreenshotMachine_Take URL Screenshot for"
            f" ScreenshotMachine: {e}"
        )
  ...
  @mcp.tool()
  async def screenshot_machine_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action ScreenshotMachine_Ping for ScreenshotMachine: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for ScreenshotMachine")
