...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def atlassian_confluence_server_get_page_by_id(
      ...
      page_id: Annotated[str, Field(..., description="Specify the page id to return.")],
      expand: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the expand parameter to return additional information about"
                  " the page. Parameter accepts multiple values as a comma separated"
                  " list. By default with body.storage the content of the page is"
                  " fetched."
              ),
          ),
      ],
    ...
    try:
      instance_response = await bindings.http_client.get(
          Endpoints.LIST_INTEGRATION_INSTANCES.format(
              INTEGRATION_NAME="AtlassianConfluenceServer"
          )
      )
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "AtlassianConfluenceServer_Get Page by ID"
      ...
      try:
        ...
        print(
            "Error executing action AtlassianConfluenceServer_Get Page by ID for"
            f" AtlassianConfluenceServer: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
          f"Warning: No active integration instance found for AtlassianConfluenceServer"
      )
      return {"Status": "Failed", "Message": "No active instance found."}

  @mcp.tool()
  async def atlassian_confluence_server_get_child_pages(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      max_records_to_return: Annotated[
          str, Field(..., description="Specify the limit of child pages to return.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AtlassianConfluenceServer_Get Child Pages"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AtlassianConfluenceServer_Get Child Pages for"
            f" AtlassianConfluenceServer: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def atlassian_confluence_server_get_page_comments(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AtlassianConfluenceServer_Get Page Comments"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AtlassianConfluenceServer_Get Page Comments for"
            f" AtlassianConfluenceServer: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def atlassian_confluence_server_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AtlassianConfluenceServer_Ping"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AtlassianConfluenceServer_Ping for"
            f" AtlassianConfluenceServer: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def atlassian_confluence_server_list_pages(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      filter_key: Annotated[
          ...
          Field(
              default=None,
              description="Specify the key that needs to be used to filter pages.",
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AtlassianConfluenceServer_List Pages"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AtlassianConfluenceServer_List Pages for"
            f" AtlassianConfluenceServer: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
