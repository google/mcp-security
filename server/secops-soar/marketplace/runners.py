...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def runners_run_command_as_user(
      ...
      command: Annotated[
          str, Field(..., description="The command to run, e.g: whoami")
      ],
      username: Annotated[str, Field(..., description="")],
      domain: Annotated[str, Field(..., description="User's domain.")],
      password: Annotated[str, Field(..., description="")],
      daemon: Annotated[
          bool, Field(..., description="Whether to run in the background or not")
      ],
