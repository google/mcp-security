...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def cisco_orbital_execute_query(
      ...
      name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the name for the query job. If nothing is specified, action"
                  " will use a name in the following format: Siemplify-{guid}"
              ),
          ),
      ],
      custom_context_fields: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify additional custom context fields that should be added to the"
                  " job. Format: key_1:value_1,key_2:value_1."
              ),
          ),
      ],
      ...
      hide_case_wall_table: Annotated[
          Optional[bool],
          Field(
              default=None,
              description="If enabled, action will not prepare a case wall table.",
          ),
      ],
    ...
    if instances:
      ...
      try:
        ...
        print(
            f"Error executing action CiscoOrbital_Execute Query for CiscoOrbital: {e}"
        )
