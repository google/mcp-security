...
def register_tools(mcp: FastMCP):
  ...
  async def netskope_block_file(
      ...
      file_id: Annotated[
          str, Field(..., description="ID of a file, needed to identify a file.")
      ],
      quarantine_profile_id: Annotated[
          str, Field(..., description="ID of a quarantine profile.")
      ],
  ...
  @mcp.tool()
  async def netskope_list_quarantined_files(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      start_time: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Restrict events to those that have timestamps greater than this"
                  " (unixtime). Needed only if time period is not passed."
              ),
          ),
      ],
      end_time: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Restrict events to those that have timestamps less than this"
                  " (unixtime). Needed only if time period is not passed."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Netskope_List Quarantined Files"
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action Netskope_List Quarantined Files for Netskope: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for Netskope")
  ...
  @mcp.tool()
  async def netskope_list_alerts(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      query: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "This acts as a filter for all the cloud app events in the alerts"
                  " database."
              ),
          ),
      ],
      type: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "The type of the alert to filter by. Valid values: anomaly |"
                  " 'Compromised Credential' | policy | 'Legal Hold' | malsite |"
                  " Malware | DLP | watchlist | quarantine | Remediation."
              ),
          ),
      ],
      time_period: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Time period to search alerts at (milliseconds backwards). Valid"
                  " Values: 3600 | 86400 | 604800 | 2592000."
              ),
          ),
      ],
      start_time: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Restrict alerts to those that have timestamps greater than this"
                  " (unixtime). Needed only if time period is not passed."
              ),
          ),
      ],
      end_time: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Restrict alerts to those that have timestamps less than this"
                  " (unixtime). Needed only if time period is not passed."
              ),
          ),
      ],
      is_acknowledged: Annotated[
          Optional[bool],
          Field(default=None, description="Whether to get only acknowledged alerts."),
      ],
      limit: Annotated[
          Optional[str],
          Field(default=None, description="Number of results to return. Default: 100."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def netskope_list_events(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      query: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "This acts as a filter for all the cloud app events in the events"
                  " database."
              ),
          ),
      ],
      type: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "The type of the alert to filter by. Valid values: page | application"
      ...
      time_period: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Time period to search events at (milliseconds backwards). Valid"
                  " Values: 3600 | 86400 | 604800 | 2592000."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def netskope_download_file(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def netskope_list_clients(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      query: Annotated[
          ...
          Field(
              default=None,
              description="This acts as a filter on all the entries in the database.",
          ),
      ],
      limit: Annotated[
          Optional[str],
          Field(default=None, description="Number of results to return. Default: 25."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
