...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def cb_live_response_create_memdump(
      ...
      check_for_active_session_x_times: Annotated[
          str,
          Field(
              ...,
              description=(
                  "How many attempts action should make to get active session for the"
                  " entity. Check is made every 2 seconds."
              ),
          ),
      ],
      file_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the file name for memdump creation. File name is case"
                  ' insensitive. File Name can be specified as a "full path" having'
                  " both path and a file name, in that case Remote Directory Path"
                  " parameter will not be used."
              ),
          ),
      ],
      remote_directory_path: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the directory file path to store the memdump. Example:"
                  " C:\\TMP\\"
              ),
          ),
      ],
    ...
    if instances:
      ...
      script_params["Check for active session x times"] = (
          check_for_active_session_x_times
      )
      ...
      try:
        ...
        print(
            "Error executing action CBLiveResponse_Create Memdump for"
            f" CBLiveResponse: {e}"
        )
  ...
  @mcp.tool()
  async def cb_live_response_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def cb_live_response_execute_file(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      file_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the file name to execute. File name is case insensitive."
                  ' File Name can be specified as a "full path" having both path and a'
                  " file name, in that case Remote Directory Path parameter will not be"
                  " used."
              ),
          ),
      ],
      remote_directory_path: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the remote directory path for the file to execute. Example:"
                  " C:\\TMP\\"
              ),
          ),
      ],
      output_log_file_on_remote_host: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the output log file action should save the redirected output"
                  " to. Example: C:\\TMP\\cmdoutput.log"
              ),
          ),
      ],
      command_arguments_to_pass_to_file: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the command arguments to pass for executing the file."
                  ' Example, here we specify "/C whoami" to execute whoami command with'
                  " cmd: C:\\Windows\\system32\\cmd.exe /C whoami"
              ),
          ),
      ],
      wait_for_the_result: Annotated[
          Optional[bool],
          Field(
              default=None,
    ...
    if instances:
      ...
      if command_arguments_to_pass_to_file is not None:
        script_params["Command Arguments to Pass to File"] = (
            command_arguments_to_pass_to_file
        )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CBLiveResponse_Execute File for"
            f" CBLiveResponse: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cb_live_response_list_processes(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      process_name: Annotated[
          Optional[str],
          Field(default=None, description="Process name to search for on the host."),
      ],
      how_many_records_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CBLiveResponse_List Processes for"
            f" CBLiveResponse: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cb_live_response_kill_process(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      process_name: Annotated[
          Optional[str],
          Field(default=None, description="Process name to search PID for."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CBLiveResponse_Kill Process for"
            f" CBLiveResponse: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cb_live_response_list_files(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      remote_directory_path: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the target directory path action should list. Example:"
                  " C:\\TMP\\ or /tmp/"
              ),
          ),
      ],
      ...
      start_from_row: Annotated[
          ...
          Field(
              default=None,
              description="Specify from which row action should start to return data.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action CBLiveResponse_List Files for CBLiveResponse: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for CBLiveResponse")
  ...
  @mcp.tool()
  async def cb_live_response_download_file(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      local_directory_path: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify the local directory path action should save the file to."
                  " Example: /tmp/"
              ),
          ),
      ],
      ...
      file_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the file name to download. File name is case insensitive."
                  ' File Name can be specified as a "full path" having both path and a'
                  " file name, in that case Remote Directory Path parameter will not be"
                  " used."
              ),
      ...
      remote_directory_path: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the remote directory path action should take to download the"
                  " file. Example: C:\\TMP\\"
              ),
          ),
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CBLiveResponse_Download File for"
            f" CBLiveResponse: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cb_live_response_list_files_in_cloud_storage(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "CBLiveResponse_List Files in Cloud Storage"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CBLiveResponse_List Files in Cloud Storage for"
            f" CBLiveResponse: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cb_live_response_put_file(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      destination_directory_path: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify the target directory path action should upload the file to."
                  " Example: C:\\TMP\\"
              ),
          ),
      ],
      file_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the file name to upload. File name is case insensitive. File"
                  ' Name can be specified as a "full path" having both path and a file'
                  " name, in that case Source Directory Path parameter will not be"
                  " used."
              ),
          ),
      ],
      source_directory_path: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the source directory path action should take to get the file"
                  " to upload. Example: /tmp/"
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  @mcp.tool()
  async def cb_live_response_delete_file(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      remote_directory_path: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the remote directory path to file to delete. Example:"
                  " C:\\TMP\\"
              ),
          ),
      ],
      file_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the file name to delete. File name is case insensitive. File"
                  ' Name can be specified as a "full path" having both path and a file'
                  " name, in that case Remote Directory Path parameter will not be"
                  " used."
              ),
          ),
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action CBLiveResponse_Delete File for CBLiveResponse: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for CBLiveResponse")
  ...
  @mcp.tool()
  async def cb_live_response_delete_file_from_cloud_storage(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      file_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the file name to delete. File name is case insensitive."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "CBLiveResponse_Delete File from Cloud Storage"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CBLiveResponse_Delete File from Cloud Storage for"
            f" CBLiveResponse: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
