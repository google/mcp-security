...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def symantec_email_security_cloud_block_entities(
      ...
      description: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a description that should be added to the blocked entities."
              ),
          ),
      ],
      remediation_action: Annotated[
          Optional[List[Any]],
          Field(
              default=None,
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "SymantecEmailSecurityCloud_Block Entities"
      ...
      try:
        ...
        print(
            "Error executing action SymantecEmailSecurityCloud_Block Entities for"
            f" SymantecEmailSecurityCloud: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
          f"Warning: No active integration instance found for"
          f" SymantecEmailSecurityCloud"
      )
      return {"Status": "Failed", "Message": "No active instance found."}

  @mcp.tool()
  async def symantec_email_security_cloud_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "SymantecEmailSecurityCloud_Ping"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SymantecEmailSecurityCloud_Ping for"
            f" SymantecEmailSecurityCloud: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
