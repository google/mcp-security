...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def exchange_extension_pack_add_senders_to_exchange_siemplify_mail_flow_rule(
      ...
      email_addresses: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the email addresses you would like to add to the rule, in a"
                  " comma separated list. If no parameter will be provided, action will"
                  " work with User entities."
              ),
          ),
      ],
    ...
    try:
      instance_response = await bindings.http_client.get(
          Endpoints.LIST_INTEGRATION_INSTANCES.format(
              INTEGRATION_NAME="ExchangeExtensionPack"
          )
      )
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          actionName=(
              "ExchangeExtensionPack_Add Senders to Exchange-Siemplify Mail Flow Rule"
          ),
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (  # Assuming same as actionName
                  "ExchangeExtensionPack_Add Senders to Exchange-Siemplify Mail Flow"
                  " Rule"
              ),
      ...
      try:
        ...
        print(
            "Error executing action ExchangeExtensionPack_Add Senders to"
            f" Exchange-Siemplify Mail Flow Rule for ExchangeExtensionPack: {e}"
        )
  ...
  @mcp.tool()
  async def exchange_extension_pack_fetch_compliance_search_results(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      compliance_search_name: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Name for the Compliance Search. Note that name shouldn't contain"
                  " special characters."
              ),
          ),
      ],
      max_emails_to_return: Annotated[
          Optional[str],
          Field(default=None, description="Specify how many emails action can return."),
      ],
      remove_compliance_search_once_action_completes: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "Specify whether action should remove from Exchange server the search"
                  " action and any related fetch or purge tasks once the action"
                  " completes."
              ),
          ),
      ],
      create_case_wall_output_table: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "Specify if action should create case wall output table. If Max"
                  " Emails To Return is set to a bigger number, its recommended to"
                  " uncheck this to increase action performance."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      if remove_compliance_search_once_action_completes is not None:
        script_params["Remove Compliance Search Once Action Completes?"] = (
            remove_compliance_search_once_action_completes
        )
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "ExchangeExtensionPack_Fetch Compliance Search Results"
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ExchangeExtensionPack_Fetch Compliance Search"
            f" Results for ExchangeExtensionPack: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for ExchangeExtensionPack")
  ...
  @mcp.tool()
  async def exchange_extension_pack_remove_domains_from_exchange_siemplify_mail_flow_rules(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      rule_to_remove_domains_from: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the rule to remove the Domains from. If the rule doesn't"
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          actionProvider="Scripts",  # Assuming constant based on example
          actionName=(
              "ExchangeExtensionPack_Remove Domains from Exchange-Siemplify Mail Flow"
              " Rules"
          ),
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (  # Assuming same as actionName
                  "ExchangeExtensionPack_Remove Domains from Exchange-Siemplify Mail"
                  " Flow Rules"
              ),
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ExchangeExtensionPack_Remove Domains from"
            f" Exchange-Siemplify Mail Flow Rules for ExchangeExtensionPack: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for ExchangeExtensionPack")
  ...
  @mcp.tool()
  async def exchange_extension_pack_delete_compliance_search(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "ExchangeExtensionPack_Delete Compliance Search"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ExchangeExtensionPack_Delete Compliance Search for"
            f" ExchangeExtensionPack: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for ExchangeExtensionPack")
  ...
  @mcp.tool()
  async def exchange_extension_pack_purge_compliance_search_results(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      perform_a_hard_delete_for_deleted_emails: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "Specify whether HardDelete should be performed. This option is"
                  " applies only to O365 and mark emails for permanent removal from the"
                  " mailbox."
              ),
          ),
      ],
    ...
    if instances:
      ...
      if perform_a_hard_delete_for_deleted_emails is not None:
        script_params["Perform a HardDelete for deleted emails?"] = (
            perform_a_hard_delete_for_deleted_emails
        )
      if remove_compliance_search_once_action_completes is not None:
        script_params["Remove Compliance Search Once Action Completes?"] = (
            remove_compliance_search_once_action_completes
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "ExchangeExtensionPack_Purge Compliance Search Results"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ExchangeExtensionPack_Purge Compliance Search"
            f" Results for ExchangeExtensionPack: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def exchange_extension_pack_add_domains_to_exchange_siemplify_mail_flow_rules(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          actionProvider="Scripts",  # Assuming constant based on example
          actionName=(
              "ExchangeExtensionPack_Add Domains to Exchange-Siemplify Mail Flow Rules"
          ),
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (  # Assuming same as actionName
                  "ExchangeExtensionPack_Add Domains to Exchange-Siemplify Mail Flow"
                  " Rules"
              ),
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ExchangeExtensionPack_Add Domains to"
            f" Exchange-Siemplify Mail Flow Rules for ExchangeExtensionPack: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def exchange_extension_pack_remove_senders_from_exchange_siemplify_mail_flow_rules(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      email_addresses: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the email addresses you would like to remove from the rule,"
                  " in a comma separated list. If no parameter will be provided, action"
                  " will work with entities."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          actionProvider="Scripts",  # Assuming constant based on example
          actionName=(
              "ExchangeExtensionPack_Remove Senders from Exchange-Siemplify Mail Flow"
              " Rules"
          ),
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (  # Assuming same as actionName
                  "ExchangeExtensionPack_Remove Senders from Exchange-Siemplify Mail"
                  " Flow Rules"
              ),
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ExchangeExtensionPack_Remove Senders from"
            f" Exchange-Siemplify Mail Flow Rules for ExchangeExtensionPack: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def exchange_extension_pack_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ExchangeExtensionPack_Ping for"
            f" ExchangeExtensionPack: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def exchange_extension_pack_run_compliance_search(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      location_to_search_emails_in: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Location to search emails in, can be one of the following: Comma"
                  " separate list of mailboxes. A distribution group or mail-enabled"
                  " security group All - for all mailboxes in organization."
              ),
          ),
      ],
      ...
      fetch_compliance_search_results: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "Specify whether the action should immediately fetch the compliance"
                  " search results. Note that maximum of 200 elements will be"
                  " displayed, but actual search can have more findings that are shown."
              ),
          ),
      ],
      max_emails_to_return: Annotated[
      ...
      advanced_query: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Instead of subject, sender or recipient filters, provide a query you"
                  " want to run compliance search on. Consider"
                  " https://docs.microsoft.com/en-us/sharepoint/dev/general-development/keyword-query-language-kql-syntax-reference"
                  " and https://docs.microsoft.com/en-us/exchange/message-properties-indexed-by-exchange-search-exchange-2013-help?redirectedfrom=MSDN"
                  " for reference on query syntax."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      if fetch_compliance_search_results is not None:
        script_params["Fetch Compliance Search Results?"] = (
            fetch_compliance_search_results
        )
      if max_emails_to_return is not None:
        script_params["Max Emails To Return"] = max_emails_to_return
      if create_case_wall_output_table is not None:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "ExchangeExtensionPack_Run Compliance Search"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ExchangeExtensionPack_Run Compliance Search for"
            f" ExchangeExtensionPack: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def exchange_extension_pack_list_exchange_siemplify_mail_flow_rules(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      rule_name_to_list: Annotated[
          List[Any],
          Field(..., description="Specify the Rule name you would like to list"),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (  # Assuming same as actionName
                  "ExchangeExtensionPack_List Exchange-Siemplify Mail Flow Rules"
              ),
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ExchangeExtensionPack_List Exchange-Siemplify Mail"
            f" Flow Rules for ExchangeExtensionPack: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for ExchangeExtensionPack")
  ...
  @mcp.tool()
  async def exchange_extension_pack_delete_exchange_siemplify_mail_flow_rules(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      rule_name_to_delete: Annotated[
          ...
          Field(
              ...,
              description="Specify the Rule name you would like to completely delete",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (  # Assuming same as actionName
                  "ExchangeExtensionPack_Delete Exchange-Siemplify Mail Flow Rules"
              ),
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ExchangeExtensionPack_Delete Exchange-Siemplify"
            f" Mail Flow Rules for ExchangeExtensionPack: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for ExchangeExtensionPack")
