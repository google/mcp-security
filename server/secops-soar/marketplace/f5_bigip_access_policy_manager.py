...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def f5_bigip_access_policy_manager_ping(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "F5BIGIPAccessPolicyManager_Ping"
      ...
      try:
        ...
        print(
            "Error executing action F5BIGIPAccessPolicyManager_Ping for"
            f" F5BIGIPAccessPolicyManager: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
          f"Warning: No active integration instance found for"
          f" F5BIGIPAccessPolicyManager"
      )
      return {"Status": "Failed", "Message": "No active instance found."}

  @mcp.tool()
  async def f5_bigip_access_policy_manager_list_active_sessions(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      limit: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the maximum number of entries you would like to get in the"
                  " action."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "F5BIGIPAccessPolicyManager_List Active Sessions"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action F5BIGIPAccessPolicyManager_List Active Sessions"
            f" for F5BIGIPAccessPolicyManager: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
  ...
  @mcp.tool()
  async def f5_bigip_access_policy_manager_disconnect_sessions(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      use_case_entities: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "Specify whether the action should disconnect sessions using Address"
                  " and Client IP entities found in the case, or work on the provided"
                  " parameters only. NOTE - once checked, action will ignore all other"
                  " parameters in the action"
              ),
          ),
      ],
      session_i_ds: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify specific session IDs you would like to disconnect, in a"
                  " comma separated list"
              ),
          ),
      ],
      logon_user_names: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify Logon User Names you would like to disconnect sessions for,"
                  " in a comma separated list, so only sessions for these Logon User"
                  " Names will be disconnected."
              ),
          ),
      ],
      client_i_ps: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify Client IPs you would like to disconnect the sessions for,in"
                  " a comma separated list, so only sessions for these Client IPs will"
                  " be disconnected."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "F5BIGIPAccessPolicyManager_Disconnect Sessions"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action F5BIGIPAccessPolicyManager_Disconnect Sessions for"
            f" F5BIGIPAccessPolicyManager: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
