...
def register_tools(mcp: FastMCP):
  ...
  async def microsoft_teams_list_chats(
      ...
      chat_type: Annotated[
          Optional[List[Any]],
          Field(
              default=None, description="Specify what type of chat should be returned."
          ),
      ],
    ...
    if instances:
      ...
      try:
        ...
        print(
            f"Error executing action MicrosoftTeams_List Chats for MicrosoftTeams: {e}"
        )
  ...
  @mcp.tool()
  async def microsoft_teams_create_chat(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action MicrosoftTeams_Create Chat for MicrosoftTeams: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for MicrosoftTeams")
  ...
  @mcp.tool()
  async def microsoft_teams_wait_for_reply(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      team_name: Annotated[str, Field(..., description="Specify name of the team.")],
      channel_name: Annotated[
          str, Field(..., description="Specify name of the channel.")
      ],
      message_id: Annotated[
          str,
          Field(
              ...,
              description="Specify ID of the message that is expected to have a reply.",
          ),
      ],
      expected_reply: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify text of the expected reply. If this value is not provided,"
                  " then action will stop execution on any reply."
              ),
          ),
      ],
      wait_method: Annotated[
          Optional[List[Any]],
          Field(
              default=None,
              description=(
                  'Specify the wait method for the action. If "Check First Reply" is'
                  " selected, action will either return the first reply or compare the"
                  ' first reply with expected value. If "Wait Till Timeout" is'
                  " selected, action will either wait for the expected value until"
                  " timeout is reached or return all of the messages that were sent"
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftTeams_Wait For Reply for"
            f" MicrosoftTeams: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_teams_create_channel(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      team_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the name of the team in which you need to create the"
                  " channel."
              ),
          ),
      ],
      channel_name: Annotated[
          str, Field(..., description="Specify a unique name of the channel.")
      ],
      channel_type: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the type of the channel that needs to be created. Standard"
                  " channel is accessible to all members of the team, while private"
                  " channel will require users to be added to it."
              ),
          ),
      ],
      description: Annotated[
          Optional[str],
          Field(default=None, description="Specify a description for the channel."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftTeams_Create Channel for"
            f" MicrosoftTeams: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_teams_list_channels(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      team_name: Annotated[str, Field(..., description="ul")],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftTeams_List Channels for"
            f" MicrosoftTeams: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_teams_send_user_message(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      text: Annotated[
          str, Field(..., description="Specify the content of the message.")
      ],
      user_identifiers: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of user identifiers to whom you want"
                  " to send a message."
              ),
          ),
      ],
      wait_for_reply: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If enabled, action will wait until replies from all entities are"
                  " available."
              ),
          ),
      ],
      content_type: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Specify the content type for the message."),
      ],
      user_selection: Annotated[
          Optional[List[Any]],
          Field(
              default=None,
              description=(
                  'Specify what selection should be used for users. If "From Entities &'
                  ' User Identifiers" is selected, then action will search in both'
                  ' relevant entities and values provided in the "User Identifiers"'
                  ' parameters. If "From Entities" is provided, action will only work'
                  ' with relevant entities and ignore values provided in the "User'
                  ' Identifiers". If "From User Identifiers" is selected, then action'
                  ' will only work with values from "User Identifiers" and "User'
                  ' Identifiers" parameter becomes mandatory.'
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftTeams_Send User Message"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftTeams_Send User Message for"
            f" MicrosoftTeams: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_teams_remove_users_from_channel(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      team_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the name of the team in which you want to search for the"
                  " channel."
              ),
          ),
      ],
      channel_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a name of the channel in which you want to remove users."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftTeams_Remove Users From Channel"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftTeams_Remove Users From Channel for"
            f" MicrosoftTeams: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_teams_send_message_reply(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      team_name: Annotated[
          str,
          Field(
              ..., description="Specify the team to which you want to send the reply."
          ),
      ],
      channel_name: Annotated[
          str,
          Field(
              ...,
              description="Specify the channel to which you want to send the reply.",
          ),
      ],
      message_id: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify the ID of the message to which you want to send the reply."
              ),
          ),
      ],
      text: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftTeams_Send Message Reply"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftTeams_Send Message Reply for"
            f" MicrosoftTeams: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_teams_generate_token(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      authorization_url: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Use the authorization URL received in the previous step to request"
                  " an access token."
              ),
          ),
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftTeams_Generate Token for"
            f" MicrosoftTeams: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_teams_add_users_to_channel(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      channel_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the name of the channel to which you want to add users."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftTeams_Add Users To Channel"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftTeams_Add Users To Channel for"
            f" MicrosoftTeams: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_teams_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def microsoft_teams_get_user_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      username: Annotated[str, Field(..., description="ul")],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
              default_factory=list,
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftTeams_Get User Details"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftTeams_Get User Details for"
            f" MicrosoftTeams: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_teams_delete_channel(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      team_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the name of the team in which you need to delete the"
                  " channel."
              ),
          ),
      ],
      channel_name: Annotated[
          str,
          Field(
              ..., description="Specify a name of the channel that needs to be deleted."
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftTeams_Delete Channel for"
            f" MicrosoftTeams: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_teams_list_teams(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      max_teams_to_return: Annotated[
          Optional[str],
          Field(
              default=None, description="Specify how many teams to return. Default: 50."
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action MicrosoftTeams_List Teams for MicrosoftTeams: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for MicrosoftTeams")
  ...
  @mcp.tool()
  async def microsoft_teams_get_team_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftTeams_Get Team Details"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftTeams_Get Team Details for"
            f" MicrosoftTeams: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_teams_get_authorization(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftTeams_Get Authorization"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftTeams_Get Authorization for"
            f" MicrosoftTeams: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  async def microsoft_teams_send_chat_message(
      ...
      chat_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the ID of the chat to which you want to send a message."
              ),
          ),
      ],
      text: Annotated[
      ...
      wait_for_reply: Annotated[
          Optional[bool],
          Field(default=None, description="If enabled, action will wait until reply."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftTeams_Send Chat Message"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftTeams_Send Chat Message for"
            f" MicrosoftTeams: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_teams_send_message(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      team_name: Annotated[str, Field(..., description="ul")],
      channel_name: Annotated[str, Field(..., description="ul")],
      message: Annotated[str, Field(..., description="ul")],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
              default_factory=list,
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftTeams_Send Message for"
            f" MicrosoftTeams: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_teams_list_users(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      max_users_to_return: Annotated[
          Optional[str],
          Field(
              default=None, description="Specify how many users to return. Default: 50."
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action MicrosoftTeams_List Users for MicrosoftTeams: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for MicrosoftTeams")
