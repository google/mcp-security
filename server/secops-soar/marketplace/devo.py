...
def register_tools(mcp: FastMCP):
  ...
  async def devo_advanced_query(
      ...
      query: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a query to execute against Devo instance. Example format:"
      ...
      end_time: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the start time for the query. This parameter is mandatory,"
  ...
  @mcp.tool()
  async def devo_simple_query(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      table_name: Annotated[
          str, Field(..., description="Specify what table should be queried.")
      ],
