...
def register_tools(mcp: FastMCP):
  ...
  async def http_get_data(
      ...
      username: Annotated[Optional[str], Field(default=None, description="")],
      password: Annotated[Optional[str], Field(default=None, description="")],
      ssl_verification: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "Whether to verify the SSL certificate of the destination server."
              ),
          ),
      ],
      ignore_http_error_codes: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action should ignore 4xx or 5xx HTTP error codes and not"
                  " return error."
              ),
          ),
      ],
      headers_json: Annotated[
          ...
          Field(
              default=None,
              description="JSON object of HTTP headers to be sent with the request.",
          ),
      ],
  ...
  async def http_get_url_data(
      ...
      username: Annotated[
          Optional[str],
          Field(
              default=None, description="Username for basic authentication. Optional."
          ),
      ],
      password: Annotated[
          Optional[str],
          Field(
              default=None, description="Password for basic authentication. Optional."
          ),
      ],
      ssl_verification: Annotated[
          Optional[bool],
  ...
  async def http_post_data(
      ...
      url: Annotated[str, Field(..., description="The url to send the request to.")],
      data: Annotated[
          str, Field(..., description="The data to send with the request.")
      ],
      username: Annotated[Optional[str], Field(default=None, description="")],
      password: Annotated[Optional[str], Field(default=None, description="")],
      ssl_verification: Annotated[
      ...
      content_type: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Content Type. If set to application/json the input data must be JSON"
                  " string."
              ),
          ),
      ],
