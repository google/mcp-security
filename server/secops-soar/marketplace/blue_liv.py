...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def blue_liv_add_labels_to_threats(
      ...
      module_type: Annotated[
          str, Field(..., description="Specify the module type the resource belongs to")
      ],
      module_id: Annotated[
          str, Field(..., description="Specify the module ID the resource belongs to")
      ],
      resource_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the Resource IDs, as a comma separated list, to add the"
                  " labels to"
              ),
          ),
      ],
      label_names: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the label names you would like to apply to the specified"
                  " threats, as a comma separated list. Please pay attention to"
  ...
  @mcp.tool()
  async def blue_liv_add_comment_to_a_threat(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      resource_id: Annotated[
          str, Field(..., description="Specify the Resource ID to add the comment to")
      ],
      comment_text: Annotated[
          str,
          Field(
              ...,
              description="Provide the comment you would like to add to the resource",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "BlueLiv_Add Comment to a Threat"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action BlueLiv_Add Comment to a Threat for BlueLiv: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for BlueLiv")
  ...
  @mcp.tool()
  async def blue_liv_list_entity_threats(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      label_filter: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of labels, that will be used to"
                  ' filter threats. Note: label filter works with "OR" logic.'
              ),
          ),
      ],
      module_filter: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of modules, that will be used to"
                  " filter threats."
              ),
          ),
      ],
      max_threats_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify how many threats to return per entity. If nothing is"
                  " specified action will return 50 threats."
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  @mcp.tool()
  async def blue_liv_mark_threat_as_a_favorite(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      favorite_status: Annotated[
          List[Any],
          Field(
              ...,
              description=(
                  "Provide the Favorite status you would like to apply on the specified"
                  " threat"
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "BlueLiv_Mark Threat as a Favorite"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action BlueLiv_Mark Threat as a Favorite for BlueLiv: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for BlueLiv")
  ...
  @mcp.tool()
  async def blue_liv_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      lowest_score_to_mark_as_suspicious: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify what should be the lowest score for the entity to be marked"
                  " as suspicious. Maximum: 10."
              ),
          ),
      ],
      create_insight: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If enabled, action will create insights containing information about"
                  " entities."
              ),
          ),
      ],
    ...
    if instances:
      ...
      script_params["Lowest Score To Mark as Suspicious"] = (
          lowest_score_to_mark_as_suspicious
      )
  ...
  @mcp.tool()
  async def blue_liv_remove_labels_from_threats(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      module_type: Annotated[
          str,
          Field(..., description="Specify the module type the resource belongs to."),
      ],
      module_id: Annotated[
          str, Field(..., description="Specify the module ID the resource belongs to.")
      ],
      resource_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of  resource IDs from which you want"
                  " to remove labels."
              ),
          ),
      ],
      label_names: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of labels that need to be removed."
                  " Please pay attention to lowercase and uppercase."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "BlueLiv_Remove Labels From Threats"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action BlueLiv_Remove Labels From Threats for"
            f" BlueLiv: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
