...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def azure_active_directory_force_password_update(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "AzureActiveDirectory_Force Password Update"
      ...
      try:
        ...
        print(
            "Error executing action AzureActiveDirectory_Force Password Update for"
            f" AzureActiveDirectory: {e}"
        )
  ...
  @mcp.tool()
  async def azure_active_directory_get_manager_contact_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureActiveDirectory_Get Manager Contact Details"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureActiveDirectory_Get Manager Contact Details"
            f" for AzureActiveDirectory: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for AzureActiveDirectory")
  ...
  @mcp.tool()
  async def azure_active_directory_disable_account(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureActiveDirectory_Disable Account"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureActiveDirectory_Disable Account for"
            f" AzureActiveDirectory: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def azure_active_directory_remove_user_from_a_group(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      user_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify user name to remove from the target group. User name should"
                  " be specified in username@domain format. Parameter accepts multiple"
      ...
      group_name: Annotated[
          Optional[str],
          Field(default=None, description="Specify group name to remove user from."),
      ],
      group_id: Annotated[
          Optional[str],
          Field(
              ...
              description=(
                  ...
                  ' If both "Group Name" and "Group ID" are provided, then "Group ID"'
                  " will have priority. Example of the id:"
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureActiveDirectory_Remove User from a Group"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureActiveDirectory_Remove User from a Group for"
            f" AzureActiveDirectory: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def azure_active_directory_enrich_user(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      fields_to_return: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "A comma-separated list of fields that you want to return. If nothing"
                  " is provided, action will return fields that are considered to be"
                  " default by API."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureActiveDirectory_Enrich User"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureActiveDirectory_Enrich User for"
            f" AzureActiveDirectory: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def azure_active_directory_enable_account(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureActiveDirectory_Enable Account"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureActiveDirectory_Enable Account for"
            f" AzureActiveDirectory: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def azure_active_directory_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureActiveDirectory_Ping for"
            f" AzureActiveDirectory: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def azure_active_directory_reset_user_password(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      password: Annotated[str, Field(..., description="User Authentication password.")],
      username: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "User name to change password for. Parameter expects value in a"
                  " username@domain format and accepts multiple values as a comma"
                  " separated string."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureActiveDirectory_Reset User Password"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureActiveDirectory_Reset User Password for"
            f" AzureActiveDirectory: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def azure_active_directory_revoke_user_session(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureActiveDirectory_Revoke User Session"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureActiveDirectory_Revoke User Session for"
            f" AzureActiveDirectory: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def azure_active_directory_list_groups(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      order_by: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specifies the result order. Groups are sorted by their display name."
              ),
          ),
      ],
      results_limit: Annotated[
          Optional[str],
          Field(default=None, description="Specify max number of groups to return."),
      ],
      filter_logic: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify what filter logic should be applied. Filtering is working on"
                  " the Name field."
              ),
          ),
      ],
      filter_value: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " Filtering is working on the Name field."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureActiveDirectory_List Groups"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureActiveDirectory_List Groups for"
            f" AzureActiveDirectory: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def azure_active_directory_list_members_in_the_group(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      group_name: Annotated[
          Optional[str],
          Field(
              default=None, description="Specify group name to return user list for."
          ),
      ],
      group_id: Annotated[
          Optional[str],
      ...
      filter_key: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the key that needs to be used to filter group members."
              ),
          ),
      ],
      filter_logic: Annotated[
      ...
      filter_value: Annotated[
          ...
          Field(
              ...
              description=(
                  "Specify what value should be used in the filter. If"
                  " \u201cEqual\u201c is selected, action will try to find the exact"
                  ' match among results and if "Contains" is selected, action will try'
                  " to find results that contain that substring. If nothing is provided"
                  " in this parameter, the filter will not be applied. Filtering logic"
                  ' is working based on the value  provided in the "Filter Key"'
                  " parameter."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureActiveDirectory_List Members in the Group"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureActiveDirectory_List Members in the Group for"
            f" AzureActiveDirectory: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def azure_active_directory_add_user_to_a_group(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      group_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Azure AD group id in 00e40000-1971-439d-80fc-d0e000001dbd format."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureActiveDirectory_Add User To a Group"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureActiveDirectory_Add User To a Group for"
            f" AzureActiveDirectory: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def azure_active_directory_is_user_in_a_group(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureActiveDirectory_Is User In a Group"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureActiveDirectory_Is User In a Group for"
            f" AzureActiveDirectory: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def azure_active_directory_enrich_host(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureActiveDirectory_Enrich Host"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureActiveDirectory_Enrich Host for"
            f" AzureActiveDirectory: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def azure_active_directory_list_users_groups_membership(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      user_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify user name to return groups membership for. User name should"
                  " be specified in username@domain format. Parameter accepts multiple"
                  " values as a comma separated string."
              ),
          ),
      ],
      return_only_security_enabled_groups: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, only security groups that the user is a member of will"
                  " be returned."
              ),
          ),
      ],
      return_detailed_groups_information: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, detailed information on the AD groups will be returned."
              ),
          ),
      ],
      filter_key: Annotated[
    ...
    if instances:
      ...
      if return_only_security_enabled_groups is not None:
        script_params["Return Only Security Enabled Groups"] = (
            return_only_security_enabled_groups
        )
      if return_detailed_groups_information is not None:
        script_params["Return Detailed Groups Information"] = (
            return_detailed_groups_information
        )
      if filter_key is not None:
        script_params["Filter Key"] = filter_key
      if filter_logic is not None:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureActiveDirectory_List User's Groups Membership"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureActiveDirectory_List User's Groups Membership"
            f" for AzureActiveDirectory: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def azure_active_directory_list_users(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      filter: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specifies which fields will be included in the results. By default,"
                  " we will return all the fields."
              ),
          ),
      ],
      ...
      order_by: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Specifies the result order."),
      ],
      results_limit: Annotated[
          Optional[str],
          Field(default=None, description="Specify max number of users to return."),
      ],
      advanced_filter_logic: Annotated[
          Optional[List[Any]],
          Field(
              default=None,
              description=(
                  "Specify what filter logic should be applied. Advanced filtering is"
                  " working on the Username (userPrincipalName) field."
              ),
          ),
      ],
      advanced_filter_value: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  ...
                  " will try to find results that contain that substring. If nothing is"
                  " provided in this parameter, the filter will not be applied. "
                  " Advanced filtering is working on the Username (userPrincipalName)"
                  " field."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureActiveDirectory_List Users"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureActiveDirectory_List Users for"
            f" AzureActiveDirectory: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
