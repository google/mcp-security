...
def register_tools(mcp: FastMCP):
  ...
  async def zendesk_create_ticket(
      ...
      assigned_user: Annotated[
          Optional[str], Field(default=None, description="User full name.")
      ],
      assignment_group: Annotated[
          Optional[str], Field(default=None, description="Group name.")
      ],
      priority: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Priority will be one of the following: urgent, high, normal or low."
              ),
          ),
      ],
      ticket_type: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "The ticket type will be one of the following: problem, incident,"
                  " question or task."
              ),
          ),
      ],
      tag: Annotated[Optional[str], Field(default=None, description="")],
      internal_note: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "Specify whether the comment should be public, or internal. Unchecked"
                  " means it will be public, checked means it will be internal only."
              ),
          ),
      ],
      email_c_cs: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of email addresses, which should also"
                  " receive the notification of the ticket creation. Note: at max 48"
                  " email CCs can be added. This is Zendesk limitation."
              ),
          ),
      ],
      validate_email_c_cs: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will try to check that users with emails provided"
                  " in \u201cEmail CCs\u201c parameter exist. If at least one user"
                  " doesn\u2019t exist, action will fail. If this parameter is"
                  " disabled, action will not perform this check."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def zendesk_get_ticket_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ticket_id: Annotated[str, Field(..., description="The ID f the ticket.")],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
              default_factory=list,
  ...
  @mcp.tool()
  async def zendesk_add_comment_to_ticket(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ticket_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the Zendesk Ticket ID for which you would like to add a"
                  " comment."
              ),
          ),
      ],
      comment_body: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Provide the text you would like to be contained in the comment body"
              ),
          ),
      ],
      internal_note: Annotated[
      ...
      author_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the name of the author, please make sure this name exists on"
                  " Zendesk"
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def zendesk_apply_macros_on_ticket(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ticket_id: Annotated[str, Field(..., description="Ticket number.")],
      macro_title: Annotated[str, Field(..., description="")],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
              default_factory=list,
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Zendesk_Apply Macros On Ticket"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
  ...
  async def zendesk_update_ticket(
      ...
      ticket_id: Annotated[str, Field(..., description="Ticket number.")],
      subject: Annotated[
          Optional[str], Field(default=None, description="The subject of the ticket.")
      ],
      assigned_user: Annotated[
          Optional[str], Field(default=None, description="User full name.")
      ],
      ...
      tag: Annotated[
          Optional[str], Field(default=None, description="Tag to add to the ticket.")
      ],
      status: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "The status will be one of the following: new, open, pending, hold,"
                  " solved or closed."
              ),
          ),
      ],
      ...
      additional_comment: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "If you want to add a comment to the ticket, specify the text you"
                  " would like to add as a comment here."
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  async def zendesk_search_tickets(
      ...
      search_query: Annotated[
          str, Field(..., description="Query content(e.g: type:ticket status:pending).")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
