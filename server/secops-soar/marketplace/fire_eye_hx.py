...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def fire_eye_hx_is_contain_malware_alerts(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "FireEyeHX_Is Contain Malware Alerts"
      ...
      try:
        ...
        print(
            "Error executing action FireEyeHX_Is Contain Malware Alerts for"
            f" FireEyeHX: {e}"
        )
  ...
  @mcp.tool()
  async def fire_eye_hx_cancel_host_contain(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action FireEyeHX_Cancel Host Contain for FireEyeHX: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for FireEyeHX")
  ...
  @mcp.tool()
  async def fire_eye_hx_get_host_alert_groups(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      acknowledgment_filter: Annotated[
          Optional[List[Any]],
          Field(
              default=None,
              description=(
                  "Specify whether you want to return all of the alert groups or only"
                  " acknowledged/unacknowledged."
              ),
          ),
      ],
      max_alert_groups_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify how many Alert Groups to return per entity. Default: 20."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "FireEyeHX_Get Host Alert Groups"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action FireEyeHX_Get Host Alert Groups for FireEyeHX: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for FireEyeHX")
  ...
  @mcp.tool()
  async def fire_eye_hx_contain_host(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      approve_containment: Annotated[
          bool,
          Field(
              ...,
              description=(
                  "Specify if containment request for host should be automatically"
                  " approved to create contain host task on FireEye HX server. If not"
                  " approved automatically, containment request can be approved in"
                  " FireEye HX web console."
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  @mcp.tool()
  async def fire_eye_hx_get_host_info(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def fire_eye_hx_get_alert_group_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      alert_group_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of Alert Group IDs for which you want"
                  " to retrieve details."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "FireEyeHX_Get Alert Group Details"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action FireEyeHX_Get Alert Group Details for"
            f" FireEyeHX: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def fire_eye_hx_get_alerts_in_alert_group(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      limit: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the maximum amount of alerts listings coming back from the"
                  " API, for the alert group. Default is 50."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "FireEyeHX_Get Alerts in Alert Group"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action FireEyeHX_Get Alerts in Alert Group for"
            f" FireEyeHX: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def fire_eye_hx_acknowledge_alert_groups(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      alert_groups_i_ds: Annotated[
          str,
          Field(
              ...,
      ...
      acknowledgment: Annotated[
          List[Any],
          Field(
              ...,
              description=(
                  "Specify whether you would like to Acknowledge or Un-acknowledge the"
                  " specified alert groups"
              ),
          ),
      ],
      acknowledgment_comment: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the acknowledgment comment you would like to add to the"
                  " relevant alert groups"
              ),
          ),
      ],
      limit: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the maximum amount of alert group listings coming back from"
                  " the API, in the JSON result."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "FireEyeHX_Acknowledge Alert Groups"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action FireEyeHX_Acknowledge Alert Groups for"
            f" FireEyeHX: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def fire_eye_hx_get_list_of_file_acquisitions_for_host(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      search_term: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Searches all file acquisitions for hosts connected to the FireEye HX"
                  " server. The search_term can be any condition value."
              ),
          ),
      ],
      limit: Annotated[
          ...
          Field(
              default=None,
              description="How many records action should return, for example, 100.",
          ),
      ],
      filter_field: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Lists only results with the specified field value, results can be"
                  " filtered by external correlation identifier (external_id)."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "FireEyeHX_Get List of File Acquisitions For Host"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action FireEyeHX_Get List of File Acquisitions For Host"
            f" for FireEyeHX: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def fire_eye_hx_get_alerts(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      has_share_mode: Annotated[
          Optional[List[Any]],
          Field(
              default=None,
              description=(
                  "Filter alerts that were triggered from indicators with specific"
                  " share mode. Available values: any, restricted, unrestricted."
              ),
          ),
      ],
      alert_resolution_status: Annotated[
          Optional[List[Any]],
          Field(
              default=None,
              description=(
                  "Filter alerts based on alert resolution status. Available values:"
                  " any, active_threat, alert, block, partial_block."
              ),
          ),
      ],
      alert_reported_in_last_x_hours: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Filter alerts reported in last x hours, for example last 4 hours."
              ),
          ),
      ],
      alert_source: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Source of alert. Available values: any, exd (exploit detection), mal"
                  " (malware alert), ioc (indicator of compromise)."
              ),
          ),
      ],
      alert_id: Annotated[
          Optional[str],
          Field(default=None, description="Return specific alert by alert identifier."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def fire_eye_hx_get_indicators(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      indicator_category: Annotated[
          Optional[str], Field(default=None, description="The indicator category.")
      ],
      search_term: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "The search term can be any name, category, signature, source, or"
                  " condition value."
              ),
          ),
      ],
      limit: Annotated[
          ...
          Field(
              default=None,
              description="How many indicators action should return, for example, 100.",
          ),
      ],
      share_mode: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Filter indicators based on specific share mode. Available values:"
                  " any, restricted, unrestricted, visible."
              ),
          ),
      ],
      sort_by_field: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Sorts the results by the specified field in ascending order."
              ),
          ),
      ],
      created_by: Annotated[
          Optional[str],
          Field(default=None, description="Filter indicators based on author."),
      ],
      has_associated_alerts: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "Specify if only indicators, which have associated alerts should be"
                  " returned."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def fire_eye_hx_get_indicator(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      indicator_category: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify indicator category uri_name value. uri_name can be found by"
                  " running \u201cGet Indicators\u201d action."
              ),
          ),
      ],
      indicator_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify indicator uri_name value. uri_name can be found by running"
