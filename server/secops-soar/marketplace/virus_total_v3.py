...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def virus_total_v3_add_comment_to_entity(
      ...
      comment: Annotated[
          str,
          Field(
              ..., description="Specify the comment that should be added to entities."
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "VirusTotalV3_Add Comment To Entity"
      ...
      try:
        ...
        print(
            "Error executing action VirusTotalV3_Add Comment To Entity for"
            f" VirusTotalV3: {e}"
        )
  ...
  @mcp.tool()
  async def virus_total_v3_search_io_cs(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      query: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the query according to the VirusTotal query search syntax."
              ),
          ),
      ],
      order_by: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the order by the selected field, in which results are"
                  " returned. Default: Use Default Order. Note: Entity types might have"
                  " different ordering fields. Refer to the VT Intelligence corpus"
                  " https://docs.virustotal.com/reference/intelligence-search for more"
                  " information."
              ),
          ),
      ],
      create_entities: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will create entities for the returned IOCs. Note:"
      ...
      sort_order: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the direction in which the results should be returned. If"
                  " \u201cUse Default Order\u201d is chosen for \u201cOrder By\u201d"
                  " field, this parameter will be ignored."
              ),
          ),
      ],
      max_io_cs_to_return: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify how many IOCs to return. Max IOCs to return is 300."
                  " Default: 10."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def virus_total_v3_enrich_hash(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      engine_threshold: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify how many engines should mark the entity as malicious or"
                  " suspicious, for Siemplify to label it as suspicious. Note: if"
                  ' "Engine Whitelist" contains values, action will only count results'
                  " from those engines."
              ),
          ),
      ],
      engine_percentage_threshold: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the percentage of engines should mark the entity as"
                  " malicious or suspicious, for Siemplify to label it as suspicious."
                  ' Note: if "Engine Whitelist" contains values, action will only count'
                  ' the percentage from those engines. If both "Engine Threshold" and'
                  ' "Engine Percentage Threshold" are provided, "Engine Threshold" will'
                  " be used. Maximum value: 100. Minimum: 0."
              ),
          ),
      ],
      engine_whitelist: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of engines that should be used to"
                  " retrieve information, whether an entity is malicious or not."
                  " Example: AlienVault,Kaspersky. Note: if nothing is specified in"
                  " this parameter, action will take results from every available"
                  " engine. If the engine didn't return any information about the"
                  ' entity it\u2019s not going to be counted for the parameters "Engine'
                  ' Threshold" and "Engine Percentage Threshold".'
              ),
          ),
      ],
      resubmit_hash: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will resubmit hashes for analysis instead of"
                  " using the latest information."
              ),
          ),
      ],
      resubmit_after_days: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify how many days since the last submission should pass for the"
                  ' entity to be submitted again. Note: parameter "Resubmit Hash" needs'
                  " to be enabled."
              ),
          ),
      ],
      retrieve_comments: Annotated[
          Optional[bool],
          Field(
              default=None,
      ...
      retrieve_sigma_analysis: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will retrieve sigma analysis for the hash."
              ),
          ),
      ],
      sandbox: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of sandbox names that should be used"
                  " for behavior analysis. If nothing is provided, action will only use"
                  ' the "VirusTotal Jujubox" sandbox. Make sure that the spelling is'
                  " correct. Examples of sandboxes: VirusTotal Jujubox, VirusTotal"
                  " ZenBox, Microsoft Sysinternals, Tencent HABO."
              ),
          ),
      ],
      retrieve_sandbox_analysis: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will fetch sandbox analysis for the entity. For"
                  " each sandbox, action will create a separate section in the JSON"
                  " result. Action will only return data for the sandboxes that are"
                  ' provided in the parameter "Sandbox".'
              ),
          ),
      ],
      ...
      max_comments_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify how many comments to return. Default: 10.",
          ),
      ],
      widget_theme: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Specify the theme for the widget."),
      ],
      fetch_widget: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will fetch augmented widget related to the"
                  " entity."
              ),
          ),
      ],
      fetch_mitre_details: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will return information about related MITRE"
                  " techniques and tactics."
              ),
          ),
      ],
      lowest_mitre_technique_severity: Annotated[
          Optional[List[Any]],
          Field(
              default=None,
              description=(
                  "Specify the lowest signature severity related to MITRE technique for"
    ...
    if instances:
      ...
      if lowest_mitre_technique_severity is not None:
        script_params["Lowest MITRE Technique Severity"] = (
            lowest_mitre_technique_severity
        )
  ...
  @mcp.tool()
  async def virus_total_v3_get_related_i_ps(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      results: Annotated[
          ...
          Field(
              default=None,
              description=(
                  'Specify how the JSON result should look like. If "Combined" is'
                  " selected then action will return all of the unique results that"
                  ' were found among the provided entities. If "Per Entity" is'
                  " selected, then action will return all of the unique items per"
                  " entity."
              ),
          ),
      ],
      max_i_ps_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify how many URLs to return. Depending on the parameter"
                  ' "Results", this parameter will behave differently. For "Combined"'
                  " the limit will define how many results to return from ALL entities."
                  ' For "Per Entity" this parameter dictates how many results to return'
                  " per entity. Default: 40."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action VirusTotalV3_Get Related IPs for VirusTotalV3: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for VirusTotalV3")
  ...
  @mcp.tool()
  async def virus_total_v3_get_related_domains(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "VirusTotalV3_Get Related Domains"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action VirusTotalV3_Get Related Domains for"
            f" VirusTotalV3: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def virus_total_v3_enrich_ip(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def virus_total_v3_get_domain_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      engine_threshold: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify how many engines should mark the domain as malicious or"
                  ' suspicious, for Siemplify to label it as risky. Note: if "Engine'
                  ' Whitelist" contains values, action will only count results from'
                  " those engines."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "VirusTotalV3_Get Domain Details"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action VirusTotalV3_Get Domain Details for"
            f" VirusTotalV3: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def virus_total_v3_search_graphs(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      query: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the query filter for the graph. Please refer to the"
      ...
      sort_field: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Specify what should be the sort field."),
      ],
      max_graphs_to_return: Annotated[
          Optional[str],
          Field(default=None, description="Specify how many graphs to return."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action VirusTotalV3_Search Graphs for VirusTotalV3: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for VirusTotalV3")
  ...
  @mcp.tool()
  async def virus_total_v3_search_entity_graphs(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "VirusTotalV3_Search Entity Graphs"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action VirusTotalV3_Search Entity Graphs for"
            f" VirusTotalV3: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def virus_total_v3_enrich_ioc(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      io_cs: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of IOCs for which you want to ingest"
                  " data."
              ),
          ),
      ],
      ioc_type: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Specify the type of the IOC."),
      ],
      widget_theme: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Specify the theme for the widget."),
  ...
  @mcp.tool()
  async def virus_total_v3_download_file(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      download_folder_path: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the path to the folder, where you want to store the files."
              ),
          ),
      ],
      overwrite: Annotated[
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action VirusTotalV3_Download File for VirusTotalV3: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for VirusTotalV3")
  ...
  @mcp.tool()
  async def virus_total_v3_get_related_hashes(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      max_hashes_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "VirusTotalV3_Get Related Hashes"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action VirusTotalV3_Get Related Hashes for"
            f" VirusTotalV3: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def virus_total_v3_add_vote_to_entity(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      vote: Annotated[
          List[Any],
          Field(..., description="Specify the vote that should be added to entities."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "VirusTotalV3_Add Vote To Entity"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action VirusTotalV3_Add Vote To Entity for"
            f" VirusTotalV3: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def virus_total_v3_get_graph_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      graph_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of graph ids for which you want to"
      ...
      max_links_to_return: Annotated[
          Optional[str],
          Field(default=None, description="Specify how many links to return."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "VirusTotalV3_Get Graph Details"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action VirusTotalV3_Get Graph Details for"
            f" VirusTotalV3: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def virus_total_v3_enrich_url(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      resubmit_url: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will resubmit urls for analysis instead of using"
      ...
      resubmit_after_days: Annotated[
          ...
          Field(
              ...
              description=(
                  "Specify how many days since the last submission should pass for the"
                  ' entity to be submitted again. Note: parameter "Resubmit URL" needs'
                  " to be enabled. Default: 30."
              ),
          ),
      ],
      widget_theme: Annotated[
  ...
  @mcp.tool()
  async def virus_total_v3_submit_file(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      file_paths: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of absolute file paths. Note: if"
                  ' "Linux Server Address" is specified, action will try to fetch file'
                  " from remote server."
              ),
          ),
      ],
      engine_threshold: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify how many engines should mark the file as malicious or"
                  ' suspicious, for Siemplify to label it as risky. Note: if "Engine'
                  ' Whitelist" contains values, action will only count results from'
                  " those engines."
              ),
      ...
      max_comments_to_return: Annotated[
          Optional[str],
          Field(default=None, description="Specify how many comments to return."),
      ],
      linux_server_address: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the IP address of the remote linux server, where the file is"
                  " located."
              ),
          ),
      ],
      linux_username: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the username of the remote linux server, where the file is"
                  " located."
              ),
          ),
      ],
      linux_password: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the password of the remote linux server, where the file is"
                  " located."
              ),
          ),
      ],
      private_submission: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will submit the file privately. Note: this"
                  " functionality requires premium VT access."
              ),
          ),
      ],
      fetch_mitre_details: Annotated[
      ...
      retrieve_ai_summary: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "Experimental. If enabled, action will retrieve an AI Summary for the"
                  " submitted file. AI Summary is only available for private"
                  " submissions."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def virus_total_v3_get_related_ur_ls(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action VirusTotalV3_Get Related URLs for"
            f" VirusTotalV3: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
