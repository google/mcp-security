...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def stellar_cyber_starlight_simple_search(
      ...
      index: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify in which index do you want to search. You can find a list of"
                  " known indexes in the documentation."
              ),
          ),
      ],
      query: Annotated[
          str, Field(..., description="Specify query filter for the search.")
      ],
      max_results_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify how many results to return in response.",
          ),
      ],
      sort_field: Annotated[
          ...
          Field(
              default=None,
              description="Specify the field, which should be used for sorting.",
          ),
      ],
      sort_order: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Specify the sort order for the result."),
      ],
    ...
    try:
      instance_response = await bindings.http_client.get(
          Endpoints.LIST_INTEGRATION_INSTANCES.format(
              INTEGRATION_NAME="StellarCyberStarlight"
          )
      )
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "StellarCyberStarlight_Simple Search"
      ...
      try:
        ...
        print(
            "Error executing action StellarCyberStarlight_Simple Search for"
            f" StellarCyberStarlight: {e}"
        )
  ...
  @mcp.tool()
  async def stellar_cyber_starlight_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action StellarCyberStarlight_Ping for"
            f" StellarCyberStarlight: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def stellar_cyber_starlight_update_security_event(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      index: Annotated[
          str, Field(..., description="Specify the index of the security event.")
      ],
      id: Annotated[
          str, Field(..., description="Specify the ID of the security event.")
      ],
      status: Annotated[
          List[Any],
          Field(..., description="Specify the new status for the security event."),
      ],
      comment: Annotated[
          Optional[str],
          Field(default=None, description="Specify a comment for the security event."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "StellarCyberStarlight_Update Security Event"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action StellarCyberStarlight_Update Security Event for"
            f" StellarCyberStarlight: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def stellar_cyber_starlight_advanced_search(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      dsl_query: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the json object of the DSL query that you want to execute."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "StellarCyberStarlight_Advanced Search"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action StellarCyberStarlight_Advanced Search for"
            f" StellarCyberStarlight: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
