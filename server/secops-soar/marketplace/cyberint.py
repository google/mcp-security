...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def cyberint_update_alert(
      ...
      alert_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the id of the alert that would need to have the status"
                  " updated."
              ),
          ),
      ],
      status: Annotated[
          ...
          Field(
              default=None,
              description=(
                  'Specify the status for the event. Note: if "Closed" is selected,'
                  ' "Closure Reason" needs to be provided as well.'
              ),
          ),
      ],
      closure_reason: Annotated[
          Optional[List[Any]],
          Field(
              default=None, description="Specify the closure reason for closed status."
          ),
      ],
