...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def sophos_list_alert_actions(
      ...
      alert_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the ID of the alert for which you want to retrieve details."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def sophos_add_entities_to_blocklist(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      comment: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the comment explaining why the hash was sent to blocklist."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Sophos_Add Entities To Blocklist"
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action Sophos_Add Entities To Blocklist for Sophos: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for Sophos")
  ...
  @mcp.tool()
  async def sophos_get_services_status(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def sophos_scan_endpoints(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def sophos_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def sophos_add_entities_to_allowlist(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      comment: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the comment explaining why the hash was sent to allowlist."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Sophos_Add Entities To Allowlist"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action Sophos_Add Entities To Allowlist for Sophos: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for Sophos")
  ...
  @mcp.tool()
  async def sophos_isolate_endpoint(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      comment: Annotated[
          ...
          Field(
              ...,
              description="Specify the comment explaining why the isolation is needed.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
  ...
  @mcp.tool()
  async def sophos_execute_alert_actions(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      alert_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the ID of the alert on which you want to execute the action."
              ),
          ),
      ],
      action: Annotated[
          List[Any],
          Field(
              ..., description="Specify an action that should be executed on the alert."
          ),
      ],
      message: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify a message explaining why the action was executed.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
  ...
  @mcp.tool()
  async def sophos_get_events_log(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      timeframe: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify how many hours backwards events should be retrieved. Note:"
                  " if the user provides more than 24 hours, action will still use 24."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def sophos_unisolate_endpoint(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      comment: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the comment explaining why the unisolation is needed."
              ),
          ),
      ],
      target_entities: Annotated[
