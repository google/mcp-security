...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def microsoft_graph_security_list_incidents(
      ...
      filter_key: Annotated[
          ...
          Field(
              default=None,
              description="Specify the key that needs to be used to filter incidents.",
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "MicrosoftGraphSecurity_List Incidents"
      ...
      try:
        ...
        print(
            "Error executing action MicrosoftGraphSecurity_List Incidents for"
            f" MicrosoftGraphSecurity: {e}"
        )
  ...
  @mcp.tool()
  async def microsoft_graph_security_kill_user_session(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      user_principal_name_id: Annotated[
          str,
          Field(
              ...,
              description=(
                  "The user's username used during sign in or the user Unique ID"
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphSecurity_Kill User Session"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphSecurity_Kill User Session for"
            f" MicrosoftGraphSecurity: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_graph_security_update_alert(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      alert_id: Annotated[
          str, Field(..., description="The ID of the alert to update.")
      ],
      ...
      closed_date_time: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Time at which the alert was closed. The Timestamp type represents"
      ...
      comments: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " separated by comma. This method can update the comments field with"
                  " the following values only: Closed in IPC, Closed in MCAS."
              ),
          ),
      ],
      feedback: Annotated[
      ...
      status: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Alert lifecycle status (stage). Possible values are: unknown,"
                  " newAlert, inProgress, resolved."
              ),
          ),
      ],
      tags: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "User-definable labels that can be applied to an alert. Separated by"
                  " comma"
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphSecurity_Update Alert"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphSecurity_Update Alert for"
            f" MicrosoftGraphSecurity: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_graph_security_get_alert(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      alert_id: Annotated[str, Field(..., description="ul")],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
              default_factory=list,
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphSecurity_Get Alert"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphSecurity_Get Alert for"
            f" MicrosoftGraphSecurity: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_graph_security_list_alerts(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphSecurity_List Alerts"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphSecurity_List Alerts for"
            f" MicrosoftGraphSecurity: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_graph_security_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphSecurity_Ping for"
            f" MicrosoftGraphSecurity: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_graph_security_add_alert_comment(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphSecurity_Add Alert Comment"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphSecurity_Add Alert Comment for"
            f" MicrosoftGraphSecurity: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def microsoft_graph_security_get_administrator_consent(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      redirect_url: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Use the redirect url you registered to request an authorization."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphSecurity_Get Administrator Consent"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphSecurity_Get Administrator Consent"
            f" for MicrosoftGraphSecurity: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for MicrosoftGraphSecurity")
  ...
  @mcp.tool()
  async def microsoft_graph_security_get_incident(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      incident_id: Annotated[
          str, Field(..., description="Specify the ID of the incident.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MicrosoftGraphSecurity_Get Incident"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MicrosoftGraphSecurity_Get Incident for"
            f" MicrosoftGraphSecurity: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
