...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def siemplify_threat_fuse_get_related_i_ps(
      ...
      confidence_threshold: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify what should be the confidence threshold. Note: Maximum is"
                  " 100."
              ),
          ),
      ],
      search_observables: Annotated[
          bool,
          Field(..., description="If enabled, action will search among observables."),
      ],
      search_threat_bulletins: Annotated[
          bool,
          Field(
              ..., description="If enabled, action will search among threat bulletins."
          ),
      ],
      search_actors: Annotated[
          bool, Field(..., description="If enabled, action will search among actors.")
      ],
      search_attack_patterns: Annotated[
          bool,
          Field(
              ..., description="If enabled, action will search among attack patterns."
          ),
      ],
      search_campaigns: Annotated[
          bool,
          Field(..., description="If enabled, action will search among campaigns."),
      ],
      search_courses_of_action: Annotated[
          bool,
          Field(
              ..., description="If enabled, action will search among courses of action."
          ),
      ],
      search_identities: Annotated[
          bool,
          Field(..., description="If enabled, action will search among identities."),
      ],
      search_incidents: Annotated[
          bool,
          Field(..., description="If enabled, action will search among incidents."),
      ],
      search_infrastructures: Annotated[
          bool,
          Field(
              ..., description="If enabled, action will search among infrastructures."
          ),
      ],
      search_intrusion_sets: Annotated[
          bool,
          Field(
              ..., description="If enabled, action will search among intrusion sets."
          ),
      ],
      search_malware: Annotated[
          bool, Field(..., description="If enabled, action will search among malware.")
      ],
      search_signatures: Annotated[
          bool,
          Field(..., description="If enabled, action will search among signatures."),
      ],
      search_tools: Annotated[
          bool, Field(..., description="If enabled, action will search among tools.")
      ],
      search_tt_ps: Annotated[
          bool, Field(..., description="If enabled, action will search among TTPs.")
      ],
      search_vulnerabilities: Annotated[
          bool,
          Field(
              ..., description="If enabled, action will search among vulnerabilities."
          ),
      ],
      max_i_ps_to_return: Annotated[
          Optional[str],
          Field(
              default=None, description="Specify how many IPs to return. Default: 50."
          ),
      ],
    ...
    try:
      instance_response = await bindings.http_client.get(
          Endpoints.LIST_INTEGRATION_INSTANCES.format(
              INTEGRATION_NAME="SiemplifyThreatFuse"
          )
      )
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "SiemplifyThreatFuse_Get Related IPs"
      ...
      try:
        ...
        print(
            "Error executing action SiemplifyThreatFuse_Get Related IPs for"
            f" SiemplifyThreatFuse: {e}"
        )
  ...
  @mcp.tool()
  async def siemplify_threat_fuse_get_related_domains(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      max_domains_to_return: Annotated[
          ...
          Field(
              default=None,
              description="Specify how many domains to return. Default: 50.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "SiemplifyThreatFuse_Get Related Domains"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SiemplifyThreatFuse_Get Related Domains for"
            f" SiemplifyThreatFuse: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def siemplify_threat_fuse_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SiemplifyThreatFuse_Ping for"
            f" SiemplifyThreatFuse: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def siemplify_threat_fuse_submit_observables(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      classification: Annotated[
          List[Any],
          Field(..., description="Specify the classification of the observable."),
      ],
      threat_type: Annotated[
          List[Any],
          Field(..., description="Specify the threat type of the observables."),
      ],
      source: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify the intelligence source for the observable.",
          ),
      ],
      expiration_date: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the expiration date in days for the observable. If nothing"
                  " is specified here, action will create an observable that will never"
                  " expire."
              ),
          ),
      ],
      trusted_circle_i_ds: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the comma-separated list of trusted circle ids. Observables"
                  " will be shared with those trusted circles."
              ),
          ),
      ],
      tlp: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Specify the TLP for your observables."),
      ],
      confidence: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify what should be the confidence for the observable. Note: this"
                  " parameter will only work, if you create observables in your"
                  " organization and requires 'Override System Confidence' to be"
                  " enabled."
              ),
          ),
      ],
      override_system_confidence: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, created observables will have the confidence specified"
                  " in the 'Confidence' parameter. Note: you can't share observables in"
                  " trusted circles and publicly, when this parameter is enabled."
              ),
          ),
      ],
      anonymous_submission: Annotated[
          Optional[bool],
          Field(
              default=None,
              description="If enabled, action will make an anonymous submission.",
          ),
      ],
      tags: Annotated[
          Optional[str],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "SiemplifyThreatFuse_Submit Observables"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SiemplifyThreatFuse_Submit Observables for"
            f" SiemplifyThreatFuse: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def siemplify_threat_fuse_get_related_associations(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      create_insight: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If enabled, action will create an insight base on the results."
              ),
          ),
      ],
      ...
      max_statistics_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify how many top statistics results regarding IOCs to return."
                  " Note: action will at max process 1000 IOCs related to the"
                  ' association. If you provide "0", action will not try to fetch'
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "SiemplifyThreatFuse_Get Related Associations"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SiemplifyThreatFuse_Get Related Associations for"
            f" SiemplifyThreatFuse: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def siemplify_threat_fuse_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      add_threat_type_to_case: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will add threat types of the entity from all"
      ...
      only_suspicious_entity_insight: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If enabled, action will create insight only for entities that"
                  ' exceeded the "Severity Threshold" and "Confidence Threshold".'
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "SiemplifyThreatFuse_Enrich Entities"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SiemplifyThreatFuse_Enrich Entities for"
            f" SiemplifyThreatFuse: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def siemplify_threat_fuse_get_related_hashes(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      max_hashes_to_return: Annotated[
          ...
          Field(
              default=None,
              description="Specify how many hashes to return. Default: 50.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "SiemplifyThreatFuse_Get Related Hashes"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SiemplifyThreatFuse_Get Related Hashes for"
            f" SiemplifyThreatFuse: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def siemplify_threat_fuse_get_related_email_addresses(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      max_email_addresses_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify how many email addresses to return. Default: 50.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "SiemplifyThreatFuse_Get Related Email Addresses"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SiemplifyThreatFuse_Get Related Email Addresses"
            f" for SiemplifyThreatFuse: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for SiemplifyThreatFuse")
  ...
  @mcp.tool()
  async def siemplify_threat_fuse_get_related_ur_ls(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "SiemplifyThreatFuse_Get Related URLs"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SiemplifyThreatFuse_Get Related URLs for"
            f" SiemplifyThreatFuse: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
