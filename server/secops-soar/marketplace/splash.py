...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def splash_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      include_png_screenshot: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will return a PNG screenshot in an insight. Note:"
                  " \u201cCreate Insight\u201d should be enabled for this parameter to"
                  " work."
              ),
          ),
      ],
      include_history: Annotated[
          ...
          Field(
              default=None,
              description="If enabled, action will return history information.",
          ),
      ],
      include_har: Annotated[
          Optional[bool],
          Field(
              default=None,
              description="If enabled, action will return HAR information.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
