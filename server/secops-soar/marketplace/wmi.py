...
def register_tools(mcp: FastMCP):
  ...
  async def wmi_run_query(
      ...
      server_address: Annotated[str, Field(..., description="")],
      wql_query: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Query content(e.g: SELECT Caption, Description FROM"
