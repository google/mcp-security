...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def exabeam_advanced_analytics_list_watchlist_items(
      ...
      watchlist_titles: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of watchlist titles for which you"
      ...
      max_items_to_return: Annotated[
          ...
          Field(
              default=None,
              description="Specify how many watchlist items should be returned.",
          ),
      ],
      max_days_backwards: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify how many days backwards to list watchlists. Default: 1"
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "ExabeamAdvancedAnalytics_List Watchlist Items"
      ...
      try:
        ...
        print(
            "Error executing action ExabeamAdvancedAnalytics_List Watchlist Items for"
            f" ExabeamAdvancedAnalytics: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
          f"Warning: No active integration instance found for ExabeamAdvancedAnalytics"
      )
      return {"Status": "Failed", "Message": "No active instance found."}

  @mcp.tool()
  async def exabeam_advanced_analytics_delete_watchlist(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      watchlist_title: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify the title of the watchlist that needs to be deleted."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "ExabeamAdvancedAnalytics_Delete Watchlist"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ExabeamAdvancedAnalytics_Delete Watchlist for"
            f" ExabeamAdvancedAnalytics: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def exabeam_advanced_analytics_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ExabeamAdvancedAnalytics_Ping for"
            f" ExabeamAdvancedAnalytics: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def exabeam_advanced_analytics_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      return_entity_timeline: Annotated[
          bool,
          Field(
              ...,
              description="If enabled, action will return the timeline for the entity.",
          ),
      ],
      event_time_frame: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the frame for the events that you want to see in hours."
              ),
          ),
      ],
      only_anomaly_events: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will only return events that are considered to be"
                  " anomalies."
              ),
          ),
      ],
      lowest_event_risk_score_to_fetch: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify what should be the lowest risk score of the event in order"
                  " to ingest it. If nothing is specified, action will not do any"
                  " filtering."
              ),
          ),
      ],
      return_comments: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will return comments related to the entity."
              ),
          ),
      ],
      create_insight: Annotated[
          ...
          Field(
              default=None,
              description="If enabled, action will create an insight per entity.",
          ),
      ],
      max_events_to_return: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify how many events should be returned. If nothing is specified,"
                  " action will return all of the events."
              ),
          ),
      ],
    ...
    if instances:
      ...
      if lowest_event_risk_score_to_fetch is not None:
        script_params["Lowest Event Risk Score To Fetch"] = (
            lowest_event_risk_score_to_fetch
        )
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "ExabeamAdvancedAnalytics_Enrich Entities"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ExabeamAdvancedAnalytics_Enrich Entities for"
            f" ExabeamAdvancedAnalytics: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def exabeam_advanced_analytics_create_watchlist(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      title: Annotated[
          str, Field(..., description="Specify the title of the watchlist.")
      ],
      category: Annotated[
          List[Any], Field(..., description="Specify the category for the watchlist.")
      ],
      access_control: Annotated[
          List[Any],
          Field(..., description="Specify the access control for the watchlist."),
      ],
      description: Annotated[
          Optional[str],
          Field(default=None, description="Specify description for the watchlist."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "ExabeamAdvancedAnalytics_Create Watchlist"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ExabeamAdvancedAnalytics_Create Watchlist for"
            f" ExabeamAdvancedAnalytics: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def exabeam_advanced_analytics_add_comments_to_entity(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      comment: Annotated[
          ...
          Field(
              ...,
              description="Specify the comment that needs to be added to the entity.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "ExabeamAdvancedAnalytics_Add Comments To Entity"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ExabeamAdvancedAnalytics_Add Comments To Entity"
            f" for ExabeamAdvancedAnalytics: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
  ...
  @mcp.tool()
  async def exabeam_advanced_analytics_remove_entity_from_watchlist(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      watchlist_title: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the title of the watchlist from which you want to remove"
                  " entities."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "ExabeamAdvancedAnalytics_Remove Entity From Watchlist"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ExabeamAdvancedAnalytics_Remove Entity From"
            f" Watchlist for ExabeamAdvancedAnalytics: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
  ...
  @mcp.tool()
  async def exabeam_advanced_analytics_add_entity_to_watchlist(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      watchlist_title: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the title of the watchlist of which you want to add"
                  " entities."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "ExabeamAdvancedAnalytics_Add Entity To Watchlist"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ExabeamAdvancedAnalytics_Add Entity To Watchlist"
            f" for ExabeamAdvancedAnalytics: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def exabeam_advanced_analytics_list_watchlists(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      max_watchlists_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify how many watchlists should be returned.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "ExabeamAdvancedAnalytics_List Watchlists"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ExabeamAdvancedAnalytics_List Watchlists for"
            f" ExabeamAdvancedAnalytics: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
