...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def google_cloud_armor_create_a_security_policy(
      ...
      policy_json: Annotated[
          ...
          Field(
              ...,
              description=(
                  "The JSON definition of the policy to create. For more information"
                  " about policies, see REST Resource: securityPolicies"
      ...
      region: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "The region to create a policy in. If no value is provided, the"
                  " global-level security policy is created."
              ),
          ),
      ],
    ...
    try:
      instance_response = await bindings.http_client.get(
          Endpoints.LIST_INTEGRATION_INSTANCES.format(
              INTEGRATION_NAME="GoogleCloudArmor"
          )
      )
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "GoogleCloudArmor_Create a Security Policy"
      ...
      try:
        ...
        print(
            "Error executing action GoogleCloudArmor_Create a Security Policy for"
            f" GoogleCloudArmor: {e}"
        )
  ...
  @mcp.tool()
  async def google_cloud_armor_update_a_security_policy(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      policy_name: Annotated[
          str, Field(..., description="Security policy name to update.")
      ],
      policy_json: Annotated[
          Union[str, dict],
          Field(
              ...,
              description=(
                  "JSON definition of the policy to update. For more information about"
                  " the policy updates, see Method: securityPolicies.patch"
                  " (https://cloud.google.com/compute/docs/reference/rest/v1/securityPolicies/patch)."
                  " You cannot update rules with this action. To add a rule to a"
                  " policy, use the Add a Rule to a Security Policy action."
              ),
          ),
      ],
      region: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Region for the updated policy. If no value is provided, the"
                  " global-level security policy is created."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "GoogleCloudArmor_Update a Security Policy"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action GoogleCloudArmor_Update a Security Policy for"
            f" GoogleCloudArmor: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def google_cloud_armor_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def google_cloud_armor_add_a_rule_to_a_security_policy(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      policy_name: Annotated[
          str, Field(..., description="Security policy name to add a new rule to.")
      ],
      rule_json: Annotated[
          Union[str, dict],
          Field(
              ...,
              description=(
                  "JSON definition of the rule to add. For more information about"
                  " adding a rule to a policy, see Method: securityPolicies.addRule"
      ...
      region: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Region for the policy to add the rule in. If no value is provided,"
                  " the rule is added to the global-level security policy."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "GoogleCloudArmor_Add a Rule to a Security Policy"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action GoogleCloudArmor_Add a Rule to a Security Policy"
            f" for GoogleCloudArmor: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for GoogleCloudArmor")
