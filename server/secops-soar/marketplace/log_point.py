...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def log_point_list_repos(
      ...
      max_repos_to_return: Annotated[
          Optional[str],
          Field(
              default=None, description="Specify how many reports should be returned."
          ),
      ],
  ...
  @mcp.tool()
  async def log_point_execute_query(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      time_frame: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the time frame for the query. If \u201cCustom\u201d is"
                  " selected, you need to also provide start time and end time."
              ),
          ),
      ],
      start_time: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the start time for the query. Format: YYYY-MM-DDThh:mm:ssZ"
                  " or timestamp."
              ),
          ),
      ],
      end_time: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the end time for the query.Format: YYYY-MM-DDThh:mm:ssZ or"
                  " timestamp. If nothing is provided action will use current time as"
                  " end time."
              ),
          ),
      ],
      repos: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of names of the repos. If nothing is"
                  " provided, action will search in all repos."
              ),
          ),
      ],
      max_results_to_return: Annotated[
          Optional[str],
          Field(
              default=None, description="Specify how many results should be returned."
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
  ...
  @mcp.tool()
  async def log_point_update_incident_status(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      incident_id: Annotated[
          ...
          Field(
              ...,
              description="Specify the id of the incident, which you want to update.",
          ),
      ],
      action: Annotated[
          List[Any], Field(..., description="Specify the action for the incident.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "LogPoint_Update Incident Status"
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action LogPoint_Update Incident Status for LogPoint: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for LogPoint")
  ...
  @mcp.tool()
  async def log_point_execute_entity_query(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      query: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the query that needs to be executed. Please refer to the"
                  " action documentation for details."
              ),
          ),
      ],
      time_frame: Annotated[
          ...
          Field(
              ...,
              description=(
                  'Specify the time frame for the query. If "Custom" is selected, you'
                  " need also provide start time, end time by default will be current"
                  " time."
              ),
          ),
      ],
      stop_if_not_enough_entities: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  ' Example: if "IP Entity Key" and "File Hash Entity Keys" are'
      ...
      hostname_entity_key: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " preparing the filter. Please refer to the action documentation for"
                  " details."
              ),
          ),
      ],
