...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def outpost24_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      finding_risk_level_filter: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of risk level findings that will be"
                  " used during filtering. Possible values: Initial, Recommendation,"
                  " Low, Medium, High, Critical. If nothing is provided, action will"
                  " fetch findings with all risk levels."
              ),
          ),
      ],
      max_findings_to_return: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify how many findings to process per entity. If nothing is"
                  " provided, action will return 100 findings."
              ),
          ),
      ],
      return_finding_information: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will also retrieve information about findings"
