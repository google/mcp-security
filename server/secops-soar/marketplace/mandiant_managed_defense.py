...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def mandiant_managed_defense_ping(
    ...
    try:
      instance_response = await bindings.http_client.get(
          Endpoints.LIST_INTEGRATION_INSTANCES.format(
              INTEGRATION_NAME="MandiantManagedDefense"
          )
      )
    ...
    if instances:
      ...
      try:
        ...
        print(
            "Error executing action MandiantManagedDefense_Ping for"
            f" MandiantManagedDefense: {e}"
        )
