...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def symantec_blue_coat_proxy_sg_block_entities(
    ...
    try:
      instance_response = await bindings.http_client.get(
          Endpoints.LIST_INTEGRATION_INSTANCES.format(
              INTEGRATION_NAME="SymantecBlueCoatProxySG"
          )
      )
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "SymantecBlueCoatProxySG_Block Entities"
      ...
      try:
        ...
        print(
            "Error executing action SymantecBlueCoatProxySG_Block Entities for"
            f" SymantecBlueCoatProxySG: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
          f"Warning: No active integration instance found for SymantecBlueCoatProxySG"
      )
      return {"Status": "Failed", "Message": "No active instance found."}

  @mcp.tool()
  async def symantec_blue_coat_proxy_sg_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SymantecBlueCoatProxySG_Ping for"
            f" SymantecBlueCoatProxySG: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def symantec_blue_coat_proxy_sg_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "SymantecBlueCoatProxySG_Enrich Entities"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SymantecBlueCoatProxySG_Enrich Entities for"
            f" SymantecBlueCoatProxySG: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
