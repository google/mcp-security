...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def snowflake_execute_simple_query(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      database: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the name of the database in which you want to execute the"
                  " query."
              ),
          ),
      ],
      table: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the name of the table in which you want to execute the"
                  " query."
              ),
          ),
      ],
      schema: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the name of the schema in which you want to execute the"
                  " query."
              ),
          ),
      ],
      where_filter: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " Note: you don't need to limit and sort. Also, you don\u2019t need"
                  " to provide WHERE string in the payload. Only single quotes are"
                  " supported in the query."
              ),
          ),
      ],
      fields_to_return: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " return all fields. Wildcard character is supported."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Snowflake_Execute Simple Query"
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action Snowflake_Execute Simple Query for Snowflake: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for Snowflake")
  ...
  @mcp.tool()
  async def snowflake_execute_custom_query(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      query: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the query that needs to be executed in Snowflake. Note:"
                  " query shouldn't contain LIMIT keyword, because it\u2019s added"
                  " automatically. Only single quotes are supported in the query."
              ),
          ),
      ],
      database: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Snowflake_Execute Custom Query"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action Snowflake_Execute Custom Query for Snowflake: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for Snowflake")
