...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def cofense_triage_add_tags_to_report(
      ...
      report_id: Annotated[
          ...
          Field(
              ...,
              description="Specify the id of the report to which you want to add tags.",
          ),
      ],
      tags: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of tags that need to be applied to"
                  " the report."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "CofenseTriage_Add Tags To Report"
      ...
      try:
        ...
        print(
            "Error executing action CofenseTriage_Add Tags To Report for"
            f" CofenseTriage: {e}"
        )
  ...
  @mcp.tool()
  async def cofense_triage_categorize_report(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      category_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the name of the category that should be applied to the"
                  " report. Available categories can be found in the \u201cList"
                  " Categories\u201d action."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "CofenseTriage_Categorize Report"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CofenseTriage_Categorize Report for"
            f" CofenseTriage: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cofense_triage_execute_playbook(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      report_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the ID of the report on which you want to execute the"
                  " playbook."
              ),
          ),
      ],
      playbook_name: Annotated[
          ...
          Field(
              ...,
              description="Specify the name of the playbook that needs to be executed.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "CofenseTriage_Execute Playbook"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CofenseTriage_Execute Playbook for"
            f" CofenseTriage: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cofense_triage_list_playbooks(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      filter_logic: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  ' Note: "Equals" logic is case sensitive, while "Contains" is case'
                  " insensitive."
              ),
          ),
      ],
      ...
      max_records_to_return: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " will return 50 records. Maximum: 200."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CofenseTriage_List Playbooks for"
            f" CofenseTriage: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cofense_triage_list_reports_related_to_threat_indicators(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      create_case_wall_table: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If enabled, action will create a case wall table with information"
                  " about reports,"
              ),
          ),
      ],
      max_reports_to_return: Annotated[
          Optional[str],
          Field(default=None, description="Specify how many reports to return."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "CofenseTriage_List Reports Related To Threat Indicators"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CofenseTriage_List Reports Related To Threat"
            f" Indicators for CofenseTriage: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for CofenseTriage")
  ...
  @mcp.tool()
  async def cofense_triage_get_report_headers(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      report_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the id of the report for which you want to retrieve headers."
              ),
          ),
      ],
      max_headers_to_return: Annotated[
          Optional[str],
          Field(default=None, description="Specify how many headers to return."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "CofenseTriage_Get Report Headers"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CofenseTriage_Get Report Headers for"
            f" CofenseTriage: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cofense_triage_get_domain_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "CofenseTriage_Get Domain Details"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CofenseTriage_Get Domain Details for"
            f" CofenseTriage: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cofense_triage_get_report_reporters(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      report_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the id of the report for which you want to retrieve"
                  " reporters."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "CofenseTriage_Get Report Reporters"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CofenseTriage_Get Report Reporters for"
            f" CofenseTriage: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cofense_triage_list_categories(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      names: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of category names, This parameter is"
                  " useful to check, whether a category with the specified name exists."
              ),
          ),
      ],
      lowest_score_to_fetch: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify what should be the lowest accepted score for the category."
                  " This parameter can work with negative values."
              ),
          ),
      ],
      only_malicious: Annotated[
          Optional[bool],
          Field(
              default=None,
              description="If enabled, action will only return malicious categories.",
          ),
      ],
      only_archived: Annotated[
          ...
          Field(
              default=None,
              description="If enabled, action will only return archived categories.",
          ),
      ],
      only_non_archived: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will return only non-archived categories."
              ),
          ),
      ],
      only_non_malicious: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will return only non-malicious categories."
              ),
          ),
      ],
      max_categories_to_return: Annotated[
          Optional[str],
          Field(default=None, description="Specify how many categories to return."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CofenseTriage_List Categories for"
            f" CofenseTriage: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cofense_triage_get_threat_indicator_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "CofenseTriage_Get Threat Indicator Details"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CofenseTriage_Get Threat Indicator Details for"
            f" CofenseTriage: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cofense_triage_download_report_preview(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      report_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the ID of the report, which contains the raw email that"
      ...
      download_folder: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the absolute path to the download folder. Note: Name will be"
                  " constructed in the following way {report id}.eml."
              ),
          ),
      ],
      image_format: Annotated[
          List[Any], Field(..., description="Specify the format of the image.")
      ],
      overwrite: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will overwrite the file with the same name and"
                  " filepath."
              ),
          ),
      ],
      create_insight: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If enabled, action will create an insight that contains raw email of"
                  " the report."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "CofenseTriage_Download Report Preview"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CofenseTriage_Download Report Preview for"
            f" CofenseTriage: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cofense_triage_download_report_email(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "CofenseTriage_Download Report Email"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CofenseTriage_Download Report Email for"
            f" CofenseTriage: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cofense_triage_enrich_url(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      risk_score_threshold: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify, what should be the risk score threshold for Siemplify to"
                  " label that URL as suspicious. Maximum is 100."
              ),
          ),
      ],
      target_entities: Annotated[
