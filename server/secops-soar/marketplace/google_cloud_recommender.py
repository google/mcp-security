...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def google_cloud_recommender_get_recommendation(
      ...
      recommendation_name: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify the recommendation name to return. Action accepts multiple"
                  " values as a comma separated string. Example of expected input:"
    ...
    try:
      instance_response = await bindings.http_client.get(
          Endpoints.LIST_INTEGRATION_INSTANCES.format(
              INTEGRATION_NAME="GoogleCloudRecommender"
          )
      )
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "GoogleCloudRecommender_Get Recommendation"
      ...
      try:
        ...
        print(
            "Error executing action GoogleCloudRecommender_Get Recommendation for"
            f" GoogleCloudRecommender: {e}"
        )
  ...
  @mcp.tool()
  async def google_cloud_recommender_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action GoogleCloudRecommender_Ping for"
            f" GoogleCloudRecommender: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def google_cloud_recommender_apply_iam_recommendations(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      iam_recommendations_json: Annotated[
          Union[str, dict],
          Field(
              ...,
              description=(
                  "Specify the JSON of the recommendation to apply to. JSON can be"
                  " provided as a placeholder from \u201cList Recommendations\u201d or"
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "GoogleCloudRecommender_Apply IAM Recommendations"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action GoogleCloudRecommender_Apply IAM Recommendations"
            f" for GoogleCloudRecommender: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for GoogleCloudRecommender")
  ...
  @mcp.tool()
  async def google_cloud_recommender_list_recommendations(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      recommendation_location: Annotated[
          str,
          Field(
              ..., description="Specify the GCP location to fetch recommendations for."
          ),
      ],
      recommendation_filter: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the filter to fetch the recommendations for. Parameter"
                  ' expects a string of a format "<projects or organizations>/<project'
                  ' or organization name or id>" or'
                  ' "//cloudresourcemanager.googleapis.com/<projects or'
                  ' organizations>/<project or organization name or id>" for which to'
                  " fetch the recommendations for. If nothing is provided - action will"
                  " take the project id from the service account configured."
              ),
          ),
      ],
      recommendation_state: Annotated[
          Optional[List[Any]],
          Field(
              default=None, description="Specify the recommendation state to return."
          ),
      ],
      recommendation_priority: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the recommender priority to return, multiple values can be"
                  " specified as a comma separated string."
              ),
          ),
      ],
      recommender_subtype: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Specify the recommender subtype to return."),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "GoogleCloudRecommender_List Recommendations"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action GoogleCloudRecommender_List Recommendations for"
            f" GoogleCloudRecommender: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def google_cloud_recommender_update_recommendation(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      recommendation_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the recommendation name to update. Action accepts multiple"
                  " values as a comma separated string. Example of expected input:"
                  " projects/projectname/locations/global/recommenders/google.iam.policy.Recommender/recommendations/0f262740-bf4a-4c3d-9573-0da3345cf3f7"
              ),
          ),
      ...
      recommendation_state: Annotated[
          ...
          Field(
              default=None,
              description="Specify the state for the recommendation to change to.",
          ),
      ],
      recommendation_result: Annotated[
          Optional[List[Any]],
          Field(
              default=None,
              description="Specify the result for the recommendation to change to.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "GoogleCloudRecommender_Update Recommendation"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action GoogleCloudRecommender_Update Recommendation for"
            f" GoogleCloudRecommender: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
