...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def siemplify_get_similar_cases(
      ...
      rule_generator: Annotated[
          bool,
          Field(
              ...,
              description=(
                  "Search for similar cases by the same Rule Generator. Note: All these"
                  " search criteria are joined using logical 'AND' condition and will"
      ...
      port: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Search for similar cases by the same Port number. Note: All these"
                  " search criteria are joined using logical 'AND' condition and will"
                  " be used in the same search."
              ),
          ),
      ],
      category_outcome: Annotated[
          bool,
          Field(
              ...,
              description=(
                  "Search for similar cases by the same Category Outcome. Note: All"
                  " these search criteria are joined using logical 'AND' condition and"
                  " will be used in the same search."
              ),
          ),
      ],
      entity_identifier: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " Note: All these search criteria are joined using logical 'AND'"
      ...
      days_back: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Defines how many days back the search should look for similar cases."
              ),
          ),
      ],
      include_open_cases: Annotated[
          Optional[bool], Field(default=None, description="Search open cases")
      ],
      include_closed_cases: Annotated[
          Optional[bool], Field(default=None, description="Search closed cases")
      ],
  ...
  @mcp.tool()
  async def siemplify_mark_as_important(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def siemplify_create_or_update_entity_properties(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      entity_field: Annotated[
          str, Field(..., description="Field that has to be created or updated.")
      ],
      field_value: Annotated[
          str, Field(..., description="Value that has to be set to the field.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Siemplify_Create Or Update Entity Properties"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Siemplify_Create Or Update Entity Properties for"
            f" Siemplify: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def siemplify_change_priority(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      priority: Annotated[
          Any, Field(..., description="Priority, which should be set for the case.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def siemplify_create_gemini_case_summary(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Siemplify_Create Gemini Case Summary"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Siemplify_Create Gemini Case Summary for"
            f" Siemplify: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def siemplify_set_risk_score(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      risk_score: Annotated[
          str, Field(..., description="Specify risk score that needs to be set.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def siemplify_set_custom_fields(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      custom_fields_data: Annotated[
          ...
          Field(
              ...,
              description=(
                  "The values to update for the custom fields. You can update multiple"
                  " custom fields in a single action run."
              ),
          ),
      ],
      append_values: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  'If selected, the action appends the inputs from the "Custom Fields'
                  ' Data" parameter to the existing values of the custom fields. If not'
                  " selected, the action overwrites the existing values with the inputs"
                  ' from the "Custom Fields Data" parameter. Not selected by default.'
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  @mcp.tool()
  async def siemplify_set_case_sla(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      sla_period: Annotated[
          str,
          Field(
              ..., description="The period of time after which the SLA is in breach."
          ),
      ],
      sla_time_unit: Annotated[
          List[Any], Field(..., description="Specify the unit for SLA Time.")
      ],
      sla_time_to_critical_period: Annotated[
          str,
          Field(
              ...,
              description=(
      ...
      sla_time_to_critical_unit: Annotated[
          List[Any],
          Field(..., description="Specify the unit for SLA Time To Critical."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def siemplify_is_in_custom_list(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      category: Annotated[str, Field(..., description="Custom list category.")],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
              default_factory=list,
  ...
  @mcp.tool()
  async def siemplify_test_siemplify_proxy(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      endpoint_url: Annotated[
          str, Field(..., description="The endpoint to try to connect to")
      ],
      ...
      verify_ssl: Annotated[
          bool, Field(..., description="Whether to verify SSL certificate or not.")
      ],
      body: Annotated[
          Optional[str], Field(default=None, description="The body of the HTTP request")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def siemplify_case_tag(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      tag: Annotated[str, Field(..., description="Tag to be added to the case.")],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
              default_factory=list,
  ...
  @mcp.tool()
  async def siemplify_close_alert(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      reason: Annotated[Any, Field(..., description="Alert closure reason.")],
      ...
      assign_to_user: Annotated[
          Optional[Any],
          Field(
              default=None, description="User that the closed case will be assigned to."
          ),
      ],
      tags: Annotated[
          Optional[str], Field(default=None, description="Comma separated tags values.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def siemplify_add_to_custom_list(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      category: Annotated[
          str, Field(..., description="Custom list category to be used.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def siemplify_case_comment(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      comment: Annotated[
          str, Field(..., description="Comment to be added to the case.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def siemplify_permitted_alert_time(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      permitted_start_time: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Start of the timeframe, when alerts are allowed. For example:"
                  " 9:55:24"
              ),
          ),
      ],
      permitted_end_time: Annotated[
          str,
          Field(
              ...,
              description=(
                  "End of the timeframe, when alerts are allowed. For example: 17:23:21"
              ),
          ),
      ],
      input_timezone: Annotated[
          str, Field(..., description="Timezone name. For example: UTC")
      ],
      monday: Annotated[Optional[bool], Field(default=None, description="")],
      tuesday: Annotated[Optional[bool], Field(default=None, description="")],
      wednesday: Annotated[Optional[bool], Field(default=None, description="")],
      thursday: Annotated[Optional[bool], Field(default=None, description="")],
      friday: Annotated[Optional[bool], Field(default=None, description="")],
      saturday: Annotated[Optional[bool], Field(default=None, description="")],
      sunday: Annotated[Optional[bool], Field(default=None, description="")],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
              default_factory=list,
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Siemplify_Permitted Alert Time"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action Siemplify_Permitted Alert Time for Siemplify: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for Siemplify")
  ...
  @mcp.tool()
  async def siemplify_open_web_url(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      title: Annotated[str, Field(..., description="Title for URL.")],
  ...
  @mcp.tool()
  async def siemplify_change_case_stage(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      stage: Annotated[
          Any, Field(..., description="Stage to which the case should be moved to.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def siemplify_add_general_insight(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      title: Annotated[str, Field(..., description="The title of the insight.")],
      message: Annotated[
          str, Field(..., description="The message that will be placed on the insight.")
      ],
      triggered_by: Annotated[
          Optional[str],
          Field(
              default=None, description="A description for the cause of this insight"
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action Siemplify_Add General Insight for Siemplify: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for Siemplify")
  ...
  @mcp.tool()
  async def siemplify_resume_alert_sla(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def siemplify_instruction(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      instruction: Annotated[str, Field(..., description="Instruction content.")],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
              default_factory=list,
  ...
  @mcp.tool()
  async def siemplify_get_case_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      fields_to_return: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " If nothing is provided, all fields are returned. Getting nested"
                  ' values can be done using \\"Nested Keys Delimiter\\" value to chain'
                  " nested keys and list indexes. For example, if the delimiter is"
                  ' \\".\\": key_1.nested_key_1.0.nested_key_2, key_2,'
                  " key_3.1.nested_key_1"
              ),
          ),
      ],
      nested_keys_delimiter: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "The delimiter to split nested keys. If missing or not provided"
                  ' fetching nested keys is not possible. Cannot be a comma (\\",\\")'
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  @mcp.tool()
  async def siemplify_set_scope_context_value(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      context_scope: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the Siemplify context scope to return context keys for."
              ),
          ),
      ],
      key_name: Annotated[
          str, Field(..., description="Specify the key name to set context value for.")
      ],
      key_value: Annotated[
          str,
          Field(..., description="Specify the value to store under the specified key."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Siemplify_Set Scope Context Value"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Siemplify_Set Scope Context Value for"
            f" Siemplify: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def siemplify_add_tags_to_similar_cases(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Siemplify_Add Tags To Similar Cases"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Siemplify_Add Tags To Similar Cases for"
            f" Siemplify: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def siemplify_add_entity_insight(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      message: Annotated[str, Field(..., description="Message content to be added.")],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
              default_factory=list,
  ...
  @mcp.tool()
  async def siemplify_attach_playbook_to_alert(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      playbook_name: Annotated[
          Any, Field(..., description="Playbook, which should be attached to an alert.")
      ],
      allow_duplicates: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If selected, action will allow the same playbook to be attached"
                  " multiple times to the alert."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Siemplify_Attach Playbook to Alert"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Siemplify_Attach Playbook to Alert for"
            f" Siemplify: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def siemplify_close_case(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      reason: Annotated[Any, Field(..., description="Closure reason.")],
      root_cause: Annotated[
          Any, Field(..., description="Root cause of the case closure.")
      ],
      comment: Annotated[str, Field(..., description="Comment content.")],
      target_entities: Annotated[
          List[TargetEntity],
  ...
  @mcp.tool()
  async def siemplify_assign_case(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def siemplify_wait_for_custom_fields(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      custom_fields_data: Annotated[
          ...
          Field(
              ...,
              description=(
                  "The conditions that are required for the custom fields for the"
                  " action to resume running a playbook. Configure the custom field"
                  " names and their required values as a JSON object.\nIf you set"
                  " conditions for multiple fields, the action waits for all fields to"
                  " match their respective conditions.\nThe action behavior depends on"
                  " the input that you provide.\nFor the action to resume running a"
                  " playbook with any value in a custom field, configure an empty"
                  " string for the custom field as follows:\n{\n\u201cCustom"
                  " Field\u201d: \u201c\u201d\n}\nFor the action to resume running a"
                  " playbook when the custom field equals to a specific value"
                  " (\u201cValue 1\u201d), specify the value for the custom field as"
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Siemplify_Wait For Custom Fields"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Siemplify_Wait For Custom Fields for"
            f" Siemplify: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def siemplify_create_entity(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      entities_identifies: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Entity identifier or comma-separated list of identifiers (Example:"
      ...
      is_internal: Annotated[
          bool,
          Field(..., description="Mark if entities are part of an internal network."),
      ],
      is_suspicious: Annotated[
          bool, Field(..., description="Mark if entities are suspicious.")
      ],
      delimiter: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Provide a delimiter character, with which the action will split the"
                  " input it gets into a number of entities instead of a single one. If"
                  " no value will be provided, action will not perform any splitting on"
                  " the input, and it will be handled as a single entity. Note - Please"
                  " make sure to read our documentation regarding the differences in"
                  " the delimiter's behavior, between different Siemplify's platform"
                  " versions 5.6.0 inclusive and 5.6.2 exclusive."
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  @mcp.tool()
  async def siemplify_update_case_description(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      description: Annotated[
          str,
          Field(
              ..., description="Specify what description should be set for the case."
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Siemplify_Update Case Description"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Siemplify_Update Case Description for"
            f" Siemplify: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def siemplify_raise_incident(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      soc_role: Annotated[
          Optional[Any],
          Field(default=None, description="Role to which the case should be assigned."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def siemplify_run_remote(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      publisher_name: Annotated[
          str, Field(..., description="Publisher instance name to be used.")
      ],
      remote_integration_name: Annotated[
          str, Field(..., description="Remote integration name to be used.")
      ],
      remote_action_name: Annotated[
          str, Field(..., description="Remote action name to be used.")
      ],
      remote_context_data: Annotated[
          str, Field(..., description="Remote action context data.")
      ],
      remote_action_script: Annotated[
          str, Field(..., description="Remote action script content to be executed.")
      ],
      agent_id: Annotated[str, Field(..., description="Action's target agent id.")],
      installed_integrations_shared_folder: Annotated[
          str, Field(..., description="Installed Integrations Shared Folder")
      ],
      verify_ssl: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "Enables\\Disables SSL Verification between Siemplify's machine and"
    ...
    if instances:
      ...
      script_params["Installed Integrations Shared Folder"] = (
          installed_integrations_shared_folder
      )
  ...
  @mcp.tool()
  async def siemplify_pause_alert_sla(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      message: Annotated[
          Optional[str], Field(default=None, description="Pause Reason")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def siemplify_remove_from_custom_list(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Siemplify_Remove from Custom List"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Siemplify_Remove from Custom List for"
            f" Siemplify: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def siemplify_change_alert_priority(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      alert_priority: Annotated[
          Any, Field(..., description="Priority to which the alert should be moved to.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Siemplify_Change Alert Priority"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action Siemplify_Change Alert Priority for Siemplify: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for Siemplify")
  ...
  @mcp.tool()
  async def siemplify_set_alert_sla(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def siemplify_get_connector_context_value(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      connector_identifier: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify connector identifier to list context keys for. Parameter"
                  ' works together with "Connector Identifier Filter Logic" parameter'
              ),
          ),
      ],
      key_name: Annotated[
          ...
          Field(
              ...,
              description="Optionally specify the key name to get context value for.",
          ),
      ],
      create_case_wall_table: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, the case wall table will be created as part of action"
                  " results."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Siemplify_Get Connector Context Value"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Siemplify_Get Connector Context Value for"
            f" Siemplify: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def siemplify_get_scope_context_value(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Siemplify_Get Scope Context Value"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Siemplify_Get Scope Context Value for"
            f" Siemplify: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def siemplify_remove_tag(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      tag: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the tag that needs to be removed. Comma seperated values."
              ),
          ),
      ],
      target_entities: Annotated[
