...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def sumo_logic_cloud_siem_add_tags_to_insight(
      ...
      insight_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the ID of the insight to which action needs to add tags."
              ),
          ),
      ],
      tags: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of tags that needs to be added in"
                  " insight."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "SumoLogicCloudSIEM_Add Tags To Insight"
      ...
      try:
        ...
        print(
            "Error executing action SumoLogicCloudSIEM_Add Tags To Insight for"
            f" SumoLogicCloudSIEM: {e}"
        )
  ...
  @mcp.tool()
  async def sumo_logic_cloud_siem_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SumoLogicCloudSIEM_Ping for"
            f" SumoLogicCloudSIEM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def sumo_logic_cloud_siem_update_insight(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      insight_id: Annotated[
          str,
          Field(..., description="Specify the ID of the insight needs to be updated."),
      ],
      status: Annotated[
          List[Any],
          Field(..., description="Specify what status to set for the insight."),
      ],
      ...
      assignee: Annotated[
          Optional[str],
          Field(default=None, description="Specify the assignee identifier."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "SumoLogicCloudSIEM_Update Insight"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SumoLogicCloudSIEM_Update Insight for"
            f" SumoLogicCloudSIEM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def sumo_logic_cloud_siem_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "SumoLogicCloudSIEM_Enrich Entities"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SumoLogicCloudSIEM_Enrich Entities for"
            f" SumoLogicCloudSIEM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def sumo_logic_cloud_siem_add_comment_to_insight(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      insight_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the ID of the insight to which action needs to add a"
                  " comment."
              ),
          ),
      ],
      comment: Annotated[
          str,
          Field(
              ..., description="Specify the comment that needs to be added in insight."
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "SumoLogicCloudSIEM_Add Comment To Insight"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SumoLogicCloudSIEM_Add Comment To Insight for"
            f" SumoLogicCloudSIEM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def sumo_logic_cloud_siem_search_entity_signals(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      lowest_severity_to_return: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the lowest severity number that will be used to return"
                  " signals. Maximum: 10."
              ),
          ),
      ],
      time_frame: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  ' also need to provide "Start Time". If "30 Minutes Around Alert'
                  ' Time" is selected, action will search the alerts 30 minutes before'
                  " the alert happened till the 30 minutes after the alert has"
      ...
      max_signals_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify how many signals to return per entity. Default: 50.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "SumoLogicCloudSIEM_Search Entity Signals"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SumoLogicCloudSIEM_Search Entity Signals for"
            f" SumoLogicCloudSIEM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
