...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def vectra_enrich_endpoint(
  ...
  async def vectra_update_note(
      ...
      item_type: Annotated[
          List[Any],
          Field(
              ..., description="Select on which item type you want to update a note."
          ),
      ],
      item_id: Annotated[
          str, Field(..., description="Specify ID of the detection/endpoint.")
      ],
      note: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify what note you want to have on the detection/endpoint."
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  async def vectra_remove_tags(
      ...
      item_type: Annotated[
          List[Any],
          Field(
              ..., description="Select from which item type you want to remove tags."
          ),
      ],
      item_id: Annotated[
          str, Field(..., description="Specify ID of the detection/endpoint.")
      ...
      tags: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify what tags you want to remove from detection/endpoint. Tags"
                  " should be separated by comma, e.g tag1, tag2."
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  @mcp.tool()
  async def vectra_get_triage_rule_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      triage_rule_i_ds: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of triage rule IDs. Example: 28,29."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Vectra_Get Triage Rule Details"
  ...
  @mcp.tool()
  async def vectra_update_detection_status(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      detection_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the detection ID on which you want to update the status."
              ),
          ),
      ],
      status: Annotated[
          List[Any],
          Field(..., description="Specify what status to set on the detection."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Vectra_Update Detection Status"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
  ...
  async def vectra_add_tags(
      ...
      item_type: Annotated[
          List[Any],
          Field(..., description="Select to which item type you want to add tags."),
      ],
      item_id: Annotated[
          str, Field(..., description="Specify ID of the detection/endpoint.")
      ],
      tags: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify what tags you want to add to detection/endpoint. Tags should"
                  " be separated by comma, e.g tag1, tag2."
              ),
          ),
      ],
      target_entities: Annotated[
