...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def google_cloud_iam_enable_service_account(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "GoogleCloudIAM_Enable Service Account"
      ...
      try:
        ...
        print(
            "Error executing action GoogleCloudIAM_Enable Service Account for"
            f" GoogleCloudIAM: {e}"
        )
  ...
  @mcp.tool()
  async def google_cloud_iam_create_service_account(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      service_account_id: Annotated[
          str, Field(..., description="Specify service account id to create.")
      ],
      project_id: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the name of the project to create service accounts in. If"
                  " nothing is provided, the project will be extracted from integration"
                  " configuration."
              ),
          ),
      ],
      service_account_display_name: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify service account display name to create.",
          ),
      ],
      service_account_description: Annotated[
          Optional[str],
          Field(
              default=None, description="Specify service account description to create."
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "GoogleCloudIAM_Create Service Account"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action GoogleCloudIAM_Create Service Account for"
            f" GoogleCloudIAM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def google_cloud_iam_get_service_account_iam_policy(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "GoogleCloudIAM_Get Service Account IAM Policy"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action GoogleCloudIAM_Get Service Account IAM Policy for"
            f" GoogleCloudIAM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def google_cloud_iam_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def google_cloud_iam_create_role(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      role_id: Annotated[
          str, Field(..., description="Specify role id for newly created IAM role.")
      ],
      role_definition: Annotated[
          str,
          Field(
              ...,
              description="Specify JSON policy document to use as the role definition.",
          ),
      ],
      project_id: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the name of the project, where you want to create the role."
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action GoogleCloudIAM_Create Role for GoogleCloudIAM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for GoogleCloudIAM")
  ...
  @mcp.tool()
  async def google_cloud_iam_delete_role(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      project_id: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the name of the project, where you want to delete the role."
                  " If nothing is provided, the project will be extracted from"
                  " integration configuration."
              ),
          ),
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action GoogleCloudIAM_Delete Role for GoogleCloudIAM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for GoogleCloudIAM")
  ...
  @mcp.tool()
  async def google_cloud_iam_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "GoogleCloudIAM_Enrich Entities"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action GoogleCloudIAM_Enrich Entities for"
            f" GoogleCloudIAM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def google_cloud_iam_disable_service_account(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "GoogleCloudIAM_Disable Service Account"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action GoogleCloudIAM_Disable Service Account for"
            f" GoogleCloudIAM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def google_cloud_iam_delete_service_account(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "GoogleCloudIAM_Delete Service Account"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action GoogleCloudIAM_Delete Service Account for"
            f" GoogleCloudIAM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def google_cloud_iam_list_roles(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      project_id: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the name of the project, where you want to list the roles."
                  " If nothing is provided, the project will be extracted from"
                  " integration configuration."
              ),
          ),
      ...
      view: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify which view should be used to return role information."
              ),
          ),
      ],
      max_rows_to_return: Annotated[
          ...
          Field(
              default=None,
              description="Specify how many roles the action should return.",
          ),
      ],
      list_custom_roles_only: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will return only custom roles defined for the"
                  " current project or orgranization."
              ),
          ),
      ],
      show_deleted: Annotated[
          ...
          Field(
              default=None,
              description="If enabled, action will also return deleted roles.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action GoogleCloudIAM_List Roles for GoogleCloudIAM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for GoogleCloudIAM")
  ...
  @mcp.tool()
  async def google_cloud_iam_list_service_accounts(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      project_id: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the name of the project to list service accounts in. If"
                  " nothing is provided, the project will be extracted from integration"
                  " configuration."
              ),
          ),
      ...
      service_account_display_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify service account display name to return. Parameter accepts"
      ...
      service_account_email: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify service account email to return. Parameter accepts multiple"
      ...
      max_rows_to_return: Annotated[
          ...
          Field(
              default=None,
              description="Specify how many service accounts the action should return.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "GoogleCloudIAM_List Service Accounts"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action GoogleCloudIAM_List Service Accounts for"
            f" GoogleCloudIAM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def google_cloud_iam_set_service_account_iam_policy(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      policy: Annotated[
          ...
          Field(
              ...,
              description="Specify JSON policy document to set for service account.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "GoogleCloudIAM_Set Service Account IAM Policy"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action GoogleCloudIAM_Set Service Account IAM Policy for"
            f" GoogleCloudIAM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
