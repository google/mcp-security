...
def register_tools(mcp: FastMCP):
  ...
  async def any_run_get_report(
      ...
      search_in_last_x_scans: Annotated[
          ...
          Field(
              ...,
              description="Search for report in last x analysises executed in Any.Run.",
          ),
      ],
      ...
      fetch_latest_report: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "Specify whether to return latest analysis report or all found"
                  " reports for the provided entity."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def any_run_analyze_file(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      try_to_create_submission_for_x_times: Annotated[
          str,
          Field(
              ...,
              description=(
                  "How many attempts action should make to check if the API concurrency"
                  " limit is not exceeded and try to create a new submission. Check is"
      ...
      wait_for_the_report: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify whether action should wait for the report creation. Report"
                  " also can be obtained later with Get report action once scan is"
                  " completed."
              ),
          ),
      ],
      os_version: Annotated[
          Optional[List[Any]],
          Field(default=None, description="OS version to run analysis on."),
      ],
      operation_system_bitness: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Bitness of Operation System"),
      ],
      os_environment_type: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Environment type to run analysis on."),
      ],
      network_connection_status: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Network connection state for analysis."),
      ],
      fake_net_feature_status: Annotated[
          Optional[List[Any]],
          Field(default=None, description="FakeNet feature state for analysis."),
      ],
      use_tor: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Use TOR or not while running analysis."),
      ],
      opt_network_mitm: Annotated[
          Optional[List[Any]],
          Field(default=None, description="HTTPS MITM proxy option."),
      ],
      opt_network_geo: Annotated[
          Optional[List[Any]], Field(default=None, description="Geo location option.")
      ],
      opt_kernel_heavyevasion: Annotated[
          Optional[List[Any]], Field(default=None, description="Heavy evasion option.")
      ],
      opt_privacy_type: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Privacy settings for analysis."),
      ],
      obj_ext_startfolder: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Start location for analysis."),
      ],
      opt_timeout: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Timeout period for analysis in range from 10 to 9999 seconds."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      script_params["Try to create submission for x times"] = (
          try_to_create_submission_for_x_times
      )
  ...
  @mcp.tool()
  async def any_run_analyze_file_url(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      url_to_file: Annotated[
          str, Field(..., description="Specify URL to file to download and analyze.")
      ],
      try_to_create_submission_for_x_times: Annotated[
          str,
          Field(
  ...
  @mcp.tool()
  async def any_run_search_report_history(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      search_in_last_x_scans: Annotated[
          ...
          Field(
              ...,
              description="Search for report in last x analyses executed in Any.Run.",
          ),
      ],
      submission_name: Annotated[
          Optional[str],
          Field(default=None, description="Specific submission name to search for."),
      ],
      skip_first_x_scans: Annotated[
          Optional[str],
          Field(
              default=None, description="Skip first x scans returned by Any.Run API."
          ),
      ],
      get_team_history: Annotated[
          Optional[bool],
          Field(
              default=None, description="Specify whether to get team history or not."
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
  ...
  async def any_run_analyze_url(
      ...
      url_for_analysis: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify URL to analyze. If URL is provided in both as entity and as"
                  " this input parameter - action will be executed on input parameter."
              ),
          ),
      ],
      try_to_create_submission_for_x_times: Annotated[
