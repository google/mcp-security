...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def bmc_helix_remedy_force_update_record(
      ...
      record_type: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the type of the record that needs to be updated. If you"
                  " don't know what kind of records are available, please execute"
                  ' action "List Record Types".'
              ),
          ),
      ],
      record_id: Annotated[
    ...
    try:
      instance_response = await bindings.http_client.get(
          Endpoints.LIST_INTEGRATION_INSTANCES.format(
              INTEGRATION_NAME="BMCHelixRemedyForce"
          )
      )
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "BMCHelixRemedyForce_Update Record"
      ...
      try:
        ...
        print(
            "Error executing action BMCHelixRemedyForce_Update Record for"
            f" BMCHelixRemedyForce: {e}"
        )
  ...
  @mcp.tool()
  async def bmc_helix_remedy_force_get_record_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      record_type: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " details. If you don't know what kind of records are available,"
                  ' please execute action "List Record Types".'
              ),
          ),
      ],
      ...
      fields_to_return: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify what fields to return. If none of the provided fields were"
                  " found, action will fail. If nothing is provided, action will return"
                  " all fields."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "BMCHelixRemedyForce_Get Record Details"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action BMCHelixRemedyForce_Get Record Details for"
            f" BMCHelixRemedyForce: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def bmc_helix_remedy_force_list_record_types(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      filter_value: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  ' types and if "Contains" is selected, action will try to find record'
                  " types that contain that substring. If nothing is provided in this"
                  " parameter, the filter will not be applied."
              ),
          ),
      ],
      max_record_types_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify how many record types to return. Default: 50.",
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "BMCHelixRemedyForce_List Record Types"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action BMCHelixRemedyForce_List Record Types for"
            f" BMCHelixRemedyForce: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def bmc_helix_remedy_force_get_o_auth_refresh_token(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      redirect_url: Annotated[
          ...
          Field(
              ...,
              description=(
                  'Specify the redirect URL that was used when the "Connector App" was'
                  " created."
              ),
          ),
      ],
      authorization_code: Annotated[
          ...
          Field(
              ...,
              description=(
                  'Specify the authorization code from action "Get OAuth Authorization'
                  ' Code".'
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "BMCHelixRemedyForce_Get OAuth Refresh Token"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action BMCHelixRemedyForce_Get OAuth Refresh Token for"
            f" BMCHelixRemedyForce: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def bmc_helix_remedy_force_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action BMCHelixRemedyForce_Ping for"
            f" BMCHelixRemedyForce: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def bmc_helix_remedy_force_execute_simple_query(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      record_type: Annotated[
          str, Field(..., description="Specify what record type should be queried.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "BMCHelixRemedyForce_Execute Simple Query"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action BMCHelixRemedyForce_Execute Simple Query for"
            f" BMCHelixRemedyForce: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def bmc_helix_remedy_force_delete_record(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      record_type: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the type of the record that needs to be deleted. If you"
                  " don't know what kind of records are available, please execute"
                  ' action "List Record Types".'
              ),
          ),
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "BMCHelixRemedyForce_Delete Record"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action BMCHelixRemedyForce_Delete Record for"
            f" BMCHelixRemedyForce: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def bmc_helix_remedy_force_create_record(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      record_type: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the type of the record that needs to be created. If you"
                  " don't know what kind of records are available, please execute"
                  ' action "List Record Types".'
              ),
          ),
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "BMCHelixRemedyForce_Create Record"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action BMCHelixRemedyForce_Create Record for"
            f" BMCHelixRemedyForce: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def bmc_helix_remedy_force_wait_for_fields_update(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      record_type: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " If you don't know what kind of records are available, please"
                  ' execute action "List Record Types".'
              ),
          ),
      ],
      record_id: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "BMCHelixRemedyForce_Wait For Fields Update"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action BMCHelixRemedyForce_Wait For Fields Update for"
            f" BMCHelixRemedyForce: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def bmc_helix_remedy_force_execute_custom_query(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      soql_query: Annotated[
          str, Field(..., description="Specify what query should be executed.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "BMCHelixRemedyForce_Execute Custom Query"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action BMCHelixRemedyForce_Execute Custom Query for"
            f" BMCHelixRemedyForce: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def bmc_helix_remedy_force_get_o_auth_authorization_code(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "BMCHelixRemedyForce_Get OAuth Authorization Code"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action BMCHelixRemedyForce_Get OAuth Authorization Code"
            f" for BMCHelixRemedyForce: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for BMCHelixRemedyForce")
