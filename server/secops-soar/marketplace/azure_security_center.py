...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def azure_security_center_get_o_auth_refresh_token(
    ...
    try:
      instance_response = await bindings.http_client.get(
          Endpoints.LIST_INTEGRATION_INSTANCES.format(
              INTEGRATION_NAME="AzureSecurityCenter"
          )
      )
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "AzureSecurityCenter_Get OAuth Refresh Token"
      ...
      try:
        ...
        print(
            "Error executing action AzureSecurityCenter_Get OAuth Refresh Token for"
            f" AzureSecurityCenter: {e}"
        )
  ...
  @mcp.tool()
  async def azure_security_center_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureSecurityCenter_Ping for"
            f" AzureSecurityCenter: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def azure_security_center_list_regulatory_standards(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      subscription_id: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the ID of the subscription for which you want to query"
                  " information. Note: if subscription ID is provided at the"
                  " integration level and action level, priority will be given to"
      ...
      state_filter: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the comma-separated list of states. Example: Failed,"
                  " Skipped. Only standards with the matching state will be returned."
                  " For example, if you specify \u201cFailed\u201d, action will only"
                  " return failed standards. Possible values: Passed, Failed,"
                  " Unsupported, Skipped"
              ),
          ),
      ],
      max_standards_to_return: Annotated[
          Optional[str],
          Field(default=None, description="Specify how many standards to return."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureSecurityCenter_List Regulatory Standards"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureSecurityCenter_List Regulatory Standards for"
            f" AzureSecurityCenter: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def azure_security_center_update_alert_status(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      location: Annotated[
          str,
          Field(
              ..., description="Specify the location of the alert. Example: centralus."
          ),
      ],
      status: Annotated[
          List[Any], Field(..., description="Specify the status for the alert.")
      ],
      subscription_id: Annotated[
          Optional[str],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureSecurityCenter_Update Alert Status"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureSecurityCenter_Update Alert Status for"
            f" AzureSecurityCenter: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def azure_security_center_list_regulatory_standard_controls(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      standard_names: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of standard names for which you want"
                  " to retrieve details. Example: Azure-CIS-1.1.0"
              ),
          ),
      ],
      subscription_id: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureSecurityCenter_List Regulatory Standard Controls"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureSecurityCenter_List Regulatory Standard"
            f" Controls for AzureSecurityCenter: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for AzureSecurityCenter")
  ...
  @mcp.tool()
  async def azure_security_center_get_o_auth_authorization_code(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AzureSecurityCenter_Get OAuth Authorization Code"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AzureSecurityCenter_Get OAuth Authorization Code"
            f" for AzureSecurityCenter: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for AzureSecurityCenter")
