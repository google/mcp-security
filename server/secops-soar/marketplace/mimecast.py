...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def mimecast_advanced_archive_search(
      ...
      xml_query: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify an XML query that should be used when searching for archive"
                  " emails. Please visit documentation for more details."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "Mimecast_Advanced Archive Search"
      ...
      try:
        ...
        print(
            f"Error executing action Mimecast_Advanced Archive Search for Mimecast: {e}"
        )
  ...
  @mcp.tool()
  async def mimecast_release_message(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      message_id: Annotated[
          ...
          Field(
              ...,
              description="Specify the ID of the message that needs to be released.",
          ),
      ],
      release_to_sandbox: Annotated[
          Optional[bool],
          Field(
              default=None,
              description="If enabled, action will release the message to the sandbox.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
  ...
  @mcp.tool()
  async def mimecast_reject_message(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      message_id: Annotated[
          ...
          Field(
              ...,
              description="Specify the ID of the message that needs to be rejected.",
          ),
      ],
      note: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify an additional note containing an explanation regarding why"
      ...
      reason: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Specify the reason for rejection."),
      ],
      notify_sender: Annotated[
          Optional[bool],
          Field(
              default=None,
              description="If enabled, action will notify the sender about rejection.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
  ...
  async def mimecast_permit_sender(
      ...
      sender: Annotated[
          str,
          Field(..., description="Specify the email address of the sender to permit."),
      ],
      recipient: Annotated[
          str,
          Field(
              ..., description="Specify the email address of the recipient to permit."
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
  ...
  async def mimecast_block_sender(
      ...
      sender: Annotated[
          str,
          Field(..., description="Specify the email address of the sender to block."),
      ],
      recipient: Annotated[
          str,
          Field(
              ..., description="Specify the email address of the recipient to block."
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
  ...
  @mcp.tool()
  async def mimecast_simple_archive_search(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      fields_to_return: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of fields that needs to be returned."
              ),
          ),
      ],
      ...
      from_: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of email addresses from which the"
                  " emails were sent."
              ),
          ),
      ],
      to: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of email addresses to which the"
                  " emails were sent."
              ),
          ),
      ],
      subject: Annotated[
          Optional[str],
          Field(
              default=None, description="Specify a subject that needs to be searched."
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Mimecast_Simple Archive Search"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action Mimecast_Simple Archive Search for Mimecast: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for Mimecast")
  ...
  @mcp.tool()
  async def mimecast_report_message(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      message_id: Annotated[
          ...
          Field(
              ...,
              description="Specify the ID of the message that needs to be reported.",
          ),
      ],
      comment: Annotated[
          Optional[str],
          Field(default=None, description="Specify the comment for the report."),
      ],
      report_as: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Specify the report type for the message."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
