...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def cybereason_list_reputation_items(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "Cybereason_List Reputation Items"
      ...
      try:
        ...
        print(
            "Error executing action Cybereason_List Reputation Items for"
            f" Cybereason: {e}"
        )
  ...
  @mcp.tool()
  async def cybereason_execute_custom_investigation_search(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      query_filters_json: Annotated[
          Union[str, dict],
          Field(
              ...,
              description=(
                  "Specify the query that needs to be executed. Note: the query should"
                  ' follow a strict pattern of "{API field } {Operator} {Value}". For'
                  ' multiple values you need to provide an "OR" key. Each new filter'
                  " needs to be a separate item in the list. Each key represents the"
                  " request type, for example, machine or user. Please refer to the"
                  " documentation portal to understand what an API field name is."
                  " Possible operators: Equals NotEquals ContainsIgnoreCase"
                  " NotContainsIgnoreCase LessThan LessOrEqualsTo GreaterThan"
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Cybereason_Execute Custom Investigation Search"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Cybereason_Execute Custom Investigation Search for"
            f" Cybereason: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cybereason_prevent_file(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def cybereason_get_sensor_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action Cybereason_Get Sensor Details for Cybereason: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for Cybereason")
  ...
  @mcp.tool()
  async def cybereason_add_comment_to_malop(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      malop_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the ID of the malop to which you want to add a comment."
              ),
          ),
      ],
      comment: Annotated[
          str, Field(..., description="Specify the comment for the malop.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Cybereason_Add Comment To Malop"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Cybereason_Add Comment To Malop for"
            f" Cybereason: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cybereason_unisolate_machine(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action Cybereason_Unisolate Machine for Cybereason: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for Cybereason")
  ...
  @mcp.tool()
  async def cybereason_set_reputation(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      reputation_list_type: Annotated[
          List[Any],
          Field(
              ...,
              description=(
                  "Specify the reputation that needs to be applied to an entity."
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  @mcp.tool()
  async def cybereason_is_probe_connected(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action Cybereason_Is Probe Connected for Cybereason: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for Cybereason")
  ...
  @mcp.tool()
  async def cybereason_list_malop_remediations(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      malop_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the ID of the malop for which you want to list available"
                  " remediations."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Cybereason_List Malop Remediations"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Cybereason_List Malop Remediations for"
            f" Cybereason: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cybereason_allow_file(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def cybereason_clear_reputation(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def cybereason_list_malop_affected_machines(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      malop_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the ID of the malop for which you want to return affected"
                  " machines."
              ),
          ),
      ],
      results_limit: Annotated[
          str,
          Field(..., description="Specify how many results to return. Default: 100"),
      ],
      create_hostname_entity: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will create an entity based on machines name."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Cybereason_List Malop Affected Machines"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Cybereason_List Malop Affected Machines for"
            f" Cybereason: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cybereason_list_processes(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      results_limit: Annotated[
          str, Field(..., description="Specify how many processes to return.")
      ],
      process_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of process names for which you want"
                  " to return data."
              ),
          ),
      ],
      machine_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of machine names on which you want to"
                  " search for processes."
              ),
          ),
      ],
      has_suspicions: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will only return processes that are labeled as"
                  " suspicious."
              ),
          ),
      ],
      has_incoming_connection: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will only return processes that have incoming"
                  " connections."
              ),
          ),
      ],
      has_outgoing_connection: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will only return processes that have outgoing"
                  " connections."
              ),
          ),
      ],
      has_external_connection: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will only return processes that have external"
                  " connections."
              ),
          ),
      ],
      unsigned_process_with_unknown_reputation: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will only return unsigned processes with unknown"
                  " reputation."
              ),
          ),
      ],
      running_from_temporary_folder: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will only return processes running from a"
                  " temporary folder."
              ),
          ),
      ],
      privilege_escalation: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will only return processes with escalated"
                  " privileges."
              ),
          ),
      ],
      malicious_use_of_ps_exec: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will only return processes related to malicious"
                  " use of PsExec."
              ),
          ),
      ],
    ...
    if instances:
      ...
      if unsigned_process_with_unknown_reputation is not None:
        script_params["Unsigned process with unknown reputation"] = (
            unsigned_process_with_unknown_reputation
        )
  ...
  @mcp.tool()
  async def cybereason_remediate_malop(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      malop_id: Annotated[
          ...
          Field(
              ...,
              description="Specify the ID of the malop which you want to remediate.",
          ),
      ],
      remediation_unique_i_ds: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of the remediation actions that need"
                  ' to be executed. This value can be retrieved from the action "List'
                  ' Malop Remediations".'
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def cybereason_execute_simple_investigation_search(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      request_type: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Specify what should be queried."),
      ],
      query_filters: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the query that needs to be executed. Note: this query should"
                  ' follow a strict pattern of "{API field} {Operator} {Value}". For'
                  ' multiple values you need to provide an "OR" key. Each new filter'
                  " needs to start from a new line. Please refer to the documentation"
                  " portal to understand what an API field name is. Possible operators:"
                  " Equals NotEquals ContainsIgnoreCase NotContainsIgnoreCase LessThan"
                  " LessOrEqualsTo GreaterThan GreaterOrEqualsTo Between Includes"
                  " NotIncludes"
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Cybereason_Execute Simple Investigation Search"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Cybereason_Execute Simple Investigation Search for"
            f" Cybereason: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cybereason_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      create_insights: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If enabled, action will create an insight for each enriched entity."
              ),
          ),
      ],
      only_malicious_entity_insight: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will create an insight only for entities that"
                  " have type: ransomware, maltool, unwanted, malware, blacklist. Note:"
                  " this affects only IP Address, File Hash and URL entities, for"
                  " Hostname entity action will still create an insight."
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  @mcp.tool()
  async def cybereason_list_files(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      results_limit: Annotated[
          str, Field(..., description="Specify how many files to return.")
      ],
      file_hash: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of file hashes for which you want to"
                  " return data. Note: action only supports SHA-1 and MD5 hashes. If"
                  " you provide values for this parameter, then parameter \u201cResults"
                  " Limit\u201c is ignored. Action will try to find information about"
                  " all provided hashes."
              ),
          ),
      ],
      fields_to_return: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of fields that you want to return. If"
                  " nothing is provided, action will work with predefined fields."
                  " Possible values:"
                  " md5String,ownerMachine,avRemediationStatus,isSigned,signatureVerified,sha1String,maliciousClassificationType,createdTime,modifiedTime,size,correctedPath,productName,productVersion,companyName,internalName,elementDisplayName."
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  @mcp.tool()
  async def cybereason_get_malop(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      malop_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the ID of the malop for which you want to return details."
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  @mcp.tool()
  async def cybereason_list_malop_processes(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      malop_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the ID of the malop for which you want to return related"
                  " processes."
              ),
          ),
      ],
      results_limit: Annotated[
          str, Field(..., description="Specify how many results to return.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Cybereason_List Malop Processes"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Cybereason_List Malop Processes for"
            f" Cybereason: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def cybereason_isolate_machine(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def cybereason_update_malop_status(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      malop_id: Annotated[
          str,
          Field(
              ..., description="Specify the ID of the malop that needs to be updated."
          ),
      ],
      status: Annotated[
          List[Any], Field(..., description="Specify the new status for the malop.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Cybereason_Update Malop Status"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action Cybereason_Update Malop Status for Cybereason: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for Cybereason")
