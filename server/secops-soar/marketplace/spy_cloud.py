...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def spy_cloud_list_entity_breaches(
      ...
      catalog_filter: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the name of the category in which you want to search for"
                  " breaches."
              ),
          ),
      ],
      start_time: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " 8601. Note: action will only take the datetime for action"
                  " execution."
              ),
          ),
      ],
      end_time: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " then this parameter will use current time. Note: action will only"
                  " take the datetime for action execution."
              ),
          ),
      ],
      max_breaches_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify how many breaches to return per entity. Default: 1. Maximum:"
                  " 1000."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def spy_cloud_list_catalogs(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      filter_value: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  ' contain that substring. "Equal" works with "title" parameter, while'
                  ' "Contains" works with all values in response. If nothing is'
      ...
      max_catalogs_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
