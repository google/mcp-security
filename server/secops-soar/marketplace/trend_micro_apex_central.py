...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def trend_micro_apex_central_create_file_udso(
      ...
      file_paths: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of file paths that needs to be used"
                  " to create a UDSO."
              ),
          ),
      ],
      action: Annotated[
          List[Any],
          Field(..., description="Specify what action should be applied to the UDSO."),
      ],
      note: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify an additional note for the provided UDSO.",
          ),
      ],
    ...
    try:
      instance_response = await bindings.http_client.get(
          Endpoints.LIST_INTEGRATION_INSTANCES.format(
              INTEGRATION_NAME="TrendMicroApexCentral"
          )
      )
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "TrendMicroApexCentral_Create File UDSO"
      ...
      try:
        ...
        print(
            "Error executing action TrendMicroApexCentral_Create File UDSO for"
            f" TrendMicroApexCentral: {e}"
        )
  ...
  @mcp.tool()
  async def trend_micro_apex_central_isolate_endpoints(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "TrendMicroApexCentral_Isolate Endpoints"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action TrendMicroApexCentral_Isolate Endpoints for"
            f" TrendMicroApexCentral: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def trend_micro_apex_central_create_entity_udso(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      note: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify an additional note for the provided UDSO. Warning: this note"
                  " can't contain more than 256 characters."
              ),
          ),
      ],
      expire_in_days: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify in how many days the UDSO should expire. If nothing is"
                  " provided, UDSO will never expire."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "TrendMicroApexCentral_Create Entity UDSO"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action TrendMicroApexCentral_Create Entity UDSO for"
            f" TrendMicroApexCentral: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def trend_micro_apex_central_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action TrendMicroApexCentral_Ping for"
            f" TrendMicroApexCentral: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def trend_micro_apex_central_unisolate_endpoints(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "TrendMicroApexCentral_Unisolate Endpoints"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action TrendMicroApexCentral_Unisolate Endpoints for"
            f" TrendMicroApexCentral: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def trend_micro_apex_central_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      create_endpoint_insight: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If enabled, action will create an insight consisting of the"
                  " information regarding the endpoints that were enriched."
              ),
          ),
      ],
      create_udso_insight: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will create an insight consising of the"
                  " information regarding the entities that matched UDSO."
              ),
          ),
      ],
      mark_udso_entities: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will mark all of the entities that were seen in"
                  " the User-Defined Suspicious Objects list as suspicious."
              ),
          ),
      ],
      extract_domain: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If enabled, action will extract domain part of the URL entity and"
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "TrendMicroApexCentral_Enrich Entities"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action TrendMicroApexCentral_Enrich Entities for"
            f" TrendMicroApexCentral: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
