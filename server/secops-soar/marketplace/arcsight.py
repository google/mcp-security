...
def register_tools(mcp: FastMCP):
  ...
  async def arcsight_search(
      ...
      search_query: Annotated[str, Field(..., description="Specify the search query.")],
      max_items_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify how many items to return in the response.",
          ),
      ],
  ...
  @mcp.tool()
  async def arcsight_get_report(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      report_full_path_uri: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify the URI to the report. Example: /All Reports/ArcSight"
                  " Foundation/MITRE ATT&CK/Mitre ATT&CK Summary"
              ),
          ),
      ],
      field_2: Annotated[
          ...
          Field(
              default=None,
              description="The dynamic fields for the query to generate the report",
          ),
      ],
      field_3: Annotated[
          Optional[str],
  ...
  @mcp.tool()
  async def arcsight_add_entities_to_active_list(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      active_list_name: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify the name of the active list to which you want to add"
                  " entities."
              ),
          ),
      ],
      entity_column: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the name of the column, where entity value should be put."
              ),
          ),
      ],
      additional_fields: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify additional fields that should be added alongside the entity"
                  ' in the active list. Format is a JSON object. Example: {"Column_1":'
                  ' "Value_1","Column_2": "Value_2"}'
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Arcsight_Add Entities To Active List"
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Arcsight_Add Entities To Active List for"
            f" Arcsight: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def arcsight_get_activelist_entries(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      active_list_uuid: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the UUID of the active list for which you want to retrieve"
                  " entries. Note: parameter \u201cActive list UUID\u201c takes"
                  " priority over \u201cActive list name\u201c. Example:"
                  " HLZRc9yYBABC-lHtlf3-f0Q=="
              ),
          ),
      ],
      active_list_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the name of the active list for which you want to retrieve"
                  " entries. Note: parameter \u201cActive list UUID\u201c takes"
                  " priority over \u201cActive list name\u201c."
              ),
          ),
      ],
      map_columns: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will map columns to the values in the JSON"
                  " result."
              ),
          ),
      ],
      max_entries_to_return: Annotated[
          Optional[str],
          Field(default=None, description="Specify how many entries to return."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Arcsight_Get Activelist Entries"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action Arcsight_Get Activelist Entries for Arcsight: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for Arcsight")
  ...
  @mcp.tool()
  async def arcsight_change_case_stage(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      case_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the name of the case for which you want to update the stage."
              ),
          ),
      ],
      stage: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a new stage for the case. Possible values: INITIAL, QUEUED,"
                  " CLOSED, FINAL, and FOLLOW_UP."
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  @mcp.tool()
  async def arcsight_get_query_results(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      query_id: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " Note: parameter \u201cQuery ID\u201c takes priority over"
                  " \u201cQuery Name\u201c. Example: cyUJKRz4BABCFwS9iFPq+aA=="
              ),
          ),
      ],
      max_items_to_return: Annotated[
      ...
      query_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the name of the query for which you want to return results."
                  " Note: parameter \u201cQuery ID\u201c takes priority over"
                  " \u201cQuery Name\u201c."
              ),
          ),
  ...
  @mcp.tool()
  async def arcsight_list_resources(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      return_active_lists: Annotated[
          Optional[bool],
          Field(
              default=None,
              description="If enabled, action will return available active lists.",
          ),
      ],
      return_queries: Annotated[
          Optional[bool],
          Field(
              default=None,
              description="If enabled, action will return available queries",
          ),
      ],
      return_cases: Annotated[
          Optional[bool],
          Field(
              default=None,
              description="If enabled, action will return available cases.",
          ),
      ],
      return_reports: Annotated[
          Optional[bool],
          Field(
              default=None,
              description="If enabled, action will return available reports.",
          ),
      ],
      max_resources_to_return: Annotated[
          Optional[str],
          Field(
              default=None, description="Specify how many resources to return per type."
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
  ...
  @mcp.tool()
  async def arcsight_add_entries_to_activelist(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      columns: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the name of the columns, where you want to put values for"
                  " the entries. Format: Column_name1;Column_name2"
              ),
          ),
      ],
      entries: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the entries. Format"
                  " entry1_value1|entry1_value2;entry2_value1|entry2_value2"
              ),
          ),
      ],
      active_list_uuid: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the UUID of the active list, where you want to add new"
                  " entries. Note: parameter \u201cActive list UUID\u201c takes"
                  " priority over \u201cActive list name\u201c. Example:"
                  " HLZRc9yYBABC-lHtlf3-f0Q=="
              ),
      ...
      active_list_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the name of the active list, where you want to add new"
                  " entries. Note: parameter \u201cActive list UUID\u201c takes"
                  " priority over \u201cActive list name\u201c."
              ),
          ),
      ...
      entries_json: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a list of JSON objects that contain information about the"
                  " entry. Note: Combination of \u2018Columns' and \u2018Entries\u2019"
                  " parameters have priority over 'Entries JSON\u2019. Format:"
                  ' [{"Column_1": "Value_1", "Column_2": "Value_2"}, {"Column_1":'
                  ' "Value_3", "Column_2": "Value_4"}]'
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Arcsight_Add Entries To Activelist"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Arcsight_Add Entries To Activelist for"
            f" Arcsight: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def arcsight_is_value_in_activelist_column(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      column_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the name of the column, where you want to search for the"
                  " entity."
              ),
          ),
      ],
      active_list_uuid: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the UUID of the active list, where you want to search for"
                  " entities. Note: parameter \u201cActive list UUID\u201c takes"
                  " priority over \u201cActive list name\u201c. Example:"
                  " HLZRc9yYBABC-lHtlf3-f0Q=="
              ),
          ),
      ...
      active_list_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the name of the active list, where you want to search for"
                  " entities. Note: parameter \u201cActive list UUID\u201c takes"
                  " priority over \u201cActive list name\u201c."
              ),
          ),
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "Arcsight_Is Value In Activelist Column"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action Arcsight_Is Value In Activelist Column for"
            f" Arcsight: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
