...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def mx_tool_box_a_record_lookup(
  ...
  @mcp.tool()
  async def mx_tool_box_reverse_dns_lookup(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def mx_tool_box_tcp_port_status(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      port_number: Annotated[str, Field(..., description="The port number to check")],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
              default_factory=list,
  ...
  @mcp.tool()
  async def mx_tool_box_https_information_lookup(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MXToolBox_HTTPS Information Lookup"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MXToolBox_HTTPS Information Lookup for"
            f" MXToolBox: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def mx_tool_box_spf_lookup(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ip_address: Annotated[str, Field(..., description="The IP address to look for")],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
              default_factory=list,
  ...
  @mcp.tool()
  async def mx_tool_box_mx_record_lookup(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def mx_tool_box_blacklist_check(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      blacklist_threshold: Annotated[
          str,
          Field(
              ...,
              description=(
                  "The threshold of the blacklist to determine whether a domain or IP"
                  " are blacklisted"
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def mx_tool_box_ping_external_ip(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
