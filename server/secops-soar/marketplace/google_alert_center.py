...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def google_alert_center_ping(
    ...
    try:
      instance_response = await bindings.http_client.get(
          Endpoints.LIST_INTEGRATION_INSTANCES.format(
              INTEGRATION_NAME="GoogleAlertCenter"
          )
      )
    ...
    if instances:
      ...
      try:
        ...
        print(
            f"Error executing action GoogleAlertCenter_Ping for GoogleAlertCenter: {e}"
        )
  ...
  @mcp.tool()
  async def google_alert_center_delete_alert(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      alert_id: Annotated[
          str,
          Field(
              ..., description="Specify the id of the alert that needs to be deleted."
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "GoogleAlertCenter_Delete Alert"
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action GoogleAlertCenter_Delete Alert for"
            f" GoogleAlertCenter: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for GoogleAlertCenter")
