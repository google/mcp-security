...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def scc_enterprise_lock_playbook(
    ...
    if instances:
      ...
      try:
        ...
        print(
            f"Error executing action SCCEnterprise_Lock Playbook for SCCEnterprise: {e}"
        )
  ...
  @mcp.tool()
  async def scc_enterprise_create_scc_enterprise_cloud_posture_ticket_type_snow(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      api_root: Annotated[
          str, Field(..., description="API root of the ServiceNow instance.")
      ],
      username: Annotated[
          str, Field(..., description="Username of the ServiceNow account.")
      ],
      password: Annotated[
          str, Field(..., description="Password of the ServiceNow account.")
      ],
      verify_ssl: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If enabled, verify the SSL certificate for the connection to the"
                  " ServiceNow is valid."
              ),
          ),
      ],
      table_role: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the role that should be set to access the newly created"
                  " table. If nothing is provided, action will create a new role"
                  ' "u_scc_enterprise_cloud_posture_ticket_user".'
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          actionProvider="Scripts",  # Assuming constant based on example
          actionName=(
              "SCCEnterprise_Create SCC Enterprise Cloud Posture Ticket Type SNOW"
          ),
          properties={
              "IntegrationInstance": instance_identifier,
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SCCEnterprise_Create SCC Enterprise Cloud Posture"
            f" Ticket Type SNOW for SCCEnterprise: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for SCCEnterprise")
  ...
  @mcp.tool()
  async def scc_enterprise_set_scc_findings_state_context_value(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "SCCEnterprise_Set SCC-FINDINGS-STATE Context Value"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SCCEnterprise_Set SCC-FINDINGS-STATE Context Value"
            f" for SCCEnterprise: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for SCCEnterprise")
  ...
  @mcp.tool()
  async def scc_enterprise_cloud_entity_parser(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "SCCEnterprise_CloudEntityParser"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SCCEnterprise_CloudEntityParser for"
            f" SCCEnterprise: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def scc_enterprise_create_scc_enterprise_cloud_posture_ticket_type_jira(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      api_root: Annotated[
          str, Field(..., description="API root of the Jira instance.")
      ],
      username: Annotated[str, Field(..., description="Username of the Jira account.")],
      api_token: Annotated[
          str, Field(..., description="Password of the Jira account.")
      ],
      verify_ssl: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, verify the SSL certificate for the connection to Jira is"
                  " valid."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          actionProvider="Scripts",  # Assuming constant based on example
          actionName=(
              "SCCEnterprise_Create SCC Enterprise Cloud Posture Ticket Type Jira"
          ),
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (  # Assuming same as actionName
      ...
      try:
        ...
        print(
            "Error executing action SCCEnterprise_Create SCC Enterprise Cloud Posture"
            f" Ticket Type Jira for SCCEnterprise: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for SCCEnterprise")
  ...
  @mcp.tool()
  async def scc_enterprise_add_scce_tags(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action SCCEnterprise_Add SCCE Tags for SCCEnterprise: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for SCCEnterprise")
  ...
  @mcp.tool()
  async def scc_enterprise_prepare_description(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      output: Annotated[Optional[List[Any]], Field(default=None, description="")],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
              default_factory=list,
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "SCCEnterprise_Prepare Description"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action SCCEnterprise_Prepare Description for"
            f" SCCEnterprise: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
