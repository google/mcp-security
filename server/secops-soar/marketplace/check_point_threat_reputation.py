...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def check_point_threat_reputation_get_ip_reputation(
      ...
      threshold: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Mark entity as suspicious if the returned risk value for entity is"
      ...
      create_insight: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify whether the Siemplify Insight should be created based on the"
                  " action result."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "CheckPointThreatReputation_Get IP Reputation"
      ...
      try:
        ...
        print(
            "Error executing action CheckPointThreatReputation_Get IP Reputation for"
            f" CheckPointThreatReputation: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
          f"Warning: No active integration instance found for"
          f" CheckPointThreatReputation"
      )
      return {"Status": "Failed", "Message": "No active instance found."}

  @mcp.tool()
  async def check_point_threat_reputation_get_host_reputation(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "CheckPointThreatReputation_Get Host Reputation"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CheckPointThreatReputation_Get Host Reputation for"
            f" CheckPointThreatReputation: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def check_point_threat_reputation_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "CheckPointThreatReputation_Ping"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CheckPointThreatReputation_Ping for"
            f" CheckPointThreatReputation: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def check_point_threat_reputation_get_file_hash_reputation(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "CheckPointThreatReputation_Get File Hash Reputation"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action CheckPointThreatReputation_Get File Hash"
            f" Reputation for CheckPointThreatReputation: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
