...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def stealthwatch_v6_10_search_events(
      ...
      timeframe: Annotated[str, Field(..., description="Time frame in hours.")],
    ...
    try:
      instance_response = await bindings.http_client.get(
          Endpoints.LIST_INTEGRATION_INSTANCES.format(
              INTEGRATION_NAME="StealthwatchV6-10"
          )
      )
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "StealthwatchV6-10_Search Events"
      ...
      try:
        ...
        print(
            "Error executing action StealthwatchV6-10_Search Events for"
            f" StealthwatchV6-10: {e}"
        )
  ...
  @mcp.tool()
  async def stealthwatch_v6_10_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action StealthwatchV6-10_Ping for StealthwatchV6-10: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for StealthwatchV6-10")
  ...
  @mcp.tool()
  async def stealthwatch_v6_10_search_flows(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      timeframe: Annotated[str, Field(..., description="Time frame in hours(e.g: 3).")],
      limit: Annotated[str, Field(..., description="The limit of the recieved flow.")],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
              default_factory=list,
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "StealthwatchV6-10_Search Flows"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action StealthwatchV6-10_Search Flows for"
            f" StealthwatchV6-10: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
