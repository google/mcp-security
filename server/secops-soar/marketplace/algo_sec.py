...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def algo_sec_list_templates(
      ...
      max_templates_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify how many templates to return. Default: 50.",
          ),
      ],
  ...
  @mcp.tool()
  async def algo_sec_wait_for_change_request_status_update(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      request_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the id of the request for which action needs to check the"
                  " status."
              ),
          ),
      ],
      status: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of change request statuses for which"
                  " action should wait. Possible values: resolved, reconcile, open,"
                  " check, implementation plan, implement, validate."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AlgoSec_Wait for Change Request Status Update"
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AlgoSec_Wait for Change Request Status Update for"
            f" AlgoSec: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def algo_sec_allow_ip(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      template: Annotated[
          str, Field(..., description="Specify the template for the change request.")
      ],
      source: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of sources for the allow rule. It can"
                  " be an IP address, IP Set or special keyword like (all)."
              ),
          ),
      ],
      service: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " Values can have a look of {TCP/UDP}/{port} (tcp/80) or special"
      ...
      subject: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the subject for the change request. If nothing is provided"
                  ' action will put "Siemplify Allow IP request" in the subject.'
              ),
          ),
      ],
      owner: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify who should be the owner of the change request. If nothing is"
                  " provided, the user that created the ticket will be the owner."
              ),
          ),
      ],
      due_date: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the due date for the change request. Format: ISO 8601."
      ...
      expiration_date: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the expiration date for the change request. Format: ISO"
                  " 8601. Example: 2021-08-13T08:16:10Z."
              ),
          ),
      ],
      custom_fields: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a JSON object containing information about all of the fields"
                  " that need to be added to the change request. Note: this parameter"
                  " has a priority over other fields"
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  async def algo_sec_block_ip(
      ...
      source: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of sources for the block rule. It can"
                  " be an IP address, IP Set or special keyword like (all)."
              ),
          ),
      ],
      ...
      subject: Annotated[
          ...
          Field(
              ...
              description=(
                  "Specify the subject for the change request. If nothing is provided"
                  " action will put \u201cSiemplify Block IP request\u201d in the"
                  " subject."
              ),
          ),
      ],
