...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def log_rhythm_add_alarm_to_case(
      ...
      alarm_i_ds: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of alarms that need to be added to"
                  " the case."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def log_rhythm_download_case_files(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      download_folder_path: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the path to the folder, where you want to store the case"
                  " files."
              ),
          ),
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action LogRhythm_Download Case Files for LogRhythm: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for LogRhythm")
  ...
  @mcp.tool()
  async def log_rhythm_list_entity_events(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      time_frame: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a time frame for the results. If \u201cCustom\u201d is"
      ...
      start_time: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " parameter. Format: ISO 8601. Example: 2021-04-23T12:38Z"
              ),
          ),
      ],
      end_time: Annotated[
      ...
      sort_order: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Specify the sorting logic for the query."),
      ],
      max_events_to_return: Annotated[
          Optional[str],
          Field(
              default=None, description="Specify how many events to return. Default: 50"
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
  ...
  @mcp.tool()
  async def log_rhythm_get_alarm_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      alarm_i_ds: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of alarm IDs for which we need to"
                  " retrieve details."
              ),
          ),
      ],
      max_events_to_fetch: Annotated[
          Optional[str],
          Field(
              default=None,
  ...
  @mcp.tool()
  async def log_rhythm_add_note_to_case(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      note: Annotated[
          str,
          Field(..., description="Specify a note that should be added to the case."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def log_rhythm_update_case(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      name: Annotated[
          Optional[str],
          Field(default=None, description="Specify a new name for the case."),
      ],
      priority: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Specify a new priority for the case."),
      ],
      due_date: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify a new due date for the case. Format: ISO 8601. Example:"
                  " 2021-04-23T12:38Z"
              ),
          ),
      ],
      description: Annotated[
          Optional[str],
          Field(default=None, description="Specify a new description for the case."),
      ],
      resolution: Annotated[
          Optional[str],
          Field(default=None, description="Specify how the case was resolved."),
      ],
      status: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Specify the new status for the case."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def log_rhythm_create_case(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      name: Annotated[str, Field(..., description="Specify the name for the case.")],
      priority: Annotated[
          List[Any], Field(..., description="Specify the priority for the case.")
      ],
      due_date: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the due date for the case. Format: ISO 8601. Example:"
                  " 2021-04-23T12:38Z"
              ),
          ),
      ],
      description: Annotated[
          Optional[str],
          Field(default=None, description="Specify a description for the case."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def log_rhythm_add_comment_to_alarm(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      alarm_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the ID of the alarm to which you need to add a comment in"
                  " LogRhythm."
              ),
          ),
      ],
      comment: Annotated[
          str,
          Field(
              ..., description="Specify a comment that needs to be added to the alarm."
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "LogRhythm_Add Comment To Alarm"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action LogRhythm_Add Comment To Alarm for LogRhythm: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for LogRhythm")
  ...
  @mcp.tool()
  async def log_rhythm_list_case_evidence(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      status_filter: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of status filters for the evidence."
                  " Possible values: pending, completed, failed. If nothing is"
                  " provided, action will return evidence from all statuses."
              ),
          ),
      ],
      type_filter: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of type filters for the evidence."
                  " Possible values: alarm, userEvents, log, note, file. If nothing is"
                  " provided, action will return evidence from all types."
              ),
          ),
      ],
      max_evidences_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify how much evidence to return. Default: 50.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
  ...
  @mcp.tool()
  async def log_rhythm_attach_file_to_case(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      file_paths: Annotated[
          str,
          Field(
              ..., description="Specify a comma-separate list of absolute file paths."
          ),
      ],
      note: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify a note that should be added to the case alongside the file."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action LogRhythm_Attach File To Case for LogRhythm: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for LogRhythm")
  ...
  @mcp.tool()
  async def log_rhythm_update_alarm(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      alarm_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the ID of the alarm that needs to be updated in LogRhythm."
              ),
          ),
      ],
      status: Annotated[
          Optional[List[Any]],
          Field(default=None, description="Specify the status for the alarm."),
      ],
      risk_score: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify a new risk score for the alarm. Maximum: 100.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
  ...
  @mcp.tool()
  async def log_rhythm_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
