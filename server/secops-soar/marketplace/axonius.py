...
def register_tools(mcp: FastMCP):
  ...
  async def axonius_remove_tags(
      ...
      tags: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the comma-separated list of tags that need to be removed"
                  " from the entities."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def axonius_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      max_notes_to_return: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify how many notes to show in the case wall table. Default: 50."
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  async def axonius_add_tags(
      ...
      tags: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the comma-separated list of tags that need to be added to"
                  " the entities."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def axonius_add_note(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      note: Annotated[
          str, Field(..., description="Specify what note needs to be added.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
