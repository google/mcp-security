...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def fortinet_forti_siem_ping(
    ...
    try:
      instance_response = await bindings.http_client.get(
          Endpoints.LIST_INTEGRATION_INSTANCES.format(
              INTEGRATION_NAME="FortinetFortiSIEM"
          )
      )
    ...
    if instances:
      ...
      try:
        ...
        print(
            f"Error executing action FortinetFortiSIEM_Ping for FortinetFortiSIEM: {e}"
        )
  ...
  @mcp.tool()
  async def fortinet_forti_siem_execute_simple_query(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      minimum_severity_to_fetch: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify minimum event severity to fetch to Siemplify in numbers, for"
                  " example 5 or 7."
              ),
          ),
      ],
      event_types: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify event types query should fetch. Parameter accepts multiple"
      ...
      event_category: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify event category query should fetch. Parameter accepts"
                  " multiple values as a comma separated string."
              ),
          ),
      ],
      event_i_ds: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify optionally exact event ids query should fetch. Parameter"
      ...
      start_time: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " 8601. Example: 2021-04-23T12:38Z"
              ),
          ),
      ],
      end_time: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "FortinetFortiSIEM_Execute Simple Query"
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action FortinetFortiSIEM_Execute Simple Query for"
            f" FortinetFortiSIEM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for FortinetFortiSIEM")
  ...
  @mcp.tool()
  async def fortinet_forti_siem_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      target_organization: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify optional target organization name to look for enrichment"
                  " information in this organization only."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "FortinetFortiSIEM_Enrich Entities"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action FortinetFortiSIEM_Enrich Entities for"
            f" FortinetFortiSIEM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def fortinet_forti_siem_execute_custom_query(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      query: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a query that will be used to retrieve information about the"
                  " events. Example: (relayDevIpAddr = 172.30.202.1 OR 172.30.202.2)"
                  " AND (reptDevName = HOST1)"
              ),
          ),
      ],
      fields_to_return: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "FortinetFortiSIEM_Execute Custom Query"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action FortinetFortiSIEM_Execute Custom Query for"
            f" FortinetFortiSIEM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
