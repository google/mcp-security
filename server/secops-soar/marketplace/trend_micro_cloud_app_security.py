...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def trend_micro_cloud_app_security_add_entities_to_blocklist(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "TrendMicroCloudAppSecurity_Add Entities To Blocklist"
      ...
      try:
        ...
        print(
            "Error executing action TrendMicroCloudAppSecurity_Add Entities To"
            f" Blocklist for TrendMicroCloudAppSecurity: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
          f"Warning: No active integration instance found for"
          f" TrendMicroCloudAppSecurity"
      )
      return {"Status": "Failed", "Message": "No active instance found."}

  @mcp.tool()
  async def trend_micro_cloud_app_security_mitigate_accounts(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      mitigation_action: Annotated[
          List[Any],
          Field(..., description="Specify what mitigation action should be applied."),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "TrendMicroCloudAppSecurity_Mitigate Accounts"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action TrendMicroCloudAppSecurity_Mitigate Accounts for"
            f" TrendMicroCloudAppSecurity: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(
  ...
  @mcp.tool()
  async def trend_micro_cloud_app_security_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "TrendMicroCloudAppSecurity_Ping"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action TrendMicroCloudAppSecurity_Ping for"
            f" TrendMicroCloudAppSecurity: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def trend_micro_cloud_app_security_mitigate_emails(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      service: Annotated[
          List[Any],
          Field(..., description="Specify the service the is used for emails."),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "TrendMicroCloudAppSecurity_Mitigate Emails"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action TrendMicroCloudAppSecurity_Mitigate Emails for"
            f" TrendMicroCloudAppSecurity: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def trend_micro_cloud_app_security_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "TrendMicroCloudAppSecurity_Enrich Entities"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action TrendMicroCloudAppSecurity_Enrich Entities for"
            f" TrendMicroCloudAppSecurity: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def trend_micro_cloud_app_security_entity_email_search(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      max_days_backwards: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify how many days backwards to look for emails. Maximum is 90."
                  " Default: 30."
              ),
          ),
      ],
      max_emails_to_return: Annotated[
          ...
          Field(
              default=None,
              description="Specify how many emails to return. Default: 100.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "TrendMicroCloudAppSecurity_Entity Email Search"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action TrendMicroCloudAppSecurity_Entity Email Search for"
            f" TrendMicroCloudAppSecurity: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
