...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def elastic_search_v7_simple_es_search(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "ElasticSearchV7_Simple ES Search"
      ...
      try:
        ...
        print(
            "Error executing action ElasticSearchV7_Simple ES Search for"
            f" ElasticSearchV7: {e}"
        )
  ...
  @mcp.tool()
  async def elastic_search_v7_advanced_es_search(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "ElasticSearchV7_Advanced ES Search"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ElasticSearchV7_Advanced ES Search for"
            f" ElasticSearchV7: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def elastic_search_v7_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def elastic_search_v7_dsl_search(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action ElasticSearchV7_DSL Search for"
            f" ElasticSearchV7: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
