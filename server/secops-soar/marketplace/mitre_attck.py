...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def mitre_attck_get_associated_intrusions(
      ...
      technique_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the identifier that will be used to find the associated"
                  " intrusions."
              ),
          ),
      ],
      identifier_type: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify what identifier type to use. Possible values: Attack Name"
                  " (Example: Access Token Manipulation) Attack ID (Example:"
                  " attack-pattern--478aa214-2ca7-4ec0-9978-18798e514790) External"
                  " Attack ID (Example: T1050)"
              ),
          ),
      ],
      max_intrusions_to_return: Annotated[
          Optional[str],
          Field(default=None, description="Specify how many intrusions to return."),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "MitreAttck_Get Associated Intrusions"
      ...
      try:
        ...
        print(
            "Error executing action MitreAttck_Get Associated Intrusions for"
            f" MitreAttck: {e}"
        )
  ...
  @mcp.tool()
  async def mitre_attck_get_technique_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      technique_identifier: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the comma-separated list of identifiers that will be used to"
                  " find the detailed information about techniques. Example:"
      ...
      identifier_type: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify what identifier type to use. Possible values: Name (Example:"
                  " Access Token Manipulation) ID (Example:"
                  " attack-pattern--478aa214-2ca7-4ec0-9978-18798e514790) External ID"
                  " (Example: T1050)"
              ),
          ),
      ],
      create_insights: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If enabled, action will create a separate insight for every"
                  " processed technique"
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MitreAttck_Get Technique Details"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MitreAttck_Get Technique Details for"
            f" MitreAttck: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def mitre_attck_get_techniques_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      technique_identifier: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the identifier that will be used to find the detailed"
                  " information about technique. Comma-separated values."
              ),
          ),
      ],
      identifier_type: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MitreAttck_Get Techniques Details"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MitreAttck_Get Techniques Details for"
            f" MitreAttck: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def mitre_attck_get_mitigations(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      technique_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the identifier that will be used to find the mitigations"
                  " related to attack technique."
              ),
          ),
      ],
      identifier_type: Annotated[
      ...
      max_mitigations_to_return: Annotated[
          Optional[str],
          Field(default=None, description="Specify how many mitigations to return."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def mitre_attck_get_techniques_mitigations(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      technique_id: Annotated[
          ...
          Field(
              ...
              description=(
                  "Specify the identifier that will be used to find the mitigations"
                  " related to attack technique. Comma-separated values."
              ),
          ),
      ],
      identifier_type: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "MitreAttck_Get Techniques Mitigations"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action MitreAttck_Get Techniques Mitigations for"
            f" MitreAttck: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
