...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def ivanti_endpoint_manager_list_delivery_methods(
      ...
      type: Annotated[
          ...
          Field(
              default=None,
              description="Specify the delivery type that needs to be returned.",
          ),
      ],
      ...
      filter_value: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " selected, action will try to find the exact match among items and"
                  ' if "Contains" is selected, action will try to find items that'
                  " contain that substring. If nothing is provided in this parameter,"
                  " the filter will not be applied."
              ),
          ),
      ],
      max_delivery_methods_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify how many delivery methods to return. Default: 50.",
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "IvantiEndpointManager_List Delivery Methods"
      ...
      try:
        ...
        print(
            "Error executing action IvantiEndpointManager_List Delivery Methods for"
            f" IvantiEndpointManager: {e}"
        )
  ...
  @mcp.tool()
  async def ivanti_endpoint_manager_execute_task(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      delivery_method: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the name of the delivery method that will be used during"
                  " task execution."
              ),
          ),
      ],
      package: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the name of the package that will be used during task"
                  " execution."
              ),
          ),
      ],
      wake_up_machines: Annotated[
          bool,
          Field(
              ...,
              description=(
                  "If enabled, action will wake up the machine during task execution."
              ),
          ),
      ],
      common_task: Annotated[
          bool,
          Field(..., description="If enabled, action will mark this task as common."),
      ],
      only_initiate: Annotated[
          bool,
          Field(
              ...,
              description=(
                  "If enabled, action will only initiate the task execution without"
                  " waiting for results."
              ),
          ),
      ],
      task_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the name of the task. If nothing is provided the action will"
                  ' use the "Siemplify Execute Task" name.'
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "IvantiEndpointManager_Execute Task"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action IvantiEndpointManager_Execute Task for"
            f" IvantiEndpointManager: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def ivanti_endpoint_manager_list_column_sets(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      max_column_sets_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify how many column sets to return. Default: 50.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "IvantiEndpointManager_List Column Sets"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action IvantiEndpointManager_List Column Sets for"
            f" IvantiEndpointManager: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def ivanti_endpoint_manager_execute_query(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      query: Annotated[
          str,
          Field(
              ..., description="Specify the name of the query that you want to execute."
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "IvantiEndpointManager_Execute Query"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action IvantiEndpointManager_Execute Query for"
            f" IvantiEndpointManager: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def ivanti_endpoint_manager_list_endpoint_vulnerabilities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      severity_filter: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of severities that will be used, when"
                  " returning information about vulnerabilities. If nothing is"
                  " provided, action will return all vulnerabilities. Possible values:"
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "IvantiEndpointManager_List Endpoint Vulnerabilities"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action IvantiEndpointManager_List Endpoint"
            f" Vulnerabilities for IvantiEndpointManager: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for IvantiEndpointManager")
  ...
  @mcp.tool()
  async def ivanti_endpoint_manager_list_column_set_fields(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      column_set: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the name of the column set for which you want to return"
                  " fields."
              ),
          ),
      ],
      ...
      max_fields_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify how many column sets to return. Default: 50.",
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "IvantiEndpointManager_List Column Set Fields"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action IvantiEndpointManager_List Column Set Fields for"
            f" IvantiEndpointManager: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def ivanti_endpoint_manager_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action IvantiEndpointManager_Ping for"
            f" IvantiEndpointManager: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def ivanti_endpoint_manager_scan_endpoints(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      task_name: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the name of the scan vulnerabilities task. If nothing is"
                  ' provided the action will use the "Siemplify Scan Endpoints" name.'
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "IvantiEndpointManager_Scan Endpoints"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action IvantiEndpointManager_Scan Endpoints for"
            f" IvantiEndpointManager: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def ivanti_endpoint_manager_list_queries(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      max_queries_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Specify how many queries to return. Default: 50.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "IvantiEndpointManager_List Queries"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action IvantiEndpointManager_List Queries for"
            f" IvantiEndpointManager: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def ivanti_endpoint_manager_list_packages(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      max_packages_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "IvantiEndpointManager_List Packages"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action IvantiEndpointManager_List Packages for"
            f" IvantiEndpointManager: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def ivanti_endpoint_manager_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      custom_column_set: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "If specified, action will also try to return information about"
                  " endpoints using custom column sets. If not specified, action will"
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "IvantiEndpointManager_Enrich Entities"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action IvantiEndpointManager_Enrich Entities for"
            f" IvantiEndpointManager: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
