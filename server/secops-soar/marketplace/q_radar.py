...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def q_radar_list_reference_maps(
      ...
      number_of_elements_to_return: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify a maximum numbers of elements to return by the action."
              ),
          ),
      ],
      fields_to_return: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify which fields should be returned by the action. If nothing is"
                  " provided - return all available fields by default. Parameter"
      ...
      filter_condition: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a filter condition to return only specific elements, for"
                  " example: element_type = ALNIC."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def q_radar_list_reference_maps_of_sets(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "QRadar_List Reference Maps of Sets"
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action QRadar_List Reference Maps of Sets for QRadar: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for QRadar")
  ...
  @mcp.tool()
  async def q_radar_q_radar_aql_search(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      query_format: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Query format to execute for example, \u201cSelect * from flows limit"
                  " 10 last 10 minutes\u201d."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def q_radar_similar_events_query(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      events_limit_to_fetch: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Limit how many events the action can return, the parameter accepts"
                  " numeric value, for example, 25."
              ),
          ),
      ],
      time_delta_in_minutes: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Fetch events for the last X minutes. The parameter accepts numeric"
                  " values for example, 10."
              ),
          ),
      ],
      fields_to_display: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "The fields to fetch from the event in addition to predefined ones,"
                  " if not set - return predefined fields for the event."
              ),
          ),
      ],
      hostname_field_name: Annotated[
          Optional[str],
          Field(
              default=None, description="Field that represents Hostname Field of event"
          ),
      ],
      source_ip_address_field_name: Annotated[
          Optional[str],
          Field(
              default=None,
      ...
      destination_ip_address_field_name: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Fields that represents Destination IP Address Field of event"
              ),
          ),
      ],
      username_field_name: Annotated[
          Optional[str],
          Field(
              default=None, description="Fields that represents Username Field of event"
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      if destination_ip_address_field_name is not None:
        script_params["Destination IP Address Field Name"] = (
  ...
  @mcp.tool()
  async def q_radar_lookup_for_a_value_in_reference_tables(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      name: Annotated[
          str,
          Field(..., description="The name of the reference table to check a value."),
      ],
      value: Annotated[
          str, Field(..., description="The value to check in a referenced table.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "QRadar_Lookup for a Value in Reference Tables"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action QRadar_Lookup for a Value in Reference Tables for"
            f" QRadar: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def q_radar_add_offense_note(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      offense_id: Annotated[
          str, Field(..., description="Offense ID to add a note to.")
      ],
      note_text: Annotated[str, Field(..., description="Note text to add to offense.")],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
              default_factory=list,
  ...
  @mcp.tool()
  async def q_radar_lookup_for_a_value_in_reference_set(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      name: Annotated[
          str, Field(..., description="The name of the reference set to check a value.")
      ],
      value: Annotated[
          str, Field(..., description="The value to check in a referenced set.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "QRadar_Lookup for a Value in Reference Set"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action QRadar_Lookup for a Value in Reference Set for"
            f" QRadar: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def q_radar_lookup_for_a_key_in_reference_map_of_sets(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      name: Annotated[
          str,
          Field(
              ..., description="The name of the reference map of sets to check a key."
          ),
      ],
      key: Annotated[
          str, Field(..., description="The key to check in a referenced map of sets.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "QRadar_Lookup for a Key in Reference Map of Sets"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action QRadar_Lookup for a Key in Reference Map of Sets"
            f" for QRadar: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def q_radar_q_radar_simple_aql_search(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      table_name: Annotated[
          List[Any], Field(..., description="Specify what table should be queried.")
      ],
      fields_to_return: Annotated[
          Optional[str],
          Field(
      ...
      where_filter: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify the WHERE filter for the query that needs to be executed."
                  " Note: you don't need to provide time filter, limiting and sorting."
                  " Also, you don't need to provide WHERE string in the payload."
              ),
          ),
      ],
      ...
      start_time: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  ' if "Custom" is selected for the "Time Frame" parameter. Format:'
                  " ISO-8601"
              ),
          ),
      ],
      ...
      sort_order: Annotated[
          ...
          Field(
              default=None,
              description=(
                  'Specify the order of sorting. Requires "Sort Field" to be provided.'
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "QRadar_QRadar Simple AQL Search"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
  ...
  @mcp.tool()
  async def q_radar_similar_flows_query(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      flows_limit_to_fetch: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Limit how many flows the action can return, parameter accepts"
      ...
      time_delta_in_minutes: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Fetch flows for the last X minutes. The parameter accepts numeric"
                  " values for example, 10."
              ),
          ),
      ],
      fields_to_display: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "The fields to fetch from the flow in addition to predefined ones, if"
                  " not set - return predefined fields for the flow."
              ),
          ),
      ],
      source_ip_address_field_name: Annotated[
          ...
          Field(
              default=None,
              description="Fields that represents Source IP Address Field of flow.",
          ),
      ],
      destination_ip_address_field_name: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Fields that represents Destination IP Address Field of flow."
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  @mcp.tool()
  async def q_radar_get_rule_mitre_coverage(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      rule_names: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify a comma-separated list of rule names for which action should"
                  " return MITRE details."
              ),
          ),
      ],
      create_insight: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " about MITRE coverage of the rules."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "QRadar_Get Rule MITRE Coverage"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
  ...
  @mcp.tool()
  async def q_radar_list_reference_sets(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def q_radar_list_reference_tables(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def q_radar_lookup_for_a_value_in_reference_map(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      name: Annotated[
          str, Field(..., description="The name of the reference map to check a value.")
      ],
      value: Annotated[
          str, Field(..., description="The value to check in a referenced map.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "QRadar_Lookup for a Value in Reference Map"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action QRadar_Lookup for a Value in Reference Map for"
            f" QRadar: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def q_radar_update_offense(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      offense_id: Annotated[str, Field(..., description="Offense ID to update.")],
      status: Annotated[
          List[Any], Field(..., description="New status of the offense.")
      ],
      assigned_to: Annotated[
          Optional[str],
          Field(default=None, description="User login to assign the offense to."),
      ],
      closing_reason: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "If offense status will be set to closed, you will need to provide a"
                  " Qradar closing reason."
              ),
          ),
      ],
      follow_up: Annotated[
          ...
          Field(
              default=None,
              description="Specify whether offense should be marked as a follow up.",
          ),
      ],
      protected: Annotated[
          Optional[bool],
          Field(
              default=None,
              description="Specify whether offense should be marked as protected.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
  ...
  @mcp.tool()
  async def q_radar_lookup_for_a_key_in_reference_map(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      name: Annotated[
          str, Field(..., description="The name of the reference map to check a key.")
      ],
      key: Annotated[
          str, Field(..., description="The key to check in a referenced map.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "QRadar_Lookup for a Key in Reference Map"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action QRadar_Lookup for a Key in Reference Map for"
            f" QRadar: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def q_radar_lookup_for_a_value_in_reference_map_of_sets(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      name: Annotated[
          str,
          Field(
              ..., description="The name of the reference map of sets to check a value."
          ),
      ],
      value: Annotated[
          str, Field(..., description="The value to check in a referenced map of sets.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "QRadar_Lookup for a Value in Reference Map of Sets"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action QRadar_Lookup for a Value in Reference Map of Sets"
            f" for QRadar: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
