...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def mc_afee_epo_get_endpoint_events(
      ...
      fields_to_return: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify what fields to return. If nothing is specified action will"
      ...
      sort_field: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify what field should be used for ordering of the results."
              ),
          ),
      ],
      sort_order: Annotated[
          ...
          Field(
              default=None,
              description="Specify what sort order should be applied to the query.",
          ),
      ],
      time_frame: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a time frame for the events. If \u201cCustom\u201d is"
                  " selected, you also need to provide \u201cStart Time\u201d."
              ),
          ),
      ],
      start_time: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the start time for the events. This parameter is mandatory,"
      ...
      end_time: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the end time for the events. Format: ISO 8601. If nothing is"
                  " provided and \u201cCustom\u201d is selected for the \u201cTime"
    ...
    if instances:
      ...
      try:
        ...
        print(
            f"Error executing action McAfeeEPO_Get Endpoint Events for McAfeeEPO: {e}"
        )
  ...
  @mcp.tool()
  async def mc_afee_epo_list_tasks(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      filter_value: Annotated[
          ...
          Field(
              default=None,
              description="Specify what value should be used in the search.",
          ),
      ],
      max_tasks_to_return: Annotated[
          Optional[str],
          Field(
              default=None, description="Specify how many tasks to return. Default: 50."
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
  ...
  @mcp.tool()
  async def mc_afee_epo_get_dat_version(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def mc_afee_epo_run_full_scan(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      task_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify what task should be executed in order to get a full scan."
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  @mcp.tool()
  async def mc_afee_epo_get_virus_engine_agent_version(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "McAfeeEPO_Get Virus Engine Agent Version"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action McAfeeEPO_Get Virus Engine Agent Version for"
            f" McAfeeEPO: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def mc_afee_epo_execute_query_by_id(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      query_id: Annotated[
          str,
          Field(
              ..., description="Specify the id of the query that needs to be executed."
          ),
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action McAfeeEPO_Execute Query By ID for McAfeeEPO: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for McAfeeEPO")
  ...
  @mcp.tool()
  async def mc_afee_epo_get_last_communication_time(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "McAfeeEPO_Get Last Communication Time"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action McAfeeEPO_Get Last Communication Time for"
            f" McAfeeEPO: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def mc_afee_epo_get_agent_information(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "McAfeeEPO_Get Agent Information"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action McAfeeEPO_Get Agent Information for McAfeeEPO: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for McAfeeEPO")
  ...
  @mcp.tool()
  async def mc_afee_epo_get_mc_afee_epo_agent_version(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "McAfeeEPO_Get McAfee Epo Agent Version"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action McAfeeEPO_Get McAfee Epo Agent Version for"
            f" McAfeeEPO: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def mc_afee_epo_get_host_network_ips_status(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "McAfeeEPO_Get Host Network IPS Status"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action McAfeeEPO_Get Host Network IPS Status for"
            f" McAfeeEPO: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def mc_afee_epo_list_queries(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def mc_afee_epo_update_mcafee_agent(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      task_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify what task should be executed in order to update the McAfee"
                  " Agent. Default for Windows is DAT_Update_Windows_CWS. For Linux"
                  " it\u2019s DAT_Update_Linux_CWS"
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action McAfeeEPO_Update Mcafee Agent for McAfeeEPO: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for McAfeeEPO")
  ...
  @mcp.tool()
  async def mc_afee_epo_compare_server_and_agent_dat(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "McAfeeEPO_Compare Server and Agent DAT"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action McAfeeEPO_Compare Server and Agent DAT for"
            f" McAfeeEPO: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def mc_afee_epo_get_host_ips_status(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action McAfeeEPO_Get Host IPS Status for McAfeeEPO: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for McAfeeEPO")
  ...
  @mcp.tool()
  async def mc_afee_epo_get_system_information(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "McAfeeEPO_Get System Information"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action McAfeeEPO_Get System Information for"
            f" McAfeeEPO: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def mc_afee_epo_execute_entity_query(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      table_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the name of the table from which you want to fetch results."
              ),
          ),
      ],
      stop_if_not_enough_entities: Annotated[
          bool,
          Field(
              ...,
              description=(
                  "If enabled, action will not start execution, unless all of the"
                  ' entity types are available for the specified ".. Entity Keys".'
                  ' Example: if "IP Entity Key" and "File Hash Entity Key" are'
                  " specified, but in the scope there are no file hashes then if this"
                  " parameter is enabled, action will not execute the query."
              ),
          ),
      ],
      cross_entity_operator: Annotated[
          List[Any],
          Field(
              ...,
              description=(
                  "Specify what should be the logical operator used between different"
                  " entity types."
              ),
          ),
      ],
      ...
      ip_entity_key: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify what key should be used with IP entities. Please refer to"
                  " the action documentation for details."
              ),
          ),
      ],
      hostname_entity_key: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify what key should be used with Hostname entities. Please refer"
                  " to the action documentation for details."
              ),
          ),
      ],
      file_hash_entity_key: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify what key should be used with File Hash entities. Please"
                  " refer to the action documentation for details."
              ),
          ),
      ],
      user_entity_key: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify what key should be used with User entities. Please refer to"
                  " the action documentation for details."
              ),
          ),
      ],
      url_entity_key: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify what key should be used with URL entities. Please refer to"
                  " the action documentation for details."
              ),
          ),
      ],
      email_address_entity_key: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify what key should be used with Email Address (User entity with"
                  " email regex) entities. Please refer to the action documentation for"
                  " details."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "McAfeeEPO_Execute Entity Query"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action McAfeeEPO_Execute Entity Query for McAfeeEPO: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for McAfeeEPO")
  ...
  @mcp.tool()
  async def mc_afee_epo_execute_custom_query(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      where_clause: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the where clause for the query. For more information please"
                  " refer to the documentation portal."
              ),
          ),
      ],
      sort_field: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "McAfeeEPO_Execute Custom Query"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action McAfeeEPO_Execute Custom Query for McAfeeEPO: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for McAfeeEPO")
  ...
  async def mc_afee_epo_add_tag(
      ...
      tag_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the name of the tag that needs to be added to the endpoints."
              ),
          ),
      ],
      target_entities: Annotated[
  ...
  @mcp.tool()
  async def mc_afee_epo_get_events_for_hash(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      fetch_events_from_ep_extended_event_table: Annotated[
          bool,
          Field(
              ...,
              description=(
                  "If enabled, action also will use \u201cEPExtendedEvent\u201c Table"
                  " to find information about hashes."
              ),
          ),
      ],
      mark_as_suspicious: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "If enabled, action will mark all of the hashes for which events were"
                  " found as suspicious."
              ),
          ),
      ],
      create_insight: Annotated[
          ...
          Field(
              ...
              description=(
                  "If enabled, action will create an insight containing information"
                  " about which hashes have events associated with them."
              ),
          ),
      ],
      fields_to_return: Annotated[
      ...
      max_events_to_return: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify how many events to return per table that is queried."
                  " Default: 50."
              ),
          ),
      ],
    ...
    if instances:
      ...
      # Construct parameters dictionary for the API call
      script_params = {}
      script_params["Fetch Events From EPExtendedEvent Table"] = (
          fetch_events_from_ep_extended_event_table
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action McAfeeEPO_Get Events For Hash for McAfeeEPO: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for McAfeeEPO")
  ...
  @mcp.tool()
  async def mc_afee_epo_remove_tag(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      tag_name: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the name of the tag that needs to be removed from the"
                  " endpoints."
              ),
          ),
      ],
