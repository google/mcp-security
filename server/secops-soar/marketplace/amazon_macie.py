...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def amazon_macie_get_findings(
      ...
      finding_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Finding ID to get details for. Parameter can take multiple values as"
  ...
  @mcp.tool()
  async def amazon_macie_list_findings(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      finding_type: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Finding type to search for, for example"
                  " SensitiveData:S3Object/Credentials or"
                  " SensitiveData:S3Object/Multiple. Parameter accepts multiple values"
                  " as a comma separated string. If nothing is specified - return all"
                  " types of findings."
              ),
          ),
      ],
      ...
      severity: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Finding severity to search - High, Medium or Low. Parameter accepts"
                  " multiple values as a comma separated string. If nothing is"
                  " specified - return all findings regardless of severity."
              ),
          ),
      ],
      include_archived_findings: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
      ...
      sort_order: Annotated[
          Optional[List[Any]], Field(default=None, description="Sort order.")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
  ...
  @mcp.tool()
  async def amazon_macie_delete_custom_data_identifier(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      custom_data_identifier_id: Annotated[
          str,
          Field(..., description="Amazon Macie custom data identifier id to delete."),
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AmazonMacie_Delete Custom Data Identifier"
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AmazonMacie_Delete Custom Data Identifier for"
            f" AmazonMacie: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def amazon_macie_disable_macie(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def amazon_macie_enable_macie(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def amazon_macie_create_custom_data_identifier(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      custom_data_identifier_name: Annotated[
          str, Field(..., description="Amazon Macie new custom data identifier name.")
      ],
      custom_data_identifier_regular_expression: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Amazon Macie new custom data identifier regular expression, eg"
                  " I[a@]mAB[a@]dRequest"
              ),
          ),
      ],
      custom_data_identifier_description: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Amazon Macie new custom data identifier description.",
          ),
      ],
      custom_data_identifier_keywords: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Amazon Macie new custom data identifier keywords.",
          ),
      ],
      custom_data_identifier_ignore_words: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Amazon Macie new custom data identifier ignore words.",
          ),
      ],
      custom_data_identifier_maximum_match_distance: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
    ...
    if instances:
      ...
      if custom_data_identifier_description is not None:
        script_params["Custom Data Identifier Description"] = (
            custom_data_identifier_description
        )
      script_params["Custom Data Identifier Regular Expression"] = (
          custom_data_identifier_regular_expression
      )
      if custom_data_identifier_keywords is not None:
        script_params["Custom Data Identifier Keywords"] = (
            custom_data_identifier_keywords
        )
      if custom_data_identifier_ignore_words is not None:
        script_params["Custom Data Identifier Ignore Words"] = (
            custom_data_identifier_ignore_words
        )
      if custom_data_identifier_maximum_match_distance is not None:
        script_params["Custom Data Identifier Maximum Match Distance"] = (
            custom_data_identifier_maximum_match_distance
        )
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "AmazonMacie_Create Custom Data Identifier"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action AmazonMacie_Create Custom Data Identifier for"
            f" AmazonMacie: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
