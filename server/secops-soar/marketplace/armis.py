...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def armis_update_alert_status(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      status: Annotated[
          ...
          Field(
              default=None,
              description="Specify what status should be set for the alert.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
  ...
  @mcp.tool()
  async def armis_enrich_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def armis_list_alert_connections(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      alert_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the id of the alert for which you want to pull connections"
                  " data."
              ),
          ),
      ],
      lowest_severity_to_fetch: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify the lowest severity of the connections that should be used"
                  " when fetching them."
              ),
          ),
      ],
      max_connections_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
