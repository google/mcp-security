...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def qualys_vm_list_scans(
  ...
  @mcp.tool()
  async def qualys_vm_launch_patch_report(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      report_title: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " characters. For a PCI compliance report, the report title is"
                  " provided by Qualys and cannot be changed."
              ),
          ),
      ],
      report_type: Annotated[
          str,
          Field(..., description="Template name. For example: Qualys Patch Report."),
      ],
      output_format: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " specified, the Secure PDF Distribution may be used. e.g: pdf,"
                  " online, xml or csv."
              ),
          ),
      ],
      i_ps_ranges: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify IPs/ranges to change (override) the report target, as"
                  " defined in the patch report template. Multiple IPs/ranges are comma"
                  " separated."
              ),
          ),
      ],
      asset_groups: Annotated[
          Optional[str],
          Field(
              default=None,
              description="Asset groups.if more than one has to be comma separated.",
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
  ...
  @mcp.tool()
  async def qualys_vm_download_vm_scan_results(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      scan_id: Annotated[
          str,
          Field(
              ..., description="Scan ID value. Scan ID format: scan/{integer}.{integer}"
          ),
      ],
      target_entities: Annotated[
          List[TargetEntity],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "QualysVM_Download Vm Scan Results"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action QualysVM_Download Vm Scan Results for"
            f" QualysVM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def qualys_vm_launch_vm_scan_and_fetch_results(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      processing_priority: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify a value of 0 - 9 to set a processing priority level for the"
                  " scan. When not specified, a value of 0 (no priority) is used. Valid"
                  " values are: 0 for No Priority (the default), 1 for Emergency, 2 for"
                  " Ultimate,3 for Critical, 4 for Major, 5 for High, 6 for Standard 7"
                  " for Medium, 8 for Minor and 9 for Low"
              ),
          ),
      ],
      scan_profile: Annotated[
          ...
          Field(
              ...,
              description=(
                  "The title of the compliance option profile to be used. One of these"
                  " parameters must be specified in a request: option_title or"
                  " option_id. For example: Qualys Top 20 Options."
              ),
          ),
      ],
      title: Annotated[
      ...
      scanner_appliance: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "The friendly names of the scanner appliances to be used or"
                  ' "External" for external scanners. Multiple entries are comma'
                  " separated."
              ),
          ),
      ],
      network: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "The ID of a network used to filter the IPs/ranges specified in the"
                  ' "ip" parameter. Set to a custom network ID (note this does not'
                  ' filter IPs/ranges specified in "asset_groups" or'
                  ' "asset_group_ids"). Or set to "0" (the default) for the Global'
                  " Default Network - this is used to scan hosts outside of your custom"
                  " networks."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "QualysVM_Launch VM Scan And Fetch Results"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action QualysVM_Launch VM Scan And Fetch Results for"
            f" QualysVM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def qualys_vm_download_report(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      report_id: Annotated[str, Field(..., description="Report ID value.")],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
              default_factory=list,
  ...
  @mcp.tool()
  async def qualys_vm_launch_scan_report(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      report_type: Annotated[
          str, Field(..., description="Template name. For example: Technical Report.")
      ],
      output_format: Annotated[
          str,
          Field(
              ...
              description=(
                  "One output format may be specified. When output_format=pdf is"
                  " specified, the Secure PDF Distribution may be used. e.g: pdf, mht"
                  " and html."
              ),
          ),
      ],
      ...
      scan_reference: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "For a PCI compliance report, either the technical or executive"
                  " report, this parameter specifies the scan reference to include. A"
                  ' scan reference starts with the string "scan/" followed by a'
                  " reference ID number. The scan reference must be for a scan that was"
                  " run using the PCI Options profile. Only one scan reference may be"
                  " specified."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def qualys_vm_list_groups(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def qualys_vm_list_endpoint_detections(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      status_filter: Annotated[
          ...
          Field(
              default=None,
              description=(
                  "Specify a comma-separated list of statuses that should be used"
                  " during ingestion. If nothing is provided, the action will ingest"
                  " detections with New, Active, Re-Opened statuses. Possible values:"
                  " New, Active, Re-Opened, Fixed"
              ),
          ),
      ],
      lowest_severity_to_fetch: Annotated[
          Optional[List[Any]],
          Field(
              default=None,
              description=(
                  "Specify the lowest severity that will be used to fetch detections."
              ),
          ),
      ],
      max_detections_to_return: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify how many detections to return per entity. Default: 50."
                  " Maximum: 200."
              ),
          ),
      ],
      ingest_ignored_detections: Annotated[
          Optional[bool],
          Field(
              default=None,
      ...
      ingest_disabled_detections: Annotated[
          Optional[bool],
          Field(
              default=None,
      ...
      create_insight: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " about vulnerabilities found on the entity."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "QualysVM_List Endpoint Detections"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action QualysVM_List Endpoint Detections for"
            f" QualysVM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def qualys_vm_list_reports(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def qualys_vm_launch_remediation_report(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      report_type: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Template name. For example: Tickets per Asset Group, Tickets per"
                  " Vulnerability."
              ),
          ),
      ],
      ...
      display_results_for_all_tickets: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "Specifies whether the report will include tickets assigned to the"
                  " current user (User is set by default), or all tickets in the user"
                  " account. By default tickets assigned to the current user are"
                  " included."
              ),
          ),
      ],
    ...
    if instances:
      ...
      if display_results_for_all_tickets is not None:
        script_params["Display Results For All tickets"] = (
            display_results_for_all_tickets
        )
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "QualysVM_Launch Remediation Report"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action QualysVM_Launch Remediation Report for"
            f" QualysVM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def qualys_vm_launch_compliance_report(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      report_type: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Template name. For example: Qualys Top 20 Report, Payment Card"
                  " Industry (PCI)."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "QualysVM_Launch Compliance Report"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action QualysVM_Launch Compliance Report for"
            f" QualysVM: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def qualys_vm_enrich_host(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
