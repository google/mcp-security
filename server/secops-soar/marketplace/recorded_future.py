...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def recorded_future_get_host_related_entities(
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              ...
              "ScriptName": (
                  "RecordedFuture_Get Host Related Entities"
      ...
      try:
        ...
        print(
            "Error executing action RecordedFuture_Get Host Related Entities for"
            f" RecordedFuture: {e}"
        )
  ...
  @mcp.tool()
  async def recorded_future_enrich_hash(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      risk_score_threshold: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Represents the minimum malicious risk score for a Hash to be marked"
                  " malicious. Has a range of 0-89. Has the bands levels: \n No"
                  " Suspicious/Malicious content: 0 \n Unusual: 5-24 \n Suspicious:"
                  " 25-64 \n Malicious: 65-89"
              ),
          ),
      ],
      include_related_entities: Annotated[
          Optional[bool],
          Field(
              default=None,
              description=(
                  "If enabled, action will get information about related entities."
              ),
          ),
      ],
      target_entities: Annotated[
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action RecordedFuture_Enrich Hash for RecordedFuture: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for RecordedFuture")
  ...
  @mcp.tool()
  async def recorded_future_get_hash_related_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "RecordedFuture_Get Hash Related Entities"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action RecordedFuture_Get Hash Related Entities for"
            f" RecordedFuture: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def recorded_future_add_analyst_note(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      note_title: Annotated[
          str, Field(..., description="Specify the title for the note")
      ],
      note_text: Annotated[
          str, Field(..., description="Specify the Text for the note")
      ],
      note_source: Annotated[
          str,
          Field(
              ...,
              description=(
                  "Specify the RF ID for note source; the API explorer shows what the"
                  " RF IDs are accessible to the user whose API token is enabled. For"
                  " example,  VWKdVr is the RF ID for an analyst note and is only"
                  " available to user in the same enterprise account in Recorded"
                  " Future."
              ),
          ),
      ],
      enrich_entity: Annotated[
          bool,
          Field(
              ...,
              description=(
                  "Specify whether the action should enrich the entity with the"
                  " \u201cEnrich IOC\u201d output."
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "RecordedFuture_Add Analyst Note"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action RecordedFuture_Add Analyst Note for"
            f" RecordedFuture: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def recorded_future_update_alert(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      ...
      status: Annotated[
          List[Any], Field(..., description="Specify the new status for the alert.")
      ],
      assign_to: Annotated[
          Optional[str],
          Field(
              default=None,
              description=(
                  "Specify to whom to assign the alert. You can provide id, username,"
                  " user hash, or email."
              ),
          ),
      ],
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action RecordedFuture_Update Alert for"
            f" RecordedFuture: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def recorded_future_enrich_cve(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      risk_score_threshold: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Represents the minimum malicious risk score for a CVE to be marked"
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action RecordedFuture_Enrich CVE for RecordedFuture: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for RecordedFuture")
  ...
  @mcp.tool()
  async def recorded_future_enrich_ip(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      risk_score_threshold: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Represents the minimum malicious risk score for an IP to be marked"
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action RecordedFuture_Enrich IP for RecordedFuture: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for RecordedFuture")
  ...
  @mcp.tool()
  async def recorded_future_ping(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def recorded_future_get_alert_details(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      alert_id: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Specify the ID of the alert for which you would like to fetch"
                  " details"
              ),
          ),
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "RecordedFuture_Get Alert Details"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action RecordedFuture_Get Alert Details for"
            f" RecordedFuture: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def recorded_future_get_ip_related_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "RecordedFuture_Get Ip Related Entities"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action RecordedFuture_Get Ip Related Entities for"
            f" RecordedFuture: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def recorded_future_enrich_ioc(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      risk_score_threshold: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Represents the minimum malicious risk score for each entity to be"
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action RecordedFuture_Enrich IOC for RecordedFuture: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for RecordedFuture")
  ...
  @mcp.tool()
  async def recorded_future_enrich_host(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      risk_score_threshold: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Represents the minimum malicious risk score for a Host to be marked"
                  " malicious. Has a range of 0-99. Below is the band levels: \n Very"
                  " Malicious: 90-99 \n Malicious: 65-89 \n Suspicious: 25-64 \n"
                  " Unusual: 5-24 \n No Malicious content: 0"
              ),
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action RecordedFuture_Enrich Host for RecordedFuture: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for RecordedFuture")
  ...
  @mcp.tool()
  async def recorded_future_get_cve_related_entities(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "RecordedFuture_Get CVE Related Entities"
              ),  # Assuming same as actionName
              "ScriptParametersEntityFields": json.dumps(script_params),
          },
      )
      ...
      try:
        ...
        # Log error appropriately
        print(
            "Error executing action RecordedFuture_Get CVE Related Entities for"
            f" RecordedFuture: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
  ...
  @mcp.tool()
  async def recorded_future_enrich_url(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      risk_score_threshold: Annotated[
          ...
          Field(
              ...,
              description=(
                  "Represents the minimum malicious risk score for a URL to be marked"
                  " malicious. Has a range of 0-99. Below is the band levels: \n Very"
                  " Malicious: 90-99 \n Malicious: 65-89 \n Suspicious: 25-64 \n"
                  " Unusual: 5-24 \n No Malicious content: 0"
              ),
    ...
    if instances:
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action RecordedFuture_Enrich URL for RecordedFuture: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for RecordedFuture")
