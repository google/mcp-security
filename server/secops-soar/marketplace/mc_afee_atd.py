...
def register_tools(mcp: FastMCP):
  ...
  @mcp.tool()
  async def mc_afee_atd_get_report(
      ...
      create_insight: Annotated[
          ...
          Field(
              ...
              description=(
                  ...
                  " retrieved information about the report."
              ),
          ),
      ],
  ...
  @mcp.tool()
  async def mc_afee_atd_submit_url(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      analyzer_profile_id: Annotated[
          str,
          Field(
  ...
  @mcp.tool()
  async def mc_afee_atd_check_hash(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
  ...
  @mcp.tool()
  async def mc_afee_atd_get_analyzer_profiles(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
    ...
    if instances:
      ...
      action_data = ApiManualActionDataModel(
          ...
          properties={
              "IntegrationInstance": instance_identifier,
              "ScriptName": (
                  "McAfeeATD_Get Analyzer Profiles"
      ...
      try:
        ...
        # Log error appropriately
        print(
            f"Error executing action McAfeeATD_Get Analyzer Profiles for McAfeeATD: {e}"
        )
        return {"Status": "Failed", "Message": f"Error executing action: {e}"}
    else:
      print(f"Warning: No active integration instance found for McAfeeATD")
  ...
  @mcp.tool()
  async def mc_afee_atd_submit_file(
      case_id: Annotated[str, Field(..., description="The ID of the case.")],
      alert_group_identifiers: Annotated[
          List[str], Field(..., description="Identifiers for the alert groups.")
      ],
      file_paths: Annotated[
          ...
          Field(
              ...,
              description=(
                  "The paths of the file to submit, comma separated. Notice - some file"
                  " types are not supported by ATD (i.e: CSV files)."
              ),
          ),
      ],
      analyzer_profile_id: Annotated[
          str, Field(..., description="The ID of the analyzer profile to analyze with")
      ],
      target_entities: Annotated[
          List[TargetEntity],
          Field(
