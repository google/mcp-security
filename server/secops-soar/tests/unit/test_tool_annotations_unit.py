...
"""Unit tests for FastMCP tool annotations in secops-soar-mcp."""

import pytest
from mcp.types import ToolAnnotations

from secops_soar_mcp.server import mcp
...
def test_tool_catalog_coverage():
    """Verify our test suites cover all 17 case management tools registered on the server."""
