...
def register_tools(mcp: FastMCP):
    ...
    @mcp.tool()
    async def anomali_threat_stream_get_related_entities(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], confidence_threshold: Annotated[str, Field(..., description="Specify what should be the confidence threshold. Note: Maximum is 100.")], search_threat_bulletins: Annotated[bool | None, Field(default=None, description="If enabled, action will search among threat bulletins.")], search_actors: Annotated[bool | None, Field(default=None, description="If enabled, action will search among actors.")], search_attack_patterns: Annotated[bool | None, Field(default=None, description="If enabled, action will search among attack patterns.")], search_campaigns: Annotated[bool | None, Field(default=None, description="If enabled, action will search among campaigns.")], search_courses_of_action: Annotated[bool | None, Field(default=None, description="If enabled, action will search among courses of action.")], search_identities: Annotated[bool | None, Field(default=None, description="If enabled, action will search among identities.")], search_incidents: Annotated[bool | None, Field(default=None, description="If enabled, action will search among incidents.")], search_infrastructures: Annotated[bool | None, Field(default=None, description="If enabled, action will search among infrastructures.")], search_intrusion_sets: Annotated[bool | None, Field(default=None, description="If enabled, action will search among intrusion sets.")], search_malware: Annotated[bool | None, Field(default=None, description="If enabled, action will search among malware.")], search_signatures: Annotated[bool | None, Field(default=None, description="If enabled, action will search among signatures.")], search_tools: Annotated[bool | None, Field(default=None, description="If enabled, action will search among tools.")], search_tt_ps: Annotated[bool | None, Field(default=None, description="If enabled, action will search among TTPs.")], search_vulnerabilities: Annotated[bool | None, Field(default=None, description="If enabled, action will search among vulnerabilities.")], max_entities_to_return: Annotated[str | None, Field(default=None, description="Specify how many entities to return per entity type. Default: 50.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def anomali_threat_stream_submit_observables(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], classification: Annotated[List[Any], Field(..., description="Specify the classification of the observable.")], threat_type: Annotated[List[Any], Field(..., description="Specify the threat type of the observables.")], source: Annotated[str | None, Field(default=None, description="Specify the intelligence source for the observable.")], expiration_date: Annotated[str | None, Field(default=None, description="Specify the expiration date in days for the observable. If nothing is specified here, action will create an observable that will never expire.")], trusted_circle_i_ds: Annotated[str | None, Field(default=None, description="Specify the comma-separated list of trusted circle ids. Observables will be shared with those trusted circles.")], tlp: Annotated[List[Any] | None, Field(default=None, description="Specify the TLP for your observables.")], confidence: Annotated[str | None, Field(default=None, description="Specify what should be the confidence for the observable. Note: this parameter will only work, if you create observables in your organization and requires 'Override System Confidence' to be enabled.")], override_system_confidence: Annotated[bool | None, Field(default=None, description="If enabled, created observables will have the confidence specified in the 'Confidence' parameter. Note: you can't share observables in trusted circles and publicly, when this parameter is enabled.")], anonymous_submission: Annotated[bool | None, Field(default=None, description="If enabled, action will make an anonymous submission.")], tags: Annotated[str | None, Field(default=None, description="Specify a comma-separated list of tags that you want to add to observable.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def anomali_threat_stream_get_related_associations(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], return_campaigns: Annotated[bool | None, Field(default=None, description="If enabled, action will fetch related campaigns and details about them.")], return_threat_bulletins: Annotated[bool | None, Field(default=None, description="If enabled, action will fetch related threat bulletins and details about them.")], return_actors: Annotated[bool | None, Field(default=None, description="If enabled, action will fetch related actors and details about them.")], return_attack_patterns: Annotated[bool | None, Field(default=None, description="If enabled, action will fetch related attack patterns and details about them.")], return_courses_of_action: Annotated[bool | None, Field(default=None, description="If enabled, action will fetch related courses of action and details about them.")], return_identities: Annotated[bool | None, Field(default=None, description="If enabled, action will fetch related identities and details about them.")], return_incidents: Annotated[bool | None, Field(default=None, description="If enabled, action will fetch related incidents and details about them.")], return_infrastructure: Annotated[bool | None, Field(default=None, description="If enabled, action will fetch related infrastructure and details about them.")], return_intrusion_sets: Annotated[bool | None, Field(default=None, description="If enabled, action will fetch related intrusion sets and details about them.")], return_malware: Annotated[bool | None, Field(default=None, description="If enabled, action will fetch related malware and details about them.")], return_signatures: Annotated[bool | None, Field(default=None, description="If enabled, action will fetch related signatures and details about them.")], return_tools: Annotated[bool | None, Field(default=None, description="If enabled, action will fetch related tools and details about them.")], return_tt_ps: Annotated[bool | None, Field(default=None, description="If enabled, action will fetch related TTPs and details about them.")], return_vulnerabilities: Annotated[bool | None, Field(default=None, description="If enabled, action will fetch related vulnerabilities and details about them.")], create_campaign_entity: Annotated[bool | None, Field(default=None, description="If enabled, action will create an entity out of available \u201cCampaign\u201d associations.")], create_actors_entity: Annotated[bool | None, Field(default=None, description="If enabled, action will create an entity out of available \u201cActor\u201d associations.")], create_signature_entity: Annotated[bool | None, Field(default=None, description="If enabled, action will create an entity out of available \u201cSignature\u201d associations.")], create_vulnerability_entity: Annotated[bool | None, Field(default=None, description="If enabled, action will create an entity out of available \u201cVulnerability\u201d associations.")], create_case_tag: Annotated[bool | None, Field(default=None, description="If enabled, action will create case tags based on the results.")], create_insight: Annotated[bool | None, Field(default=None, description="If enabled, action will create an insight base on the results.")], max_associations_to_return: Annotated[str | None, Field(default=None, description="Specify how many associations to return per type. Default: 5")], max_statistics_to_return: Annotated[str | None, Field(default=None, description="Specify how many top statistics results regarding IOCs to return. Note: action will at max process 1000 IOCs related to the association. If you provide \"0\", action will not try to fetch statistics information.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
