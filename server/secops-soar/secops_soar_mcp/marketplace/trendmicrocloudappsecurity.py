...
def register_tools(mcp: FastMCP):
    ...
    @mcp.tool()
    async def trend_micro_cloud_app_security_entity_email_search(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], max_days_backwards: Annotated[str | None, Field(default=None, description="Specify how many days backwards to look for emails. Maximum is 90. Default: 30.")], max_emails_to_return: Annotated[str | None, Field(default=None, description="Specify how many emails to return. Default: 100.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
