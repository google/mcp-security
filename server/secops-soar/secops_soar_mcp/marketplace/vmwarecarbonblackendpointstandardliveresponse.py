...
def register_tools(mcp: FastMCP):
    ...
    @mcp.tool()
    async def cb_live_response_list_files(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], remote_directory_path: Annotated[str, Field(..., description="Specify the target directory path action should list. Example: C:\\TMP\\ or /tmp/")], check_for_active_session_x_times: Annotated[str, Field(..., description="How many attempts action should make to get active session for the entity. Check is made every 2 seconds.")], max_rows_to_return: Annotated[str | None, Field(default=None, description="Specify how many rows action should return.")], start_from_row: Annotated[str | None, Field(default=None, description="Specify from which row action should start to return data.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def cb_live_response_list_files_in_cloud_storage(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], check_for_active_session_x_times: Annotated[str, Field(..., description="How many attempts action should make to get active session for the entity. Check is made every 2 seconds.")], max_rows_to_return: Annotated[str | None, Field(default=None, description="Specify how many rows action should return.")], start_from_row: Annotated[str | None, Field(default=None, description="Specify from which row action should start to return data.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def cb_live_response_delete_file(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], check_for_active_session_x_times: Annotated[str, Field(..., description="How many attempts action should make to get active session for the entity. Check is made every 2 seconds.")], remote_directory_path: Annotated[str | None, Field(default=None, description="Specify the remote directory path to file to delete. Example: C:\\TMP\\")], file_name: Annotated[str | None, Field(default=None, description="Specify the file name to delete. File name is case insensitive. File Name can be specified as a \"full path\" having both path and a file name, in that case Remote Directory Path parameter will not be used.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
