...
def register_tools(mcp: FastMCP):
    ...
    @mcp.tool()
    async def file_operation_tarzip_files_windows(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], source_folder: Annotated[str | None, Field(default=None, description="The full path to the folder with the relevant files")], file_filter: Annotated[str | None, Field(default=None, description="iles extension to include in targzip file {ex: *.txt}")], output_folder: Annotated[str | None, Field(default=None, description="The path to the folder to put the zip file into")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
