...
def register_tools(mcp: FastMCP):
    ...
    @mcp.tool()
    async def crowd_strike_falcon_run_script(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], customer_id: Annotated[str | None, Field(default=None, description="Specify the ID of the customer for which you want to execute the action.")], script_name: Annotated[str | None, Field(default=None, description="The name of the script file that needs to be executed. Note: either \u201cScript Name\u201d or \u201cRaw Script\u201d should be provided. If both \u201cScript Name\u201d and \u201cRaw Script\u201d are provided, then \u201cRaw Script\u201d will have the priority.")], raw_script: Annotated[str | None, Field(default=None, description="Raw powershell script payload that needs to be executed on the endpoints. Note: either \u201cScript Name\u201d or \u201cRaw Script\u201d should be provided. If both \u201cScript Name\u201d and \u201cRaw Script\u201d are provided, then \u201cRaw Script\u201d will have the priority.")], hostname: Annotated[str | None, Field(default=None, description="Comma-separated list of hostnames on which you want to execute the action. Note: action will run the action on both entities + this parameter values.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def crowd_strike_falcon_execute_command(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], command: Annotated[str, Field(..., description="Specify what command to execute on the hosts.")], customer_id: Annotated[str | None, Field(default=None, description="Specify the ID of the customer for which you want to execute the action.")], admin_command: Annotated[bool | None, Field(default=None, description="If enabled, action will execute commands with the admin level permissions. This is necessary for certain commands like \"put\".")], hostname: Annotated[str | None, Field(default=None, description="Comma-separated list of hostnames on which you want to execute the action. Note: action will run the action on both entities + this parameter values.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def crowd_strike_falcon_list_hosts(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], customer_id: Annotated[str | None, Field(default=None, description="Specify the ID of the customer for which you want to execute the action.")], filter_logic: Annotated[List[Any] | None, Field(default=None, description="Specify what logic should be used, when searching for hosts.")], filter_value: Annotated[str | None, Field(default=None, description="Specify the value that should be used to filter hosts.")], max_hosts_to_return: Annotated[str | None, Field(default=None, description="Specify how many hosts to return. Default: 50. Maximum: 1000.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def crowd_strike_falcon_contain_endpoint(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], customer_id: Annotated[str | None, Field(default=None, description="Specify the ID of the customer for which you want to execute the action.")], fail_if_timeout: Annotated[bool | None, Field(default=None, description="If enabled, action will be failed, if not all of the endpoints were contained.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def crowd_strike_falcon_update_ioc_information(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], description: Annotated[str | None, Field(default=None, description="Specify a new description for custom IOCs.")], source: Annotated[str | None, Field(default=None, description="Specify the source for custom IOCs.")], expiration_days: Annotated[str | None, Field(default=None, description="Specify the amount of days till expiration.")], detect_policy: Annotated[bool | None, Field(default=None, description="If enabled, IOCs that have been identifed, will send a notification. In other case, no action will be taken")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def crowd_strike_falcon_get_host_information(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], customer_id: Annotated[str | None, Field(default=None, description="Specify the ID of the customer for which you want to execute the action.")], create_insight: Annotated[bool | None, Field(default=None, description="If enabled, action will create insights containing information regarding entities.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def crowd_strike_falcon_on_demand_scan(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], file_paths_to_scan: Annotated[str, Field(..., description="Comma-separated list of paths to scan.")], customer_id: Annotated[str | None, Field(default=None, description="Specify the ID of the customer for which you want to execute the action.")], file_paths_to_exclude_from_scan: Annotated[str | None, Field(default=None, description="Comma-separated list of paths to exclude from scanning.")], host_group_name: Annotated[str | None, Field(default=None, description="Comma-separated list of host group names to initiate scanning for. Note: Separate scanning process is created for each host group.")], scan_description: Annotated[str | None, Field(default=None, description="Description for the scan. If no value is provided, the action sets the description to the following: \"Scan initialized by Chronicle SecOps.\"")], cpu_priority: Annotated[List[Any] | None, Field(default=None, description="The amount of CPU to  use for the underlying host during scanning.")], sensor_anti_malware_detection_level: Annotated[List[Any] | None, Field(default=None, description="Specify the sensor anti-malware detection level. Note: Detection level must be equal to or higher than the Prevention level.")], sensor_anti_malware_prevention_level: Annotated[List[Any] | None, Field(default=None, description="Specify the sensor anti-malware prevention level. Note: Detection level must be equal to or higher than the Prevention level.")], cloud_anti_malware_detection_level: Annotated[List[Any] | None, Field(default=None, description="Specify the cloud anti-malware detection level. Note: Detection level must be equal to or higher than the Prevention level.")], cloud_anti_malware_prevention_level: Annotated[List[Any] | None, Field(default=None, description="Specify the cloud anti-malware prevention level. Note: Detection level must be equal to or higher than the Prevention level.")], quarantine_hosts: Annotated[bool | None, Field(default=None, description="If enabled, underlying hosts are quarantined as part of scanning.")], create_endpoint_notification: Annotated[bool | None, Field(default=None, description="If enabled, the scanning process creates an endpoint notification.")], max_scan_duration: Annotated[str | None, Field(default=None, description="Number of hours for a scan to run. If no value is provided, the scan runs continuously.")], hostname: Annotated[str | None, Field(default=None, description="Comma-separated list of hostnames on which you want to execute the action. Note: action will run the action on both entities + this parameter values.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def crowd_strike_falcon_list_uploaded_io_cs(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], ioc_type_filter: Annotated[str | None, Field(default=None, description="Specify a comma-separated list of IOC types that should be returned. If nothing is provided, action will return IOCs from all types. Possible values: ipv4,ipv6,md5,sha256,domain.")], value_filter_logic: Annotated[List[Any] | None, Field(default=None, description="Specify the value filter logic. If \"Equal\" is selected, action will try to find the exact match among IOCs and if \"Contains\" is selected, action will try to find IOCs that contain that substring.")], value_filter_string: Annotated[str | None, Field(default=None, description="Specify the string that should be searched among IOCs.")], max_io_cs_to_return: Annotated[str | None, Field(default=None, description="Specify how many IOCs to return. Default: 50. Maximum: 500.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def crowd_strike_falcon_list_host_vulnerabilities(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], customer_id: Annotated[str | None, Field(default=None, description="Specify the ID of the customer for which you want to execute the action.")], severity_filter: Annotated[str | None, Field(default=None, description="Specify the comma-separated list of severities for vulnerabilities.If nothing is provided, action will ingest all related vulnerabilities. Possible values: Critical, High, Medium, Low, Unknown.")], create_insight: Annotated[bool | None, Field(default=None, description="If enabled, action will create an insight per entity containing statistical information about related vulnerabilities.")], max_vulnerabilities_to_return: Annotated[str | None, Field(default=None, description="Specify how many vulnerabilities to return per host. If nothing is provided action will process all of the related vulnerabilities.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def crowd_strike_falcon_lift_contained_endpoint(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], customer_id: Annotated[str | None, Field(default=None, description="Specify the ID of the customer for which you want to execute the action.")], fail_if_timeout: Annotated[bool | None, Field(default=None, description="If enabled, action will be failed, if containment was not lifted on all endpoints.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
