...
def register_tools(mcp: FastMCP):
    ...
    @mcp.tool()
    async def cloudflare_list_firewall_rules(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], zone_name: Annotated[str, Field(..., description="Specify the name of the zone, which will contain the firewall rule.")], filter_key: Annotated[List[Any] | None, Field(default=None, description="Specify the key that needs to be used to filter results.")], filter_logic: Annotated[List[Any] | None, Field(default=None, description="Specify what filter logic should be applied. Filtering logic is working based on the value  provided in the \"Filter Key\" parameter.")], filter_value: Annotated[str | None, Field(default=None, description="Specify what value should be used in the filter. If \"Equal\" is selected, action will try to find the exact match among results and if \"Contains\" is selected, action will try to find results that contain that substring. If nothing is provided in this parameter, the filter will not be applied. Filtering logic is working based on the value provided in the \"Filter Key\" parameter.")], max_records_to_return: Annotated[str | None, Field(default=None, description="Specify how many records to return. If nothing is provided, action will return 50 records.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def cloudflare_add_ip_to_rule_list(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], rule_name: Annotated[str, Field(..., description="Specify the name of the rule list to which you want to add rule list items.")], description: Annotated[str | None, Field(default=None, description="Specify a description for the newly added rule list items.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def cloudflare_add_url_to_rule_list(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], rule_name: Annotated[str, Field(..., description="Specify the name of the rule list to which you want to add rule list items.")], target_url: Annotated[str, Field(..., description="Specify the target URL for the rule list item.")], description: Annotated[str | None, Field(default=None, description="Specify a description for the newly added rule list item.")], status_code: Annotated[List[Any] | None, Field(default=None, description="Specify the status for the rule list item.")], preserve_query_string: Annotated[bool | None, Field(default=None, description="If enabled, the rule list item will preserve the query string.")], include_subdomains: Annotated[bool | None, Field(default=None, description="If enabled, the rule list item will include subdomains.")], subpath_matching: Annotated[bool | None, Field(default=None, description="If enabled, the rule list item will match the subpath.")], preserve_path_suffix: Annotated[bool | None, Field(default=None, description="If enabled, the rule list item will preserve the path suffix.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def cloudflare_update_firewall_rule(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], rule_name: Annotated[str, Field(..., description="Specify the name of the rule that needs to be updated.")], zone_name: Annotated[str, Field(..., description="Specify the name of the zone, which will contain the firewall rule.")], action: Annotated[List[Any] | None, Field(default=None, description="Specify the action for the firewall rule. If \"Bypass\" is selected, you need to provide values in the \"Products\" parameter.")], expression: Annotated[str | None, Field(default=None, description="Specify the expression for the firewall rule.")], products: Annotated[str | None, Field(default=None, description="Specify a comma-separated list of products for the firewall rule. Note: this parameter is only mandatory, if \"Bypass\" is selected for \"Action\" parameter. Possible values: zoneLockdown, uaBlock, bic, hot, securityLevel, rateLimit, waf.")], priority: Annotated[str | None, Field(default=None, description="Specify the priority for the firewall rule.")], reference_tag: Annotated[str | None, Field(default=None, description="Specify a reference tag for the firewall rule. Note: it can only be up to 50 characters long.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def cloudflare_create_firewall_rule(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], zone_name: Annotated[str, Field(..., description="Specify the name of the zone, which will contain the firewall rule.")], expression: Annotated[str, Field(..., description="Specify the expression for the firewall rule.")], name: Annotated[str | None, Field(default=None, description="Specify the name for the firewall rule.")], action: Annotated[List[Any] | None, Field(default=None, description="Specify the action for the firewall rule. If \"Bypass\" is selected, you need to provide values in the \"Products\" parameter.")], products: Annotated[str | None, Field(default=None, description="Specify a comma-separated list of products for the firewall rule. Note: this parameter is only mandatory, if \"Bypass\" is selected for \"Action\" parameter. Possible values: zoneLockdown, uaBlock, bic, hot, securityLevel, rateLimit, waf.")], priority: Annotated[str | None, Field(default=None, description="Specify the priority for the firewall rule.")], reference_tag: Annotated[str | None, Field(default=None, description="Specify a reference tag for the firewall rule. Note: it can only be up to 50 characters long.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
