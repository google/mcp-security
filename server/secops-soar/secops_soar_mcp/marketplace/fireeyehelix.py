...
def register_tools(mcp: FastMCP):
    ...
    @mcp.tool()
    async def fire_eye_helix_get_list_items(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], list_short_name: Annotated[str, Field(..., description="Specify the short name of the list.")], value: Annotated[str | None, Field(default=None, description="Specify value filter for the items.")], type: Annotated[List[Any] | None, Field(default=None, description="Specify type filter for the items.")], sort_by: Annotated[List[Any] | None, Field(default=None, description="Specify which parameter should be used for sorting results.")], sort_order: Annotated[List[Any] | None, Field(default=None, description="Specify the sorting order for the results.")], max_items_to_return: Annotated[str | None, Field(default=None, description="Specify how many items to return.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def fire_eye_helix_get_lists(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], name: Annotated[str | None, Field(default=None, description="Specify name filter.")], short_name: Annotated[str | None, Field(default=None, description="Specify short name filter.")], active: Annotated[bool | None, Field(default=None, description="Specify, whether action should only return active lists.")], internal: Annotated[bool | None, Field(default=None, description="Specify, whether action should only return internal lists.")], protected: Annotated[bool | None, Field(default=None, description="Specify, whether action should only return protected lists.")], sort_by: Annotated[List[Any] | None, Field(default=None, description="Specify which parameter should be used for sorting results.")], sort_order: Annotated[List[Any] | None, Field(default=None, description="Specify the sorting order for the results.")], max_lists_to_return: Annotated[str | None, Field(default=None, description="Specify how many lists to return.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
