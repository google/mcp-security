...
def register_tools(mcp: FastMCP):
    ...
    @mcp.tool()
    async def fire_eye_hx_get_host_alert_groups(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], acknowledgment_filter: Annotated[List[Any] | None, Field(default=None, description="Specify whether you want to return all of the alert groups or only acknowledged/unacknowledged.")], max_alert_groups_to_return: Annotated[str | None, Field(default=None, description="Specify how many Alert Groups to return per entity. Default: 20.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def fire_eye_hx_acknowledge_alert_groups(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], alert_groups_i_ds: Annotated[str, Field(..., description="Specify the Alert Groups IDs you would like to Acknowledge.")], acknowledgment: Annotated[List[Any], Field(..., description="Specify whether you would like to Acknowledge or Un-acknowledge the specified alert groups")], acknowledgment_comment: Annotated[str | None, Field(default=None, description="Specify the acknowledgment comment you would like to add to the relevant alert groups")], limit: Annotated[str | None, Field(default=None, description="Specify the maximum amount of alert group listings coming back from the API, in the JSON result.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def fire_eye_hx_get_list_of_file_acquisitions_for_host(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], search_term: Annotated[str | None, Field(default=None, description="Searches all file acquisitions for hosts connected to the FireEye HX server. The search_term can be any condition value.")], limit: Annotated[str | None, Field(default=None, description="How many records action should return, for example, 100.")], filter_field: Annotated[str | None, Field(default=None, description="Lists only results with the specified field value, results can be filtered by external correlation identifier (external_id).")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def fire_eye_hx_get_alerts(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], limit: Annotated[str | None, Field(default=None, description="How many alerts action should return, for example, 100.")], has_share_mode: Annotated[List[Any] | None, Field(default=None, description="Filter alerts that were triggered from indicators with specific share mode. Available values: any, restricted, unrestricted.")], alert_resolution_status: Annotated[List[Any] | None, Field(default=None, description="Filter alerts based on alert resolution status. Available values: any, active_threat, alert, block, partial_block.")], alert_reported_in_last_x_hours: Annotated[str | None, Field(default=None, description="Filter alerts reported in last x hours, for example last 4 hours.")], alert_source: Annotated[List[Any] | None, Field(default=None, description="Source of alert. Available values: any, exd (exploit detection), mal (malware alert), ioc (indicator of compromise).")], alert_id: Annotated[str | None, Field(default=None, description="Return specific alert by alert identifier.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def fire_eye_hx_get_indicators(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], indicator_category: Annotated[str | None, Field(default=None, description="The indicator category.")], search_term: Annotated[str | None, Field(default=None, description="The search term can be any name, category, signature, source, or condition value.")], limit: Annotated[str | None, Field(default=None, description="How many indicators action should return, for example, 100.")], share_mode: Annotated[List[Any] | None, Field(default=None, description="Filter indicators based on specific share mode. Available values: any, restricted, unrestricted, visible.")], sort_by_field: Annotated[str | None, Field(default=None, description="Sorts the results by the specified field in ascending order.")], created_by: Annotated[str | None, Field(default=None, description="Filter indicators based on author.")], has_associated_alerts: Annotated[bool | None, Field(default=None, description="Specify if only indicators, which have associated alerts should be returned.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
