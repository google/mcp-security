...
def register_tools(mcp: FastMCP):
    ...
    async def google_chronicle_get_rule_details(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], rule_id: Annotated[str, Field(..., description="Specify the ID of the rule for which you want to fetch details.")], target_entities: Annotated[ List[Dict[str, str]], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
        ...
        if target_entities:
            target_entities = [TargetEntity(**entity) for entity in target_entities]
    ...
    @mcp.tool()
    async def google_chronicle_ping(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], target_entities: Annotated[List[Dict[str, str]], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
