...
def register_tools(mcp: FastMCP):
    ...
    @mcp.tool()
    async def microsoft_graph_mail_wait_for_email_from_user(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], mail_id: Annotated[str, Field(..., description="Specify the id or internetMessageId of the email, which current action would be waiting for. If the message has been sent using Send Email action, please select SendEmail.JSONResult|id or Send Email.JsonResult|internetMessageId field as a placeholder. Search Emails action also can return ids for emails.")], wait_for_all_recipients_to_reply: Annotated[bool | None, Field(default=None, description="If enabled,  the action will wait for responses from all of the recipients until timeout, and not finish upon getting the first response.")], wait_stage_exclude_pattern: Annotated[str | None, Field(default=None, description="Specify the regular expression to exclude specific replies from the wait stage. Works with subject and body parts of the email. Example is, to exclude automatic Out-Of-Office emails to be considered as recipient reply, and instead wait for actual user reply.")], folder_to_check_for_reply: Annotated[str | None, Field(default=None, description="Specify the mailbox email folder (mailbox that was used to send the email with question) to search for the user reply in this folder. '/' separator can be used to specify a subfolder to search in, example: Inbox/Subfolder")], fetch_response_attachments: Annotated[bool | None, Field(default=None, description="If enabled, if recipient replies with attachment - fetch recipient response and add it as attachment for the action result.")], limit_the_amount_of_information_returned_in_the_json_result: Annotated[bool | None, Field(default=None, description="If enabled, the amount of information returned by the action will be limited only to the key email fields.")], disable_the_action_json_result: Annotated[bool | None, Field(default=None, description="If enabled, action will not return JSON result.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def microsoft_graph_mail_move_email_to_folder(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], move_in_mailbox: Annotated[str, Field(..., description="By default, move operation will be executed in the default mailbox specified in the integration configuration. If permissions allow, action can search in other mailboxes as well. If permissions allow, action can search in other mailboxes as well. Parameter accepts multiple values as a comma separated string.")], source_folder_name: Annotated[str, Field(..., description="Specify the source folder name to move mail from. '/' separator can be used to specify a subfolder to search in, example: Inbox/Subfolder")], destination_folder_name: Annotated[str, Field(..., description="Specify the destination folder name to move mail to. '/' separator can be used to specify a subfolder to search in, example: Inbox/Subfolder")], mail_i_ds: Annotated[str | None, Field(default=None, description="Specify the mail ids or internetMessageIds to search for. Parameter accepts multiple values as a comma separated string. If mail id or internet message id is provided, it takes priority for the search, subject and sender filters are ignored.")], subject_filter: Annotated[str | None, Field(default=None, description="Specify the subject of the email to search for. Filter works with \"contains\" logic.")], sender_filter: Annotated[str | None, Field(default=None, description="Specify the sender of the email to search for. Filter works with \"equals\" logic.")], time_frame_minutes: Annotated[str | None, Field(default=None, description="Specify time frame in minutes to search emails for.")], only_unread: Annotated[bool | None, Field(default=None, description="If enabled, action searches only for the unread emails.")], how_many_mailboxes_to_process_in_a_single_batch: Annotated[str | None, Field(default=None, description="Specify how many mailboxes action should process in a single batch (single connection to O365). If nothing is provided, default value of 25 will be used.")], limit_the_amount_of_information_returned_in_the_json_result: Annotated[bool | None, Field(default=None, description="If enabled, the amount of information returned by the action will be limited only to the key email fields.")], disable_the_action_json_result: Annotated[bool | None, Field(default=None, description="If enabled, action will not return JSON result.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def microsoft_graph_mail_wait_for_vote_email_results(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], vote_mail_sent_from: Annotated[str, Field(..., description="By default, the email is sent from the default mailbox specified in the integration configuration. In this parameter optionally a different value can be specified, if the vote mail was sent from a different mailbox.")], mail_id: Annotated[str, Field(..., description="ID or internetMessageId of the vote email that the action waits for. If the message was sent using Send Vote Email action, select SendVoteEmail.JSONResult|id or Send Email.JsonResult|internetMessageId field as a placeholder. The Search Emails action also can return email IDs.")], wait_for_all_recipients_to_reply: Annotated[bool | None, Field(default=None, description="If selected, the action waits for responses from all recipients until timeout and doesn't complete execution receiving the first response.")], wait_stage_exclude_pattern: Annotated[str | None, Field(default=None, description="Regular expression to exclude specific replies from the wait stage. The regular expression works with the email subject and body. For example, you can use this parameter to exclude  automatic Out of Office emails wait for an actual user reply.")], folder_to_check_for_reply: Annotated[str | None, Field(default=None, description="Email folder in the mailbox that was used to send the email with question to search for the user reply in. Parameter also accepts a comma separated list of folders to check the user response in multiple folders. '/' separator can be used to specify a subfolder to search in, example: Inbox/Subfolder")], folder_to_check_for_sent_mail: Annotated[str | None, Field(default=None, description="Parameter can be used to specify mailbox email folder (mailbox that was used to send the email with question) to search for the sent mail in this folder. Parameter also accepts a comma separated list of folders to check the user response in multiple folders. Parameter is case sensitive. '/' separator can be used to specify a subfolder to search in, example: Inbox/Subfolder")], fetch_response_attachments: Annotated[bool | None, Field(default=None, description="If selected and the recipient replies with an attachment, the action fetches the recipient response and adds it as an attachment for the action result.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def microsoft_graph_mail_search_emails(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], search_in_mailbox: Annotated[str, Field(..., description="By default, the search will be executed in the default mailbox specified in the integration configuration. If permissions allow, action can search in other mailboxes as well. Parameter accepts multiple values as a comma separated string. Note that it\u2019s not recommended to perform a search against a big number of mailboxes with this action, for complex searches it is recommended to use Exchange Extension Pack.")], folder_name: Annotated[str, Field(..., description="Specify the mailbox folder to search in. '/' separator can be used to specify a subfolder to search in, example: Inbox/Subfolder")], subject_filter: Annotated[str | None, Field(default=None, description="Specify the subject of the email to search for. Filter works with \u201ccontains\u201d logic.")], sender_filter: Annotated[str | None, Field(default=None, description="Specify the sender of the email to search for. Filter works with \u201cequals\u201d logic.")], time_frame_minutes: Annotated[str | None, Field(default=None, description="Specify time frame in minutes to search emails for.")], max_emails_to_return: Annotated[str | None, Field(default=None, description="Specify how many emails action should return. If value is not provided, API default is used.")], only_unread: Annotated[bool | None, Field(default=None, description="If enabled, action will search only for unread emails.")], select_all_fields_for_return: Annotated[bool | None, Field(default=None, description="If enabled, action will return all available fields for the found email.")], how_many_mailboxes_to_process_in_a_single_batch: Annotated[str | None, Field(default=None, description="Specify how many mailboxes action should process in a single batch (single connection to O365). If nothing is provided, default value of 25 will be used.")], limit_the_amount_of_information_returned_in_the_json_result: Annotated[bool | None, Field(default=None, description="If enabled, the amount of information returned by the action will be limited only to the key email fields.")], disable_the_action_json_result: Annotated[bool | None, Field(default=None, description="If enabled, action will not return JSON result.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
    ...
    @mcp.tool()
    async def microsoft_graph_mail_save_email_to_the_case(case_id: Annotated[str, Field(..., description="The ID of the case.")], alert_group_identifiers: Annotated[List[str], Field(..., description="Identifiers for the alert groups.")], search_in_mailbox: Annotated[str, Field(..., description="By default, action will try to search for email in the default mailbox specified in the integration configuration. If permissions allow, action can search in other mailboxes as well.")], mail_id: Annotated[str, Field(..., description="Specify the mail id or internetMessageId to save email and attachments to the case. If the message has been sent using Send Email action, please select SendEmail.JSONResult|id or Send Email.JsonResult|internetMessageId field as a placeholder. Search Emails action also can return ids for emails.")], folder_name: Annotated[str | None, Field(default=None, description="Specify the mailbox folder to search in. '/' separator can be used to specify a subfolder to search in, example: Inbox/Subfolder")], save_only_email_attachments: Annotated[bool | None, Field(default=None, description="If enabled, action will save only attachments of the specified email.")], attachment_to_save: Annotated[str | None, Field(default=None, description="If \"Save Only Email Attachments\" checkbox is enabled, action can save only specific attachments that are specified in this parameter. Parameter accepts multiple values as a comma-separated string.")], base64_encode: Annotated[bool | None, Field(default=None, description="If enabled, encode the email file to base64 encoding.")], save_email_to_the_case_wall: Annotated[bool | None, Field(default=None, description="If enabled, save the Email directly to the SecOps Case Wall.")], target_entities: Annotated[List[TargetEntity], Field(default_factory=list, description="Optional list of specific target entities (Identifier, EntityType) to run the action on.")], scope: Annotated[str, Field(default="All entities", description="Defines the scope for the action.")]) -> dict:
